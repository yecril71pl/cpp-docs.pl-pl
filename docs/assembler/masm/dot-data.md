...
ms.locfileid: "43683235"
---
# <a name="data"></a>.DATA

Gdy jest używane z [. MODEL](../../assembler/masm/dot-model.md), rozpoczyna się niemal segmentu danych dla danych zainicjowanych (_dane segment nazwy).
