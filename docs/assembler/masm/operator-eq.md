---
title: Operator EQ | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
Zwraca wartość true (-1) Jeśli *wyrażenie1* jest równe *wyrażenie2*, lub zwraca wartość false (0), jeśli jej nie ma.  
