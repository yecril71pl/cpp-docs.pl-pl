---
title: Operator SHL | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="operator-shl"></a>operator SHL
Zwraca wynik przesunięcia bitów *wyrażenie* po lewej stronie *liczba* liczba bitów.  
