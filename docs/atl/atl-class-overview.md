---
title: "Przegląd klasy ATL | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[Moduły COM](../atl/com-modules-classes.md)|[Trwałość](../atl/persistence-classes.md)|  
...
|[Implementacja interfejsu IUnknown](../atl/iunknown-implementation-classes.md)|[Narzędzie](../atl/utility-classes.md)|  
 ...
 Dla klas dodatkowe, które mogą być używane w projektach ATL, zobacz [udostępnionych klasy](../atl-mfc-shared/atl-mfc-shared-classes.md).  
