...
## <a name="in-this-section"></a>W tej sekcji  
 [Moduł wyliczający klasy i kolekcji ATL](../atl/atl-collection-and-enumerator-classes.md)  
 Krótko opisano oraz zawiera łącza do klasy ATL, które pomogą Ci implementować kolekcje i wyliczenia.  
  
 [Zasady projektowania dla kolekcji i interfejsy modułu wyliczającego](../atl/design-principles-for-collection-and-enumerator-interfaces.md)  
