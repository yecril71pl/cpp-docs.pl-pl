...
W tej sekcji pokazano, jak przechwytywać zdarzenia za pomocą ATL. Poruszono w nim zasad obsłudze zdarzeń COM i szczegółowych wychwytywania zdarzeń za pomocą pomoc techniczną świadczoną przez ATL.

Aby uzyskać informacje na temat sposobu wyzwalać zdarzeń i wdrożenie punktów połączenia, przeczytaj [punkty połączenia ATL](../atl/atl-connection-points.md).
