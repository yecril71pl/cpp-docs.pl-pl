...
1. Dodaj metodę trzeci `GoToURL`, interfejsu, który nie kończy się w interfejsie "użytkownika". Zaimplementować tę metodę, wywołując [IWebBrowser2::Navigate](https://msdn.microsoft.com/library/aa752133.aspx), wykonując następujące czynności:
