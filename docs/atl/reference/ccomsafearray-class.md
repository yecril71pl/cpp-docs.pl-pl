...
## <a name="remarks"></a>Uwagi  
 `CComSafeArray` udostępnia otokę dla [SAFEARRAY — typ danych](/previous-versions/windows/desktop/api/oaidl/ns-oaidl-tagsafearray) klasy, dzięki czemu polegać na tworzenie i zarządzanie nimi jedno - i tablice wielowymiarowe z niemal dowolnego typu VARIANT, obsługiwane.  
