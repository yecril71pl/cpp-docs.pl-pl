...
Aby uzyskać więcej informacji na temat tej struktury, w tym listę swoich elementów członkowskich, zobacz [PROPSHEETPAGE](/windows/desktop/api/prsht/ns-prsht-propsheetpagea_v3) w zestawie Windows SDK.
