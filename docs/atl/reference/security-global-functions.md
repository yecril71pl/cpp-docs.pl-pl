...
Jeśli `AtlGetSacl` ma być wywoływana wiele razy w wielu różnych obiektach, przed wywołaniem funkcji będzie bardziej wydajne włączenie SE_SECURITY_NAME, a wartość *bRequestNeededPrivileges* ma wartość false.
...
Jeśli `AtlSetSacl` ma być wywoływana wiele razy w wielu różnych obiektach, przed wywołaniem funkcji będzie bardziej wydajne włączenie SE_SECURITY_NAME, a wartość *bRequestNeededPrivileges* ma wartość false.
...
*requestedInfo*<br/>
Zestaw [SECURITY_INFORMATIONych](/windows/win32/SecAuthZ/security-information) flag bitowych, które wskazują typ informacji o zabezpieczeniach do pobrania. Ten parametr może być kombinacją następujących wartości.
...
Jeśli `AtlGetSecurityDescriptor` ma być wywoływana wiele razy w wielu różnych obiektach, przed wywołaniem funkcji będzie bardziej wydajne włączenie SE_SECURITY_NAME, a wartość *bRequestNeededPrivileges* ma wartość false.
