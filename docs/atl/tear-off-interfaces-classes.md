---
title: Oderwania interfejsy klas (ATL) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
---
# <a name="tear-off-interfaces-classes"></a>Oderwania klas interfejsów
Następujące klasy zapewniają obsługę interfejsów oderwania:  
