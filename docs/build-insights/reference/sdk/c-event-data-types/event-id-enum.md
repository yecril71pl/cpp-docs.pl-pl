---
title: EVENT_ID Wyliczenie
description: Zestaw C++ SDK usługi Build insights EVENT_ID Wyliczenie.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "78333784"
---
# <a name="event_id-enum"></a>EVENT_ID Wyliczenie
...
| Nazwa | Wartość | Adres URL szczegółów zdarzenia |
|--|--|--|
...
| `EVENT_ID_LINKER` | 18 (0x00000012) | [KONSOLIDATORA](../event-table.md#linker) |
...
| `EVENT_ID_THREAD` | 29 (0x0000001D) | [NICI](../event-table.md#thread) |
...
Te wartości są używane z funkcjami zestawu SDK języka C.
