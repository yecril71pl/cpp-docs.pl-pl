---
title: Klasa C2DLL
description: Odwołanie C++ do klasy C2DLL zestawu SDK usługi Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
Wraz z dziedziczonymi elementami członkowskimi z klasy podstawowej [działania](activity.md) Klasa `C2DLL` zawiera następujących członków:
