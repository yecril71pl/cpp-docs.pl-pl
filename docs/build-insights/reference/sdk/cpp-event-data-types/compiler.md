...
description: Odwołanie C++ do klasy kompilatora zestawu SDK usługi Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
Wraz z dziedziczonymi elementami członkowskimi z klasy podstawowej [wywołania](invocation.md) Klasa `Compiler` zawiera następujących członków:
