...
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[CompilerPass](cpp-event-data-types/compiler-pass.md)<br/>[BackEndPass](cpp-event-data-types/back-end-pass.md) |
...
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[BottomUp](cpp-event-data-types/bottom-up.md) |
...
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[C1DLL](cpp-event-data-types/c1-dll.md) |
...
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[C2DLL](cpp-event-data-types/c2-dll.md) |
...
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[CodeGeneration](cpp-event-data-types/code-generation.md) |
...
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[Wywołania](cpp-event-data-types/invocation.md)<br/>[Compiler](cpp-event-data-types/compiler.md) |
...
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[ForceInlinee](cpp-event-data-types/force-inlinee.md) |
...
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[FrontEndFile](cpp-event-data-types/front-end-file.md) |
...
|  | Właściwości | -Absolutna ścieżka do wejściowego pliku źródłowego<br/>-Bezwzględna ścieżka do pliku obiektu wyjściowego |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[CompilerPass](cpp-event-data-types/compiler-pass.md)<br/>[FrontEndPass](cpp-event-data-types/front-end-pass.md) |
...
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[Funkcyjn](cpp-event-data-types/function.md) |
...
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[Wywołania](cpp-event-data-types/invocation.md)<br/>[Linker](cpp-event-data-types/linker.md) |
|  | Opis | Występuje po uruchomieniu i zatrzymaniu wywołania *. exe* . |
| <a name="ltcg"></a>LTCG | Typ | Działanie |
|  | Rodzicielski | [PASS1](#pass1) |
|  | Elementy podrzędne | [C2_DLL](#c2-dll) |
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[LTCG](cpp-event-data-types/ltcg.md) |
...
|  | Elementy podrzędne | Brak |
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[OptICF](cpp-event-data-types/opt-icf.md) |
...
|  | Elementy podrzędne | Brak |
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[OptLBR](cpp-event-data-types/opt-lbr.md) |
...
|  | Elementy podrzędne | Brak |
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[OptRef](cpp-event-data-types/opt-ref.md) |
...
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[Pass1](cpp-event-data-types/pass1.md) |
|  | Opis | Występuje na początku i zatrzymywaniu przebiegu konsolidatora 1. |
| <a name="pass2"></a>PASS2 | Typ | Działanie |
|  | Rodzicielski | [KONSOLIDATORA](#linker) |
|  | Elementy podrzędne | Brak |
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[Pass2](cpp-event-data-types/pass2.md) |
...
|  | Elementy podrzędne | Brak |
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[PreLTCGOptRef](cpp-event-data-types/pre-ltcg-opt-ref.md) |
...
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[TemplateInstantiation](cpp-event-data-types/template-instantiation.md) |
...
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[Nici](cpp-event-data-types/thread.md) |
...
|  | Elementy podrzędne | [FUNCTION](#function)<br/>[NICI](#thread) |
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[TopDown](cpp-event-data-types/top-down.md) |
...
|  | Właściwości | Brak |
|  | Klasy przechwytywania | [Aktywność](cpp-event-data-types/activity.md)<br/>[WholeProgramAnalysis](cpp-event-data-types/whole-program-analysis.md) |
