...
description: Odwołanie do funkcji SDK StopTracingSessionW w programie C++ Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
