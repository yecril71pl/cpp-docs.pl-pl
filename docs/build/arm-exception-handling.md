...
|2|*C*= = 1 lub *L*= = 1 lub *R*= = 0 lub PF = = 1|16/32|`push {registers}`|80-Z/D0-DF/EC-ED|
...
|F0-F4||||-|Dostępne|
|F5|00-FF|||32|`vpop  {dS-dE}`<br /><br /> gdzie S jest (Code & 0x00F0)  >> 4 i E jest kodem & 0x000F|
...
|PLATFORMY FB||||16|NOP (16 bitów)|
|FC||||32|NOP (32-bitowa)|
|PROCES||||16|End + 16-bitowy NOP w epilogu|
...
[Omówienie Konwencji ABI ARM](overview-of-arm-abi-conventions.md)<br/>
