...
![Składnik CMake w obciążeniu klasycznym C++](media/cmake-install-2019.png)
...
Domyślnie większość komunikatów konfiguracyjnych jest pomijana, o ile wystąpi błąd. Aby wyświetlić wszystkie komunikaty, Włącz tę funkcję w**opcji** >  **Narzędzia** > **CMAKE**.
...
![Składnik CMake w obciążeniu klasycznym C++](media/cmake-install.png)
...
Po wprowadzeniu znaczących zmian w plikach *pliku cmakesettings. JSON* lub *CMakeLists. txt* program Visual Studio automatycznie ponownie uruchamia krok konfiguracji CMAKE. Jeśli krok konfiguracji zakończy się bez błędów, zbierane informacje są dostępne w języku C++ IntelliSense i w usługach językowych. Jest on również używany w operacjach kompilowania i debugowania.
