...
-   Użyj słowa kluczowe **__declspec(dllimport)** w definicji funkcji w głównej aplikacji  
  
-   Użyj pliku definicji (.def) moduł wraz z programem **__declspec(dllimport)**  
