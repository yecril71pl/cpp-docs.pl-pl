...
|`projectTarget`|ciąg|Określa opcjonalny element docelowy wywoływany podczas kompilowania `project`. Ta `projectTarget` musi już istnieć i być zgodna z nazwą na liście rozwijanej **elementu docelowego debugowania** .|
