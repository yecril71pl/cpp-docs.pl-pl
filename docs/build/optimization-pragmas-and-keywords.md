---
title: Optymalizacja pragm i słów kluczowych
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "64341203"
---
# <a name="optimization-pragmas-and-keywords"></a>Optymalizacja pragm i słów kluczowych

Kilka słowa kluczowe i pragmy, którego używasz w kodzie C lub C++ wpływa na optymalizację:

- [__asm](../assembler/inline/asm.md)

- [__assume](../intrinsics/assume.md)

- [w tekście, __inline, lub \__forceinline](../cpp/inline-functions-cpp.md)
