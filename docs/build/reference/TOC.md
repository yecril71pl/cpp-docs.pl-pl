...
##### [-Qvec-raport (Poziom raportowania automatycznej wektoryzacji)](qvec-report-auto-vectorizer-reporting-level.md)
...
#### [-WL (Włącz diagnostykę w trybie on-line)](wl-enable-one-line-diagnostics.md)
...
### [-APPCONTAINER (Aplikacja do Sklepu Windows)](appcontainer-windows-store-app.md)
...
### [-IGNORE (ignorowanie określonych ostrzeżeń)](ignore-ignore-specific-warnings.md)
...
### [Optymalizacja sterowana profilem w Centrum Wydajności i Diagnostyki](profile-guided-optimization-in-the-performance-and-diagnostics-hub.md)
### [Narzędzia do ręcznej optymalizacji sterowanej profilem](tools-for-manual-profile-guided-optimization.md)
