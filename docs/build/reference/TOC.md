...
# [Dokumentacja aparatu MSBuild dla projektów w języku C++](msbuild-reference-cpp.md)
## [Funkcje wewnętrzne aparatu MSBuild dla projektów w języku C++](msbuild-visual-cpp-overview.md)
## [Typowe makra dla właściwości i poleceń kompilacji](common-macros-for-build-commands-and-properties.md)
## [Typy plików używane w projektach w języku C++](file-types-created-for-visual-cpp-projects.md)
### [Pliki projektu i rozwiązania](project-and-solution-files.md)
### [Szablony projektów w języku C++](visual-cpp-project-types.md)
### [Szablony nowych elementów w języku C++](using-visual-cpp-add-new-item-templates.md)
...
### [HTML — pliki pomocy](help-files-html-help.md)
### [Winhelp — pliki pomocy](help-files-winhelp.md)
### [Pliki wskazówek dla funkcji Intellisense](hint-files.md)
...
## [Dokumentacja właściwości projektów w języku C++](property-pages-visual-cpp.md)
### [Strona właściwości ogólnych](general-property-page-project.md)
### [Strona właściwości ogólnych](general-property-page-file.md)
...
# [Dokumentacja kompilatora MSVC](compiling-a-c-cpp-program.md)
...
##### [Optymalizacja liczb zmiennoprzecinkowych MSVC](floating-point-optimization.md)
...
# [Dodatkowe narzędzia kompilacji kompilatora MSVC](c-cpp-build-tools.md)
## [NMAKE — dokumentacja](nmake-reference.md)
### [Projekty NMAKE w projekcie Visual Studio](creating-a-makefile-project.md)
...
# [Błędy kompilatora i narzędzi do kompilacji](../../error-messages/)
# [Dokumentacja XML dla języka C++](xml-documentation-visual-cpp.md)
## [Zalecane tagi przeznaczone do komentarzy dokumentacji języka C++](recommended-tags-for-documentation-comments-visual-cpp.md)
### [<c>](c-visual-cpp.md)
...
## [Ograniczniki tagów dokumentacji języka C++](delimiters-for-visual-cpp-documentation-tags.md)
