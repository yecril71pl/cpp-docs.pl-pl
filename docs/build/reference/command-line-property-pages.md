...
Aby uzyskać informacje dotyczące uzyskiwania dostępu do **wiersza polecenia** strony właściwości, zobacz [kompilatora i tworzenia właściwości ustaw C++ w programie Visual Studio](../working-with-project-properties.md).
