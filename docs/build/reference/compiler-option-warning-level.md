---
title: -w, — W0,-W1, - W2,-W3, - W4,-w1,-w2,-w3,-w4, — Wall, -wd,-we, -wo, -Wv, - WX (poziom ostrzegawczy) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/31/2018
ms.technology:
- cpp-tools
...
|**/WX**|Traktuje wszystkie ostrzeżenia kompilatora jako błędy. Dla nowego projektu może być najlepiej użyć **/WX** we wszystkich kompilacjach; rozwiązanie wszystkich ostrzeżeń zapewnia najmniejszą liczbą wad możliwe kodu twardych do znalezienia.<br /><br /> Ma również konsolidator **/WX** opcji. Aby uzyskać więcej informacji, zobacz [/WX (Traktuj ostrzeżenia konsolidatora jak błędy)](../../build/reference/wx-treat-linker-warnings-as-errors.md).|
