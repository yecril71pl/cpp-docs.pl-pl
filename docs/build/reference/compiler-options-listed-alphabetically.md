...
|[/ analyze](../../build/reference/analyze-code-analysis.md)|Włącz analizę kodu.|  
|[/ arch](../../build/reference/arch-minimum-cpu-architecture.md)|Określa architektury dla generowania kodu.|  
...
|[/ favor pod](../../build/reference/favor-optimize-for-architecture-specifics.md)|Generuje kod, który jest zoptymalizowana pod kątem określonego [!INCLUDE[vcprx64](../../assembler/inline/includes/vcprx64_md.md)] architektura lub kątem specyfiki architektury micro w zarówno AMD64, jak i pamięci rozszerzony 64 architektury technologii (EM64T).|  
|[/FA](../../build/reference/fa-fa-listing-file.md)|Tworzy plik listy.|  
|[/FA](../../build/reference/fa-fa-listing-file.md)|Ustawia nazwę pliku listy.|  
|[/FC](../../build/reference/fc-full-path-of-source-code-file-in-diagnostics.md)|Wyświetl pełną ścieżkę diagnostyczny przekazano cl.exe plików kodu źródłowego.|  
...
|[/Fi](../../build/reference/fi-preprocess-output-file-name.md)|Ustawia nazwę pliku wstępnie przetworzonych danych wyjściowych.|  
|[/FM](../../build/reference/fm-name-mapfile.md)|Tworzy plik mapowania.|  
|[/FO](../../build/reference/fo-object-file-name.md)|Tworzy plik obiektu.|  
|[/ FP](../../build/reference/fp-specify-floating-point-behavior.md)|Określenie zachowania zmiennoprzecinkowego.|  
|[/ FP](../../build/reference/fp-name-dot-pch-file.md)|Określa nazwę pliku prekompilowanego nagłówka.|  
|[/FR](../../build/reference/fr-fr-create-dot-sbr-file.md)<br /><br /> [/FR](../../build/reference/fr-fr-create-dot-sbr-file.md)|Generuje pliki przeglądarki. **/FR** jest przestarzały.|  
...
|[/FX](../../build/reference/fx-merge-injected-code.md)|Wprowadzony kod scalenia z pliku źródłowego.|  
|[/GA](../../build/reference/ga-optimize-for-windows-application.md)|Optymalizuje kod dla aplikacji systemu Windows.|  
|[/GD](../../build/reference/gd-gr-gv-gz-calling-convention.md)|Używa `__cdecl` (tylko x86) konwencji wywoływania.|  
...
|[Gr](../../build/reference/gd-gr-gv-gz-calling-convention.md)|Używa `__fastcall` (tylko x86) konwencji wywoływania.|  
|[/ GS](../../build/reference/gs-buffer-security-check.md)|Buforuje sprawdzanie zabezpieczeń.|  
|[/ GS](../../build/reference/gs-control-stack-checking-calls.md)|Sondy stosu kontrolki.|  
|[/GT](../../build/reference/gt-support-fiber-safe-thread-local-storage.md)|Obsługuje bezpieczeństwa włókien przydzielony przy użyciu statycznego magazynu wątków lokalnych danych.|  
...
|[GZ](../../build/reference/gz-enable-stack-frame-run-time-error-checking.md)|Przestarzałe. Taki sam jak [rtc1](../../build/reference/rtc-run-time-error-checks.md).|  
|[GZ](../../build/reference/gd-gr-gv-gz-calling-convention.md)|Używa `__stdcall` (tylko x86) konwencji wywoływania.|  
...
|[/VD](../../build/reference/vd-disable-construction-displacements.md)|Włącza lub wyłącza vtordisp ukrytych elementów członkowskich klasy.|  
...
|[/ W0, /W1, /W2, /W3, / W4](../../build/reference/compiler-option-warning-level.md)|Ustawia poziom ostrzeżeń do danych wyjściowych.|  
|[/W1, /w2, /w3, / W4](../../build/reference/compiler-option-warning-level.md)|Ustawia poziom ostrzeżeń dla określonego ostrzeżenie.|  
...
|[/WV](../../build/reference/compiler-option-warning-level.md)|Wyświetlane nie ostrzeżenia wprowadzone po określonej wersji kompilatora.|  
|[WX](../../build/reference/compiler-option-warning-level.md)|Traktuje wszystkie ostrzeżenia jako błędy.|  
...
|[/Yc](../../build/reference/yc-create-precompiled-header-file.md)|Tworzy plik prekompilowanego nagłówka.|  
...
|[/Zc](../../build/reference/zc-conformance.md)|Określa zachowanie standardowe w obszarze [/Ze](../../build/reference/za-ze-disable-language-extensions.md).[ / Za, /Ze (Wyłącz rozszerzenia językowe)](../../build/reference/za-ze-disable-language-extensions.md)|  
...
|[/ ZI](../../build/reference/z7-zi-zi-debug-information-format.md)|Zawiera informacje o debugowaniu w bazie danych programu zgodne z opcją Edytuj i Kontynuuj.|  
|[/ Zi](../../build/reference/z7-zi-zi-debug-information-format.md)|Generuje pełne informacje debugowania.|  
|[/ZL](../../build/reference/zl-omit-default-library-name.md)|Usuwa domyślną nazwę biblioteki z pliku obj. (tylko x86).|  
...
|[/ZP](../../build/reference/zp-struct-member-alignment.md)|Pakiety struktury elementów członkowskich.|  
