...
-   [Zasady spójności dla każdego pliku użytkowania prekompilowanych nagłówków](#consistency-rules-for-per-file-use-of-precompiled-headers)  
...
-   [Przykładowy plik reguł programu make dla PCH](#sample-makefile-for-pch)  
