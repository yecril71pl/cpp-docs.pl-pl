...
3.  Kliknij przycisk **debugowanie** stronę właściwości.  
  
4.  Modyfikowanie **Generuj informacje o debugowaniu** właściwością pozwalającą włączyć Generowanie pliku PDB. Dzięki temu fastlink domyślnie w programie Visual Studio 2017.  
  
4.  Modyfikowanie **Generuj pełny plik bazy danych programu** właściwością pozwalającą włączyć/Debug: Full, aby uzyskać pełne generowanie pliku PDB dla każdej kompilacji przyrostowej.  
