---
title: -DEPENDENTS | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
## <a name="remarks"></a>Uwagi  
 Zrzuty nazwy bibliotek DLL, z których obrazu importuje funkcji. Nie zrzutu nazwy funkcji zaimportowany.  
