...
**/GD**, **GR**, **GV** i **GZ** nie są zgodne z [/CLR: Safe](../../build/reference/clr-common-language-runtime-compilation.md) lub   **/CLR: pure**. **/CLR: pure** i **/CLR: Safe** — opcje kompilatora są używane w programie Visual Studio 2015 i nieobsługiwane w programie Visual Studio 2017 r.
...
1. Wybierz **C/C++** > **zaawansowane** strony właściwości.
