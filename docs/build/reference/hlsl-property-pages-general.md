...
Aby skonfigurować następujące właściwości kompilator HLSL (fxc.exe), użyj jej **ogólne** stronę właściwości. Aby uzyskać informacje o tym, jak uzyskać dostęp do **ogólne** zobacz stronę właściwości w folderze HLSL [kompilatora i tworzenia właściwości ustaw C++ w programie Visual Studio](../working-with-project-properties.md).
...
[Strony właściwości HLSL: Zaawansowane](hlsl-property-pages-advanced.md)<br>
