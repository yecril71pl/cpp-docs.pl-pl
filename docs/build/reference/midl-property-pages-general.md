...
Aby uzyskać informacje dotyczące uzyskiwania dostępu do **ogólne** — strona właściwości w **MIDL** folderów, zobacz [kompilatora i tworzenia właściwości ustaw C++ w programie Visual Studio](../working-with-project-properties.md).
