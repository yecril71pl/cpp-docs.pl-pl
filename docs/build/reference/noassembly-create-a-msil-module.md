...
Domyślnie jest tworzony zestaw. Można również użyć [/LN (Utwórz moduł MSIL)](ln-create-msil-module.md) opcję kompilatora, aby utworzyć moduł.
