---
title: Najlepsze rozwiązania dotyczące optymalizacji | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
Aby uzyskać więcej informacji, zobacz [/GL (Optymalizacja Całoprogramowa)](../../build/reference/gl-whole-program-optimization.md) i [/O1, / O2 (Minimalizuj rozmiar, Maksymalizuj szybkość)](../../build/reference/o1-o2-minimize-size-maximize-speed.md).
...
Istnieje kilka słów kluczowych w języku Visual C++, które mogą pomóc wydajność: [element __restrict](../../cpp/extension-restrict.md) i [__assume](../../intrinsics/assume.md).
