---
title: -OUT (DUMPBIN) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
## <a name="remarks"></a>Uwagi  
 Ta opcja określa *filename* dla danych wyjściowych. Domyślnie DUMPBIN Wyświetla informacje do wyjścia standardowego.  
