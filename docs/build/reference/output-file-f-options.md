---
title: Plik wyjściowy (-F) opcje | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
-   [/FD (nazwa pliku PDB)](../../build/reference/fd-program-database-file-name.md)  
...
-   [/FP (nazwa pliku .pch)](../../build/reference/fp-name-dot-pch-file.md)  
