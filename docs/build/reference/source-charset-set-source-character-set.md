...
[/UTF-8 (Ustaw źródłowy i wykonywalny zestawów na UTF-8 znaków)](../../build/reference/utf-8-set-source-and-executable-character-sets-to-utf-8.md)
 [ /Validate-Charset (Zweryfikuj w celu zachowania zgodności Liczba znaków)](../../build/reference/validate-charset-validate-for-compatible-characters.md)