---
title: -std (Określ wersję standardu języka) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/16/2017
ms.topic: reference
f1_keywords:
...
3.  W **standardu języka C++**, wybierz standard języka pomocy technicznej z formantu listy rozwijanej, a następnie wybierz pozycję **OK** lub **Zastosuj** Aby zapisać zmiany.  
