---
title: "-Zc-: wbudowany (usuwanie nieużywanej sekcji COMDAT) | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
4.  Modyfikowanie **dodatkowe opcje** właściwości, aby uwzględnić `/Zc:inline` , a następnie wybierz **OK**.  
