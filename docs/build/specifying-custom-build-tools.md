...
Aby uzyskać ogólne informacje o niestandardowych narzędzi kompilacji i niestandardowych kroków kompilacji, zobacz [niestandardowych krokach kompilacji zrozumienie i zdarzenia kompilacji](understanding-custom-build-steps-and-build-events.md).
