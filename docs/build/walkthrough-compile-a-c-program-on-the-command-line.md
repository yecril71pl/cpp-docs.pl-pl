...
Kompilator generuje program o nazwie file1.exe. Aby zmienić nazwę program1.exe, Dodaj [/out](reference/out-output-file-name.md) — opcja konsolidatora:
