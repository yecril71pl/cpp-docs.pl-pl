...
1. W wierszu polecenia wprowadź **basicclr.cpp Notatnik**.
...
1. Na pasku menu wybierz **pliku**, **zapisać**.
...
1. W wierszu polecenia wprowadź **basicclr.cpp/CLR cl**. Cl.exe — kompilator kompiluje kod źródłowy w pliku .obj, który zawiera MSIL, a następnie uruchomi konsolidator, aby wygenerować program wykonywalny o nazwie basicclr.exe.

1. Aby uruchomić basicclr.exe program, w wierszu polecenia, wpisz **basicclr**.
