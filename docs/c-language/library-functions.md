---
title: Funkcje bibliotek | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
-   [Signal — funkcja](../c-language/signal-function-c.md)  
  
-   [Sygnały domyślne](../c-language/default-signals.md)  
  
-   [Kończenie znakami nowego wiersza](../c-language/terminating-newline-characters.md)  
...
-   [Pliki o zerowej długości](../c-language/zero-length-files.md)  
  
-   [Nazwy plików](../c-language/filenames.md)  
  
-   [Limity dostępu do pliku](../c-language/file-access-limits.md)  
...
-   [Odczytywanie zakresów](../c-language/reading-ranges.md)  
