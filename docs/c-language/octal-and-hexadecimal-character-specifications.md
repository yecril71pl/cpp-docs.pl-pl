...
Wartość ósemkowej lub szesnastkowej sekwencji ucieczki musi znajdować się w przedziale wartości typu **unsigned char** dla stałej znakowej i wpisać `wchar_t` dla stałej o szerokim znaku. Zobacz [znaki wielobajtowe i szerokie,](../c-language/multibyte-and-wide-characters.md) Aby uzyskać informacje o stałych znakach.
