 ...
 *Deklaracja*  
 ...
 [Przegląd deklaracji](../c-language/overview-of-declarations.md) daje składnia `declaration` nonterminal i *odwołania preprocesora* wyjaśniono, jak [jednostce tłumaczenia](../preprocessor/phases-of-translation.md) jest przetwarzany.  
  
> [!NOTE]
>  Zobacz introduction to [podsumowanie dotyczące składni języka C](../c-language/c-language-syntax-summary.md), aby uzyskać informacje o konwencje składni ANSI.  
  
 Składniki jednostki translacji są deklaracjami zewnętrznymi, do których należą definicje funkcji i deklaracje identyfikatorów. Te deklaracje i definicje mogą znajdować się w plikach źródłowych, plikach nagłówka, bibliotekach i innych plikach, które są potrzebne w programie. Należy skompilować każdą jednostkę translacji i połączyć pliki obiektów wynikowych w celu utworzenia programu.  
