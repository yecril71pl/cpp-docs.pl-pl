...
**Float** typ zawiera 32-bitowy: 1 znaku, 8 wykładnika potęgi i 23 dla mantysa. Jej zakres jest +/-3.4E38 z dokładnością co najmniej 7 cyfr.

**Double** typ zawiera 64-bitowy: 1 znaku, 11 dla wykładnik i 52 dla mantysy. Jej zakres jest +/-1.7E308 z dokładnością co najmniej 15 cyfr.
