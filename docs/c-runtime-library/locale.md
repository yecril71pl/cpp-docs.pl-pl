...
|[strtod, _strtod_l, wcstod, _wcstod_l](../c-runtime-library/reference/strtod-strtod-l-wcstod-wcstod-l.md)|Konwertowanie ciągu znaków na `double` wartość|`LC_NUMERIC`(określa rozpoznawania znaków podstawa)|  
|[strtol, wcstol, _strtol_l, _wcstol_l](../c-runtime-library/reference/strtol-wcstol-strtol-l-wcstol-l.md)|Konwertowanie ciągu znaków na `long` wartość|`LC_NUMERIC`(określa rozpoznawania znaków podstawa)|  
