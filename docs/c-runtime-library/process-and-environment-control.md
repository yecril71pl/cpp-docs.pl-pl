...
|[_getpid](../c-runtime-library/reference/getpid.md)|Pobierz numer identyfikacyjny ID procesu|[System::Diagnostics::process::ID](https://msdn.microsoft.com/library/system.diagnostics.process.id.aspx)|
