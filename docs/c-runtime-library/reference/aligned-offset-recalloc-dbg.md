...
*Nazwa pliku*<br/>
Wskaźnik do nazwy pliku źródłowego, który żądanej operacji realloc ani mieć wartości NULL.

*numer wiersza*<br/>
Numer w pliku źródłowym, której zażądano operacji realloc wiersza lub wartość NULL.
