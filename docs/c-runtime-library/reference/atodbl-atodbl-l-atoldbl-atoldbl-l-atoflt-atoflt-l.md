...
## <a name="remarks"></a>Uwagi  
 ...
 Jeśli ciąg nie jest prawidłową interpretacji jako wartość zmiennoprzecinkowa `value` ma ustawioną wartość zero i zwrot wartość jest równa zero.  
  
 Wersje tych funkcji, które mają `_l` sufiks są identyczne wersje, które nie mają sufiks, z wyjątkiem tego, aby używały parametr ustawień regionalnych, który jest przekazywany w zamiast bieżącego ustawienia regionalne wątku.  
