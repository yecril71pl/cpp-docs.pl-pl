...
## <a name="remarks"></a>Uwagi  
 Ponieważ C++ pozwala przeładowanie, można wywoływać przeciążenia `casinh` który przyjmować i zwracać `_Fcomplex` i `_Lcomplex` wartości. W programie C `casinh` zawsze przyjmuje i zwraca `_Dcomplex` wartość.  
