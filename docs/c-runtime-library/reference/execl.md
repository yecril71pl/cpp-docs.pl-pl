---
title: "execl — | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Ta funkcja POSIX jest przestarzały. Użyj zgodność ISO C++ [_execl —](../../c-runtime-library/reference/execl-wexecl.md) zamiast tego.  
