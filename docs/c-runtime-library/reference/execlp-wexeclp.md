...
## <a name="remarks"></a>Uwagi  
 Każda z tych funkcji ładuje i wykonuje nowego procesu przekazywania każdy argument wiersza polecenia jako osobny parametr i przy użyciu `PATH` zmiennej środowiskowej można znaleźć pliku do wykonania.  
