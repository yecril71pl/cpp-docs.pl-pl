...
## <a name="remarks"></a>Uwagi  
 Każda z tych funkcji ładuje i wykonuje nowy proces przekazywaniem każdy argument wiersza polecenia jako osobny parametr, a także przekazanie tablicy wskaźników do ustawienia środowiska. Użyj tych funkcji `PATH` zmiennej środowiskowej można znaleźć pliku do wykonania.  
