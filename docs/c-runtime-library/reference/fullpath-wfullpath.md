...
Jeśli **_DEBUG** i **_CRTDBG_MAP_ALLOC** są zdefiniowane, wywołania **_fullpath** i **_wfullpath** są zastępowane wywołaniami **_fullpath_dbg** i **_wfullpath_dbg** , aby umożliwić debugowanie alokacji pamięci. Aby uzyskać więcej informacji, zobacz [_fullpath_dbg, _wfullpath_dbg](fullpath-dbg-wfullpath-dbg.md).
