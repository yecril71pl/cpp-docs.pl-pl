---
title: _getch_nolock —, _getwch_nolock — | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Pobiera znak z konsoli bez echo i bez blokowania wątku.
