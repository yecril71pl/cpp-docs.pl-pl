...
Te funkcje Zablokuj wątek wywołujący i w związku z tym są wątkowo. Blokowania wersje można znaleźć [_getche_nolock —, _getwche_nolock —](getche-nolock-getwche-nolock.md).
