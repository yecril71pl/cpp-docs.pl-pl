...
Konwertuje **time_t** wartość czasu na strukturę **TM** i koryguje ją dla lokalnej strefy czasowej. Są to wersje [localtime, _localtime32 _localtime64](localtime-localtime32-localtime64.md) z ulepszonymi zabezpieczeniami, zgodnie z opisem w temacie [funkcje zabezpieczeń w CRT](../../c-runtime-library/security-features-in-the-crt.md).
