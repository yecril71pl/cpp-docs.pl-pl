...
Funkcja **_memicmp** porównuje pierwsze znaki *Count* z dwóch buforów *buffer1* i *buffer2* bajt według bajtu. W porównaniu z rozróżnianiem wielkości liter.
