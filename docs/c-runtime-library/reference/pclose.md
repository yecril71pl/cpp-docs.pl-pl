...
## <a name="remarks"></a>Uwagi  
 `_pclose` Funkcja wyszukuje procesora poleceń (Cmd.exe) uruchomione przez skojarzony identyfikator procesu `_popen` wywołać, wykonuje [_cwait —](../../c-runtime-library/reference/cwait.md) wywołać dla nowego procesora poleceń i zamknięcie strumienia skojarzone potoku.  
