---
title: "cwait — | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Ta funkcja POSIX jest przestarzały. Użyj zgodność ISO C++ [_cwait —](../../c-runtime-library/reference/cwait.md) zamiast tego.  
