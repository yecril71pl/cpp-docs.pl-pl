...
description: Dokumentacja interfejsu API dla snprintf, _snprintf, _snprintf_l, _snwprintf i _snwprintf_; , które zapisują sformatowane dane do ciągu.
ms.date: 08/27/2020
api_name:
- _snwprintf
- _snprintf
