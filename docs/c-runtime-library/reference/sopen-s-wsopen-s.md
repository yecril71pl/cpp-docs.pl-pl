...
Argument *Shflag* jest wyrażeniem stałym, które składa się z jednej z następujących stałych manifestu, które są zdefiniowane w \<udziału. h >.
...
|-------------|---------------------|---------------------|
|**_sopen_s**|\<we/wy >|\<fcntl. h >, \<sys\types.h >, \<sys\stat.h >, \<Share. h >|
|**_wsopen_s**|\<we/wy > lub \<WCHAR. h >|\<fcntl. h >, \<sys/Types. h >, \<sys/stat. h >, \<Share. h >|
