...
Każda z tych funkcji tworzy i uruchamia nowy proces, przekazując każdy argument wiersza polecenia jako oddzielny parametr i przekazując także tablicę wskaźników do ustawienia środowiska.
