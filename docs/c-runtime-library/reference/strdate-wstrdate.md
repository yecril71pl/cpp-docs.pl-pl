...
**_wstrdate** to dwubajtowa wersja **_strdate**; argument i wartość zwracana przez **_wstrdate** są ciągami znaków dwubajtowych. Funkcje te zachowują się identycznie w inny sposób.
