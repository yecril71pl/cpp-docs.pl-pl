...
Funkcja **_strlwr_s** konwertuje na miejsce wszystkie wielkie litery w *str* do małych liter. **_mbslwr_s** to dwubajtowa wersja znaku **_strlwr_s**. **_wcslwr_s** to dwubajtowa wersja **_strlwr_s**.
