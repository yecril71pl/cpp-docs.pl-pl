...
Funkcja **_strlwr** konwertuje każdą wielką literę w *str* na małe litery zgodnie z ustawieniami kategorii **LC_CTYPE** ustawień regionalnych. Inne znaki nie są modyfikowane. Aby uzyskać więcej informacji na temat **LC_CTYPE**, zobacz [setlocale](setlocale-wsetlocale.md). Wersje tych funkcji bez sufiksu **_l** używają bieżących ustawień regionalnych dla zachowań zależnych od ustawień regionalnych. wersje z sufiksem **_l** są identyczne, z tą różnicą, że w zamian korzystają z przekazaną ustawieniami regionalnymi. Aby uzyskać więcej informacji, zobacz [Ustawienia regionalne](../../c-runtime-library/locale.md).

**_Wcslwr** i **_mbslwr** funkcje są wersjami znaków dwubajtowych i znaków wieloznacznych **_strlwr**. Argument i zwracana wartość **_wcslwr** są ciągami znaków dwubajtowych; te **_mbslwr** są ciągami znaków wielobajtowych. Te trzy funkcje zachowują się identycznie w inny sposób.
