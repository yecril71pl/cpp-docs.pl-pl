...
ms.locfileid: "81316891"
---
# <a name="_strset-_strset_l-_wcsset-_wcsset_l-_mbsset-_mbsset_l"></a>_strset, _strset_l, _wcsset, _wcsset_l, _mbsset, _mbsset_l

Ustawia znaki ciągu na znak. Dostępne są bezpieczniejsze wersje tych funkcji; [zobacz _strset_s, _strset_s_l, _wcsset_s, _wcsset_s_l, _mbsset_s, _mbsset_s_l](strset-s-strset-s-l-wcsset-s-wcsset-s-l-mbsset-s-mbsset-s-l.md).

> [!IMPORTANT]
> **_mbsset** i **_mbsset_l** nie mogą być używane w aplikacjach wykonywanych w czasie wykonywania systemu Windows. Aby uzyskać więcej informacji, zobacz [funkcje CRT nieobjęte w aplikacjach platformy uniwersalnej systemu Windows](../../cppcx/crt-functions-not-supported-in-universal-windows-platform-apps.md).
...
Funkcja **_strset** ustawia wszystkie znaki (z wyjątkiem kończącego się znaku null) *od str* do *c,* konwertowane na **char**. **_wcsset** i **_mbsset_l** są wersjami **_strset o**szerokich i wielobajtowych znakach, a typy danych argumentów i wartości zwracane różnią się odpowiednio. Te funkcje zachowują się identycznie w przeciwnym razie.

**_mbsset** sprawdza poprawność jego parametrów. Jeśli *str* jest wskaźnikiem zerowym, wywoływany jest nieprawidłowy program obsługi parametrów, zgodnie z opisem w [programie Sprawdzanie poprawności parametru.](../../c-runtime-library/parameter-validation.md) Jeśli wykonanie jest dozwolone, **_mbsset** zwraca **wartość NULL** i ustawia **errno** na **EINVAL**. **_strset** i **_wcsset** nie sprawdzają poprawności swoich parametrów.
