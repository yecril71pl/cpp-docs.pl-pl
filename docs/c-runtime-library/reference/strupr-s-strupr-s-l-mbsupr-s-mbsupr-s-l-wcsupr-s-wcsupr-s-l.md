...
Funkcja **_strupr_s** konwertuje na miejsce każdą małą literę w *str* na wielkie litery. **_wcsupr_s** to wersja znaku dwubajtowego **_strupr_s**. **_mbsupr_s** jest wersja znaku wielobajtowego **_strupr_s**.
...
|**_wcsupr_s**, **_wcsupr_s_l**, **_mbsupr_s** **_mbsupr_s_l**|\<ciąg. h> lub \<WCHAR. h>|

Aby uzyskać dodatkowe informacje o zgodności, zobacz [zgodność](../../c-runtime-library/compatibility.md).

## <a name="example"></a>Przykład

Zapoznaj się z przykładem [_strlwr_s, _strlwr_s_l, _mbslwr_s, _mbslwr_s_l, _wcslwr_s, _wcslwr_s_l](strlwr-s-strlwr-s-l-mbslwr-s-mbslwr-s-l-wcslwr-s-wcslwr-s-l.md) .
