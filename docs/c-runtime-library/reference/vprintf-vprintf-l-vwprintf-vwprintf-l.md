...
ms.locfileid: "32414822"
---
# <a name="vprintf-vprintfl-vwprintf-vwprintfl"></a>vprintf, _vprintf_l, vwprintf, _vwprintf_l

Zapisuje dane wyjściowe w formacie za pomocą wskaźnika do listy argumentów. Dostępne są bardziej bezpieczne wersje tych funkcji, zobacz [vprintf_s —, _vprintf_s_l —, vwprintf_s —, _vwprintf_s_l —](vprintf-s-vprintf-s-l-vwprintf-s-vwprintf-s-l.md).
...
**vwprintf —** jest wersja znaków dwubajtowych **vprintf —**; dwie funkcje zachowują się tak samo, jakby strumień jest otwarty w trybie ANSI. **vprintf —** aktualnie nie obsługuje dane wyjściowe do strumienia UNICODE.
