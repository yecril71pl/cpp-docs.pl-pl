...
W tej sekcji wymieniono i opisano procedury biblioteki wykonawczej Microsoft według kategorii. Dla wygody odwołanie niektóre procedury są wyświetlane w więcej niż jedną kategorię. Procedury znaków wielobajtowych i procedury znaków dwubajtowych są zgrupowane z jednobajtowe - odpowiedniki znak, jeśli takie istnieją.  
  
 Główne kategorie są procedury biblioteki wykonawczej firmy Microsoft:  
...
|[Dane wejściowe i wyjściowe](../c-runtime-library/input-and-output.md)|[Przystosowywanie do warunków międzynarodowych](../c-runtime-library/internationalization.md)|  
|[Alokacja pamięci](../c-runtime-library/memory-allocation.md)|[Proces i kontroli środowiska](../c-runtime-library/process-and-environment-control.md)|  
|[Niezawodności](../c-runtime-library/robustness.md)|[Sprawdzanie błędów czasu wykonywania](../c-runtime-library/run-time-error-checking.md)|  
