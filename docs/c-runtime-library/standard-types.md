...
|`div_t``ldiv_t`i `lldiv_t` struktury|Wartości są przechowywane odpowiednio przez [DIV](../c-runtime-library/reference/div.md), [ldiv](../c-runtime-library/reference/ldiv-lldiv.md)i [LLDiv](../c-runtime-library/reference/ldiv-lldiv.md).|STDLIB.H|
