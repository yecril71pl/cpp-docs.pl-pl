...
|[umieszcza _putws —](../c-runtime-library/reference/puts-putws.md)|Zapisz wiersz do strumienia|  
|[_putw —](../c-runtime-library/reference/putw.md)|Zapisywania danych binarnych `int` do strumienia|  
|[przewijanie do tyłu](../c-runtime-library/reference/rewind.md)|Przenieś na początek strumienia położenie pliku|  
