 ...
 **_Ftime —** i **konwersję** użyć procedury **TZ** zmiennej środowiskowej. Jeśli **TZ** nie jest ustawiona, biblioteki wykonawczej próbuje użyć informacji o strefie czasowej, określony przez system operacyjny. Jeśli te informacje są niedostępne, te funkcje użyć wartości domyślnej PST8PDT. Aby uzyskać więcej informacji na temat **TZ**, zobacz [_tzset —](../c-runtime-library/reference/tzset.md); Zobacz też [_daylight, strefa czasowa i _tzname](../c-runtime-library/daylight-dstbias-timezone-and-tzname.md).

### <a name="time-routines"></a>Procedury czasu

|Funkcja|Zastosowanie|
|--------------|---------|
|[asctime —, _wasctime —](../c-runtime-library/reference/asctime-wasctime.md), [asctime_s —, _wasctime_s —](../c-runtime-library/reference/asctime-s-wasctime-s.md)|Konwertować z typu czasu **tm struktury** do ciągu znaków. Wersje tych funkcji z **_s** sufiks są bardziej bezpieczne.|
|[clock](../c-runtime-library/reference/clock.md)|Zwraca czas zegara wall czas procesu.|
...
|[_tzset](../c-runtime-library/reference/tzset.md)|Ustaw zmienne czas zewnętrzny w zmiennej środowiskowej czasu **TZ**.|
