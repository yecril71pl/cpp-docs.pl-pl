...
Aby uzyskać informacje dotyczące obsługi wyjątków w aplikacjach CLR, zobacz [obsługi wyjątków (C + +/ CLI i C + +/ CX)](../extensions/exception-handling-cpp-component-extensions.md).
