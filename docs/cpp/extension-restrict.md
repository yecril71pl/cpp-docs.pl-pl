...
- **Element __restrict** przypomina **ograniczyć** z specyfikacje C99, ale **element __restrict** mogą być używane w C++ lub programów C.
...
W programie Visual Studio 2015 i nowszych **element __restrict** mogą być używane na C++ odwołania.
