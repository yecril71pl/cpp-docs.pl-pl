...
ms.locfileid: "32417471"
---
# <a name="floating-limits"></a>Limity liczb zmiennoprzecinkowych
**Microsoft Specific**  
  
 W poniższej tabeli wymieniono limity dla stałych zmiennoprzecinkowych wartości. Te limity również są zdefiniowane w pliku standardowy nagłówek \<float.h — >.  
