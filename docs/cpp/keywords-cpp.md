---
title: "Słowa kluczowe (C++) | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
||||  
|-|-|-|  
|[__abstract](../dotnet/declaration-of-a-managed-class-type.md) <sup>2</sup>|[Operator __alignof](../cpp/alignof-operator.md)|[__asm](../assembler/inline/asm.md)|  
...
|[Tablica](../windows/arrays-cpp-component-extensions.md)|[Automatycznie](../cpp/auto-keyword.md)|[bool](../cpp/bool-cpp.md)|  
...
|[Operator const_cast](../cpp/const-cast-operator.md)|[continue](../cpp/continue-statement-cpp.md)|[decltype](../cpp/decltype-cpp.md)|  
...
|[przestarzałe](../cpp/deprecated-cpp.md) <sup>1</sup>|[dllexport](../cpp/dllexport-dllimport.md) <sup>1</sup>|[DllImport](../cpp/dllexport-dllimport.md) <sup>1</sup>|  
|[do](../cpp/do-while-statement-cpp.md)|[double](../cpp/fundamental-types-cpp.md)|[dynamic_cast](../cpp/dynamic-cast-operator.md)|  
|[else](../cpp/if-else-statement-cpp.md)|[enum](../cpp/enumerations-cpp.md)|[Enum — klasa](../windows/enum-class-cpp-component-extensions.md)|  
...
|[ogólny](../windows/generics-cpp-component-extensions.md)|[goto](../cpp/goto-statement-cpp.md)|[Jeśli](../cpp/if-else-statement-cpp.md)|  
|[InitOnly](../dotnet/initonly-cpp-cli.md)|[wbudowany](../cpp/inline-functions-cpp.md)|[int](../cpp/fundamental-types-cpp.md)|  
|[klasy interfejsu](../windows/interface-class-cpp-component-extensions.md)|[struct — interfejs](../windows/interface-class-cpp-component-extensions.md)|[interior_ptr](../windows/interior-ptr-cpp-cli.md)|  
|[literału](../windows/literal-cpp-component-extensions.md)|[long](../cpp/fundamental-types-cpp.md)|[modyfikowalna](../cpp/mutable-data-members-cpp.md)|  
...
|[operator](../cpp/operator-overloading.md)|[private](../cpp/private-cpp.md)|[właściwość](../windows/property-cpp-component-extensions.md)|  
|[Właściwość](../cpp/property-cpp.md) <sup>1</sup>|[protected](../cpp/protected-cpp.md)|[public](../cpp/public-cpp.md)|  
|[Klasa REF](../windows/classes-and-structs-cpp-component-extensions.md)|[REF — struktura](../windows/classes-and-structs-cpp-component-extensions.md)|[Rejestr](../cpp/storage-classes-cpp.md#register)|  
...
|[podpisany](../cpp/fundamental-types-cpp.md)|[sizeof](../cpp/sizeof-operator.md)|[static](storage-classes-cpp.md)|  
|[static_assert](../cpp/static-assert.md)|[static_cast](../cpp/static-cast-operator.md)|[struct](../cpp/struct-cpp.md)|  
|[switch](../cpp/switch-statement-cpp.md)|[szablon](templates-cpp.md)|[this](../cpp/this-pointer.md)|  
|[Wątek](../cpp/thread.md) <sup>1</sup>|[throw](../cpp/try-throw-and-catch-statements-cpp.md)|[true](../cpp/true-cpp.md)|  
|[Spróbuj](../cpp/try-throw-and-catch-statements-cpp.md)|[Element TypeDef](aliases-and-typedefs-cpp.md)|[TypeID](../cpp/typeid-operator.md)|  
|[TypeID](../windows/typeid-cpp-component-extensions.md)|[typename](../cpp/typename.md)|[Unii](../cpp/unions.md)|  
|[bez znaku](../cpp/fundamental-types-cpp.md)|[przy użyciu](../cpp/using-declaration.md) deklaracji, [przy użyciu](namespaces-cpp.md#using_directives) — dyrektywa|[Identyfikator UUID](../cpp/uuid-cpp.md) <sup>1</sup>|  
|[Klasa wartości](../windows/classes-and-structs-cpp-component-extensions.md)|[wartość — Struktura](../windows/classes-and-structs-cpp-component-extensions.md)|[virtual](../cpp/virtual-cpp.md)|  
|[void](../cpp/void-cpp.md)|[volatile](../cpp/volatile-cpp.md)|[while](../cpp/while-statement-cpp.md)|  
  
 Atrybuty rozszerzone 1 `__declspec` — słowo kluczowe.  
  
 2 dotyczy Managed Extensions for C++ tylko. Ta składnia jest już przestarzały.  
  
 Wewnętrzna funkcja 3 używane w obsłudze zdarzeń.  
  
 Zobacz [Component Extensions dla platform środowiska uruchomieniowego](../windows/component-extensions-for-runtime-platforms.md) Aby uzyskać więcej informacji.  
  
## <a name="microsoft-specific"></a>Specyficzne dla firmy Microsoft  
 W Microsoft C++ identyfikatorów o dwóch wiodące znaki podkreślenia są zarezerwowane do implementacji kompilatora. W związku z tym Konwencji firmy Microsoft jest poprzedzać słowa kluczowe specyficzne dla firmy Microsoft z podwójne znaki podkreślenia. Te słowa nie można użyć jako nazwy identyfikatora.  
  
 Rozszerzenia Microsoft są domyślnie włączone. Aby zapewnić pełni dostosowane programy, można wyłączyć rozszerzenia Microsoft określając ANSI zgodnego [/Za](../build/reference/za-ze-disable-language-extensions.md) opcji wiersza polecenia (Kompiluj zgodność ANSI) podczas kompilacji. Gdy to zrobisz, słowa kluczowe specyficzne dla firmy Microsoft są wyłączone.  
  
 Po włączeniu rozszerzenia Microsoft, można użyć słowa kluczowe specyficzne dla firmy Microsoft w programach. Zgodność ANSI słowa kluczowe są poprzedzone podwójnego podkreślenia. Zgodności z poprzednimi wersjami podkreślenia jednym wersje wszystkich podkreślenia o podwójnej precyzji słów kluczowych z wyjątkiem `__except`, `__finally`, `__leave`, i `__try` są obsługiwane. Ponadto `__cdecl` jest dostępne nie początkowe podkreślenia.  
  
 `__asm` — Słowo kluczowe zastępuje C++ `asm` składni. `asm`jest zarezerwowany do zachowania zgodności z innych implementacji C++, ale nie jest zaimplementowana. Użyj `__asm`.  
  
 `__based` — Słowo kluczowe ma ograniczoną zastosowania kompilacje docelowym 32-bitowe i 64-bitowych.  
