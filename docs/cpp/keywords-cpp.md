...
|||||
|-|-|-|-|
|[__abstract](../dotnet/declaration-of-a-managed-class-type.md) <sup>2</sup>|[Operator __alignof](alignof-operator.md)|[__asm](../assembler/inline/asm.md)|[__assume](../intrinsics/assume.md)|
...
|[alignas](align-cpp.md)|[Tablica](../windows/arrays-cpp-component-extensions.md)|[auto](auto-keyword.md)|[bool](bool-cpp.md)|
|[break](break-statement-cpp.md)|[przypadek](switch-statement-cpp.md)|[catch](try-throw-and-catch-statements-cpp.md)|[char](fundamental-types-cpp.md)|
...
|[Operator const_cast](const-cast-operator.md)|[constexpr](constexpr-cpp.md)|[continue](continue-statement-cpp.md)|[decltype](decltype-cpp.md)|
|[default](switch-statement-cpp.md)|[delegate](../windows/delegate-cpp-component-extensions.md)|[delete](delete-operator-cpp.md)|[przestarzałe](deprecated-cpp.md) <sup>1</sup>|
...
|[dynamic_cast](dynamic-cast-operator.md)|[else](if-else-statement-cpp.md)|[enum](enumerations-cpp.md)|[Klasa wyliczeniowa](../windows/enum-class-cpp-component-extensions.md)|
|[Struktura wyliczenia](../windows/enum-class-cpp-component-extensions.md)|[event](../windows/event-cpp-component-extensions.md)|[explicit](user-defined-type-conversions-cpp.md)|[extern](using-extern-to-specify-linkage.md)|
|[false](false-cpp.md)|[finally](../dotnet/finally.md)|[float](fundamental-types-cpp.md)|[for](for-statement-cpp.md)|
|[dla każdego w](../dotnet/for-each-in.md)|[friend](friend-cpp.md)|[friend_as](../preprocessor/hash-using-directive-cpp.md)|[gcnew](../windows/ref-new-gcnew-cpp-component-extensions.md)|
|[Ogólny](../windows/generics-cpp-component-extensions.md)|[goto](goto-statement-cpp.md)|[if](if-else-statement-cpp.md)|[InitOnly](../dotnet/initonly-cpp-cli.md)|
|[wbudowane](inline-functions-cpp.md)|[int](fundamental-types-cpp.md)|[Klasa interfejsu](../windows/interface-class-cpp-component-extensions.md)|[Struktura interfejsu](../windows/interface-class-cpp-component-extensions.md)|
|[pomocą interior_ptr](../windows/interior-ptr-cpp-cli.md)|[literał](../windows/literal-cpp-component-extensions.md)|[long](fundamental-types-cpp.md)|[modyfikowalne](mutable-data-members-cpp.md)|
...
|[właściwość](../windows/property-cpp-component-extensions.md)|[Właściwość](property-cpp.md) <sup>1</sup>|[protected](protected-cpp.md)|[public](public-cpp.md)|
|[Klasa REF](../windows/classes-and-structs-cpp-component-extensions.md)|[Struktura REF](../windows/classes-and-structs-cpp-component-extensions.md)|[register](storage-classes-cpp.md#register)|[reinterpret_cast](reinterpret-cast-operator.md)|
...
|[true](true-cpp.md)|[Wypróbuj](try-throw-and-catch-statements-cpp.md)|[Element TypeDef](aliases-and-typedefs-cpp.md)|[TypeID](typeid-operator.md)|
|[TypeID](../windows/typeid-cpp-component-extensions.md)|[typename](typename.md)|[Unia](unions.md)|[Bez znaku](fundamental-types-cpp.md)|
|[za pomocą](using-declaration.md) deklaracji|[za pomocą](namespaces-cpp.md#using_directives) — dyrektywa|[Identyfikator UUID](uuid-cpp.md) <sup>1</sup>|[Klasa wartości](../windows/classes-and-structs-cpp-component-extensions.md)|
|[Struktura wartości](../windows/classes-and-structs-cpp-component-extensions.md)|[virtual](virtual-cpp.md)|[void](void-cpp.md)|[volatile](volatile-cpp.md)|
|[while](while-statement-cpp.md)|


1 atrybuty rozszerzone dla **__declspec** — słowo kluczowe.

2 mające zastosowanie do rozszerzenia zarządzane tylko w języku C++. Ta składnia jest już przestarzały.

3 Wewnętrzna funkcja używaa w obsłudze zdarzeń.
...
Rozszerzenia Microsoft są domyślnie włączone. Aby upewnić się, że Twoje programy są w pełni zgodne, można wyłączyć rozszerzenia Microsoft określając zgodność ANSI [/Za](../build/reference/za-ze-disable-language-extensions.md) opcji wiersza polecenia (Kompiluj dla zgodności ANSI) podczas kompilacji. Gdy to zrobisz, wyłączane są słowa kluczowe specyficzne dla firmy Microsoft.

Po włączeniu rozszerzeń Microsoft, można użyć słowa kluczowe specyficzne dla firmy Microsoft w swoich programach. Dla zachowania zgodności z ANSI te słowa kluczowe są poprzedzone podwójnym podkreśleniem. Dla zgodności z poprzednimi wersjami, wersje pojedynczym podkreśleniem wszystkich podwójnym podkreśleniem słów kluczowych z wyjątkiem **__except**, **__finally**, **__leave**, i **_ _try** są obsługiwane. Ponadto **__cdecl** jest dostępna z bez wiodącego podkreślenia.

**__Asm** — słowo kluczowe zastępuje C++ `asm` składni. `asm` jest zarezerwowana dla zachowania zgodności z innymi implementacjami C++, ale nie zaimplementowana. Użyj **__asm**.
