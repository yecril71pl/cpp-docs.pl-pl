...
<sup>2</sup> mające zastosowanie do rozszerzenia zarządzane tylko w języku C++. Ta składnia jest już przestarzały. Zobacz [Component Extensions dla platform środowiska uruchomieniowego](../windows/component-extensions-for-runtime-platforms.md) Aby uzyskać więcej informacji.
