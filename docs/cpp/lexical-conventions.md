---
title: Konwencje leksykalne | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [Literały definiowane przez użytkownika](../cpp/user-defined-literals-cpp.md)  
 ...
 Ta sekcja ma również [Przegląd tłumaczenia pliku](../cpp/cpp-built-in-operators-precedence-and-associativity.md) tematu.  
