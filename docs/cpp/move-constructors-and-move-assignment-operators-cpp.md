---
title: 'Instrukcje: Zdefiniuj konstruktorów przeniesienia i operatorów przypisania przenoszenia (C++)'
ms.date: 03/05/2018
helpviewer_keywords:
- move constructor [C++]
...
1. W Konstruktorze przenoszącym Przypisz elementy członkowskie danych klasy z obiektu źródłowego do obiektu, który jest konstruowany:
...
1. Przypisz elementy członkowskie danych obiektu źródłowego do wartości domyślnych. Zapobiega to zwalnianiu zasobów (takich jak pamięć) wielokrotnie przez destruktor:
...
1. W operatorze przypisywania przenoszenia Dodaj instrukcję warunkową, która wykonuje żadnej operacji, jeśli użytkownik próbuje przypisać obiekt do samego siebie.
...
1. Zwraca odwołanie do bieżącego obiektu, jak pokazano w poniższym przykładzie:
