...
```  
 ...
 ![Skierowanym grafie acyklicznym](../cpp/media/vc38xj2.gif "vc38XJ2")  
...
> [!NOTE]
>  Grafy acykliczne ukierunkowanej nie są unikatowe dla pojedyncze dziedziczenie. Służą one również opisujący wykresy dziedziczenia wielokrotnego. W tym temacie omówiono [wielokrotne dziedziczenie](http://msdn.microsoft.com/3b74185e-2beb-4e29-8684-441e51d2a2ca).  
