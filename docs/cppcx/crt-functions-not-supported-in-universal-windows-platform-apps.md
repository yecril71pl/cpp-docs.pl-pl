...
|_pclose _pipe _popen _wpopen|Funkcja potoku nie jest dostępne dla aplikacji platformy uniwersalnej systemu Windows.|Brak obejścia.|  
...
|_chdir _wchdir _getcwd _getdcwd _wgetcwd _wgetdcwd|Pojęcie katalog roboczy nie odnoszą się do aplikacji ze Sklepu Windows 8.x.|Zamiast tego użyj pełnej ścieżki.|  
