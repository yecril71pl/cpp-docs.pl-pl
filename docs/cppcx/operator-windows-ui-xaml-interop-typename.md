...
Umożliwia konwersję z `Platform::Type` do [Windows::UI::Xaml::Interop::TypeName](http://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.interop.typename.aspx).  
...
### <a name="return-value"></a>Wartość zwracana  
 Zwraca [Windows::UI::Xaml::Interop::TypeName](http://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.interop.typename.aspx) danego pseudoelementu `Platform::Type^`.  
