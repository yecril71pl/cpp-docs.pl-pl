...
Pierwszy Konstruktor jest konstruktor domyślny, która niejawnie tworzy pustego obiektu. Drugi Konstruktor Określa [__nullptr](../../extensions/nullptr-cpp-component-extensions.md), co powoduje jawne utworzenie pustego obiektu.
