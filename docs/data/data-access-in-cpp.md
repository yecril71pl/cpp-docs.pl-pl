...
[Sterownik OLE DB dla programu SQL Server](/sql/connect/oledb/oledb-driver-for-sql-server)<br/>
...
[Jak używać Blob Storage z C++](/azure/storage/storage-c-plus-plus-how-to-use-blobs)<br/>
...
[Odwołanie do programisty ODBC](/sql/odbc/reference/odbc-programmer-s-reference)<br/>
