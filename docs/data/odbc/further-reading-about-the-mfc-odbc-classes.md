---
title: Dalsze informacje o klasach MFC ODBC | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [Transakcja (ODBC)](../../data/odbc/transaction-odbc.md)  
 ...
 Najlepiej rozpocząć odczytywanie Twojego jest z [zestawu rekordów (ODBC)](../../data/odbc/recordset-odbc.md).  
  
 W *odwołania MFC*, zobacz [cdatabase —](../../mfc/reference/cdatabase-class.md), [crecordset —](../../mfc/reference/crecordset-class.md), [CRecordView](../../mfc/reference/crecordview-class.md), [CFieldExchange](../../mfc/reference/cfieldexchange-class.md), i [CDBException](../../mfc/reference/cdbexception-class.md).  
