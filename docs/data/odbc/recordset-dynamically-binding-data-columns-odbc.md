...
1. Porównanie bieżącej tabeli kolumn i kolumny w przypadku zestawu rekordów powiązanego do tworzenia listy (kolumn do Bind — dynamiczne) kolumn nie jest jeszcze granicy w głównym rekordów.
...
1. Tworzenie listy Dynamic-Values kolumny (jak lista 4 na ilustracji) do przechowywania wartości danych, odpowiadający nazwa kolumny przechowywane na liście kolumn, aby powiązać dynamicznie (kolumn do Bind — dynamiczne).
