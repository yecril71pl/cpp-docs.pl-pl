...
3.  Możesz zakończyć operację — i zwykle Zatwierdzanie aktualizacji — przez wywołanie metody [aktualizacji](../../mfc/reference/crecordset-class.md#update) funkcja elementu członkowskiego.  
