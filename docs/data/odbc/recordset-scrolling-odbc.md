...
2.  Z poprzednimi wersjami jeden rekord lub jednego zestawu wierszy: wywołanie [moveprev —](../../mfc/reference/crecordset-class.md#moveprev) funkcja elementu członkowskiego.  
  
3.  Do pierwszego rekordu w zestawie rekordów: wywołanie [MoveFirst](../../mfc/reference/crecordset-class.md#movefirst) funkcja elementu członkowskiego.  
  
4.  Ostatni rekord w zestawie lub ostatni zestaw wierszy: wywołanie [MoveLast](../../mfc/reference/crecordset-class.md#movelast) funkcja elementu członkowskiego.  
  
5.  *N* rekordów względem bieżącego położenia: wywołanie [przenieść](../../mfc/reference/crecordset-class.md#move) funkcja elementu członkowskiego.  
...
2.  Masz przewiniesz w przód od pierwszego rekordu (przenoszenie do tyłu)? Wywołaj [IsBOF](../../mfc/reference/crecordset-class.md#isbof) funkcja elementu członkowskiego.  
