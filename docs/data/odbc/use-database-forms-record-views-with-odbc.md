---
title: Używanie formularzy bazy danych (widoków rekordów) z ODBC
ms.date: 11/04/2016
helpviewer_keywords:
- ODBC, record views
- record views, ODBC
...
ms.locfileid: "59030066"
---
# <a name="use-database-forms-record-views-with-odbc"></a>Używanie formularzy bazy danych (widoków rekordów) z ODBC

Niektóre aplikacje, takie jak wprowadzanie danych lub wyświetlanie danych wymagają widoku przy użyciu okna dialogowego stylu kontrolki formularza.

## <a name="in-this-section"></a>W tej sekcji

- [Wyświetl dane z bazy danych w formularzu](../../data/record-views-mfc-data-access.md)
