---
title: Praca z dokumentami i widokami
ms.date: 11/04/2016
helpviewer_keywords:
- MFC [C++], documents
- MFC [C++], views
...
Aby uzyskać więcej informacji na temat Używanie klas baz danych w ramach zobacz [MFC: Używanie klas baz danych z dokumentami i widokami](../../data/mfc-using-database-classes-with-documents-and-views.md).
...
Umożliwia także klas baz danych bez korzystania z architektury pełny dokument/widok. Aby uzyskać więcej informacji, zobacz [MFC: Używanie klas baz danych bez dokumentów i widoków](../../data/mfc-using-database-classes-without-documents-and-views.md).
