...
Zobacz [ISourcesRowset::GetSourcesRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms711200(v=vs.85)) w *OLE DB Podręcznik programisty* Aby uzyskać więcej informacji.
