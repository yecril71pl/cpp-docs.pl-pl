---
title: CKeyColumns, CKeyColumnInfo | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Uwagi  
 ...
 Ta klasa identyfikuje kolumny zdefiniowanych w katalogu, które są ograniczone jako klucze przez danego użytkownika.  
  
 W poniższej tabeli wymieniono klasy elementów członkowskich danych i OLE DB kolumny. Zobacz [wierszy KEY_COLUMN_USAGE](https://msdn.microsoft.com/en-us/library/ms712990.aspx) w *OLE DB Podręcznik programisty* Aby uzyskać więcej informacji o schemacie i kolumn.  
