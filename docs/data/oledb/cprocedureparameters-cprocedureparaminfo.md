---
title: CProcedureParameters CProcedureParamInfo | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33097552"
---
# <a name="cprocedureparameters-cprocedureparaminfo"></a>CProcedureParameters CProcedureParamInfo
Call — klasa typedef **CProcedureParameters** do zaimplementowania w klasie parametru **CProcedureParamInfo**.  
...
## <a name="remarks"></a>Uwagi  
 ...
 Ta klasa zwraca informacje na temat parametrów i kody powrotne procedur.  
  
 W poniższej tabeli wymieniono klasy elementów członkowskich danych i OLE DB kolumny. Zobacz [wierszy PROCEDURE_PARAMETERS](https://msdn.microsoft.com/en-us/library/ms713623.aspx) w *OLE DB Podręcznik programisty* Aby uzyskać więcej informacji o schemacie i kolumn.  
...
|m_szParameterName|NAZWA_PARAMETRU|  
