---
title: CRowset::ReleaseRows | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33096915"
---
# <a name="crowsetreleaserows"></a>CRowset::ReleaseRows
Wywołania [IRowset::ReleaseRows](https://msdn.microsoft.com/en-us/library/ms719771.aspx) zwolnienia dojście do bieżącego wiersza.  
