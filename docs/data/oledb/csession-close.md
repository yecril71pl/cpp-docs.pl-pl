---
title: CSession::Close | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33097955"
---
# <a name="csessionclose"></a>CSession::Close
Zamyka sesji, która została otwarta przez [CSession::Open](../../data/oledb/csession-open.md).  
