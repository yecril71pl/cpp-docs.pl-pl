...
## <a name="remarks"></a>Uwagi  
 ...
 W poniższej tabeli wymieniono klasy elementów członkowskich danych i OLE DB kolumny. Zobacz [wierszy statystyki](https://msdn.microsoft.com/en-us/library/ms715957.aspx) w *OLE DB Podręcznik programisty* Aby uzyskać więcej informacji o schemacie i kolumn.  
