---
title: ICommandPropertiesImpl::SetProperties | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>Parametry  
 Zobacz [ICommandProperties::SetProperties](https://msdn.microsoft.com/en-us/library/ms711497.aspx) w *OLE DB Podręcznik programisty*.  
