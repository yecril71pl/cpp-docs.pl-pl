---
title: IErrorRecordsImpl::GetRecordCount | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>Parametry  
 Zobacz [IErrorRecords::GetRecordCount](https://msdn.microsoft.com/en-us/library/ms722724.aspx) w *OLE DB Podręcznik programisty*.  
