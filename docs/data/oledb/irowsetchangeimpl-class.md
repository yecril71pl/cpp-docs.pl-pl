...
*hRowToFlush*<br/>
podczas Dojście do wierszy danych. Typ tego wiersza jest określany na podstawie argumentu szablonu *RowClass* `IRowsetImpl` klasy ( `CSimpleRow` domyślnie).
