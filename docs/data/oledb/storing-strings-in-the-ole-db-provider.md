...
ms.locfileid: "50053230"
---
# <a name="storing-strings-in-the-ole-db-provider"></a>Przechowywanie ciągów w dostawcy OLE DB

W CustomRS.h, ATL OLE DB Provider Kreator tworzy rekord użytkownika domyślnego o nazwie `CWindowsFile`. Aby obsługiwać dwa ciągi, zmodyfikuj `CWindowsFile` lub dodać rekord użytkownika, jak pokazano w poniższym kodzie:
