---
title: Praca z szablonami konsumentów OLE DB | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
-   [Uzyskiwanie metadanych za pomocą zestawów wierszy schematu](../../data/oledb/obtaining-metadata-with-schema-rowsets.md)  
  
-   [Obsługa transakcji w OLE DB](../../data/oledb/supporting-transactions-in-ole-db.md)  
...
-   [Korzystanie z zakładek](../../data/oledb/using-bookmarks.md)  
  
-   [Pobieranie obiektu BLOB](../../data/oledb/retrieving-a-blob.md)  
  
-   [Odbieranie powiadomień](../../data/oledb/receiving-notifications.md)  
  
 Na przykład tworzenia i implementowanie OLE DB konsumenta, zobacz [Tworzenie prostego konsumenta](../../data/oledb/creating-an-ole-db-consumer.md).  
  
 Można również znaleźć przykłady sposobu korzystania z OLE DB konsumenta szablonów w następujących przykładach:  
