...
|[Kopiowanie (STL/CLR)](../dotnet/copy-stl-clr.md)|Kopiuje wartości z zakresu źródła docelowy zakres iteracja w kierunku do przodu.|  
...
|[równości (STL/CLR)](../dotnet/equal-stl-clr.md)|Porównuje dwa zakresy, elementów.|  
...
|[Generowanie (STL/CLR)](../dotnet/generate-stl-clr.md)|Przypisuje wartości generowanych przez obiekt funkcji do każdego elementu w sekwencji wartości.|  
...
|[obejmuje (STL/CLR)](../dotnet/includes-stl-clr.md)|Sprawdza, czy jeden zakres posortowane zawiera wszystkie elementy w drugiego zakresu posortowane.|  
...
|[Niezgodność (STL/CLR)](../dotnet/mismatch-stl-clr.md)|Porównuje dwa zakresy elementów i zwraca pierwszą pozycję, gdzie występuje różnica.|  
...
|[Usuń (STL/CLR)](../dotnet/remove-stl-clr.md)|Usuwa określoną wartość z danego zakresu bez zakłócania kolejność pozostałych elementów i zwraca koniec nowy zakres wolne od określonej wartości.|  
...
|[Wyszukiwanie (STL/CLR)](../dotnet/search-stl-clr.md)|Wyszukuje pierwsze wystąpienie sekwencji w zakresie docelowym, której elementy są równe tym w danej sekwencji elementów lub której elementy są równoważne w sensie określonym przez predykat binarny dla elementów w danej sekwencji.|  
...
|[Sortowanie (STL/CLR)](../dotnet/sort-stl-clr.md)|Rozmieszcza elementy w określonym zakresie w niemalejącej kolejności lub według kryteriów sortowania określonych przez binarny predykat.|  
...
|[Unikatowy (STL/CLR)](../dotnet/unique-stl-clr.md)|Usuwa zduplikowane elementy, które sąsiadują ze sobą w określonym zakresie.|  
