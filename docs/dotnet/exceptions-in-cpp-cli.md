...
ms.locfileid: "62404445"
---
# <a name="exceptions-in-ccli"></a>Wyjątki w języku C++/CLI

Artykuły w tej sekcji dokumentacji wyjaśniają obsługi wyjątków w C++sposób niezamierzony i czym różni się ona od standardowych wyjątków.
...
|[Różnice w zachowaniu obsługi wyjątków w/CLR](../dotnet/differences-in-exception-handling-behavior-under-clr.md)|W tym artykule omówiono różnice między standardowych wyjątków i wyjątków w C++sposób niezamierzony.|
