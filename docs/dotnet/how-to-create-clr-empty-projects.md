---
title: 'Porady: tworzenie pustych projektów CLR | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
1. W obszarze **zainstalowane szablony**, kliknij przycisk **Visual C++** węzła; następnie kliknij przycisk **CLR** węzła. Wybierz **pusty projekt CLR** ikony.

1. W **nazwa** wprowadź unikatową nazwę aplikacji.

    > [!NOTE]
    >  Można również określić inne ustawienia projektu i rozwiązania z **nowy projekt** okno dialogowe, ale te ustawienia nie są wymagane.
