---
title: 'Porady: Definiowanie oraz stosowanie wyliczeń w języku C + +/ interfejsu wiersza polecenia | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
