---
title: Lock::Release | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
## <a name="remarks"></a>Uwagi  
 Jeśli blokada nie jest zablokowany, `release` nie działają.  
  
 Nie trzeba jawnie; wywołanie tej funkcji gdy `lock` obiektu wykracza poza zakresem, jego wywołania destruktora `release`.  
