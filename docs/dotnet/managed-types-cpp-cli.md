...
2.  Najpierw należy wyizolować i odtworzenia wyjątek lub innych warunków błędów. Problem, który występuje z powodu nieaktualnych wyjątku należy do odtworzenia.  
  
3.  Sprawdź sygnaturę czasową wszelkich zestawów, do których odwołuje się do aplikacji.  
  
4.  W przypadku nowszych niż sygnatura czasowa ostatniej kompilacji aplikacji znacznikami czasu dowolne zestawy, do którego istnieje odwołanie, aplikacja jest nieaktualna. Jeśli ten problem wystąpi, ponownie skompilować aplikację przy użyciu najbardziej aktualnych zestawu i wprowadzać żadnych zmian kodu wymaganych.  
  
5.  Uruchom ponownie aplikację, wykonaj kroki odtworzenia problemu, a następnie sprawdź, czy nie występuje wyjątek.  
