...
C2059 może wystąpić, jeśli symbol daje w wyniku nic, co może mieć miejsce, gdy **/D** `symbol` **=** jest używana do kompilowania.
...
Możesz także uzyskać C2059, jeśli zdefiniujesz składowej szablonu klasy lub funkcji spoza klasy. Aby uzyskać informacje, zobacz [artykuł bazy wiedzy 241949](http://support.microsoft.com/kb/241949).
