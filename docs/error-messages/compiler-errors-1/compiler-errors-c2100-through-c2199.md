...
|[Compiler error C2109](compiler-error-c2109.md)|Indeks dolny wymaga tablicy lub wskaźnika typu|
...
|Błąd kompilatora C2119|"*identyfikator*": typ dla "*typu*" nie można wywnioskować na podstawie pustego inicjalizatora|
...
|Błąd kompilatora C2123|"*identyfikator*": szablony aliasów nie może być jawnie lub częściowo specjalizowany|
|[Błąd kompilatora C2124](compiler-error-c2124.md)|Dzielenie lub dzielenie modulo przez zero|
|Błąd kompilatora C2125|"constexpr" jest niezgodna z "*tokenu*"|
|Błąd kompilatora C2126|"*identyfikator*" nie można zadeklarować ze specyfikatorem "constexpr"|
|Błąd kompilatora C2127|"*identyfikator*": niedozwolone inicjowanie elementu "constexpr" jednostki o niestałe wyrażenie|
...
|[Błąd kompilatora C2131](compiler-error-c2131.md)|Wyrażenie nie zostało obliczone do stałej|
...
|Błąd kompilatora C2136|Tworzenie kontrakt interfejsu API, które nie są dozwolone|
...
|[Compiler error C2151](compiler-error-c2151.md)|więcej niż jeden atrybut językowy|
|[Compiler error C2152](compiler-error-c2152.md)|"*identyfikator*": wskaźniki do funkcji z różnymi atrybutami|
...
|[Compiler error C2156](compiler-error-c2156.md)|pragma musi znajdować się poza funkcją|
...
|[Compiler error C2159](compiler-error-c2159.md)|więcej niż jedną klasę magazynu określony|
...
|[Compiler error C2169](compiler-error-c2169.md)|"*funkcja*": wewnętrzna funkcja nie może być zdefiniowana|
...
|Błąd kompilatora C2176|instrukcja return nie może występować w procedurze obsługi funkcji bloku "try" skojarzonym z konstruktorem|
...
|Błąd kompilatora C2187|Błąd składniowy: "*tokenu*' była Nieoczekiwana w tym miejscu|
|[Błąd kompilatora C2188](compiler-error-c2188.md)|"*numer*": zbyt duży dla znaku dwubajtowego|
|Błąd kompilatora C2189|Nie można zastosować atrybutu "alignas" do pola bitowego, parametru funkcji, deklaracji wyjątku lub zmiennej zadeklarowanej przy użyciu klasy magazynu "register"|
|[Błąd kompilatora C2190](compiler-error-c2190.md)|Pierwsza lista parametrów dłuższa niż druga|
|[Compiler error C2191](compiler-error-c2191.md)|druga lista parametrów dłuższa niż pierwsza|
...
|[Compiler error C2196](compiler-error-c2196.md)|wartość Case "*wartość*" już użyta|
...
|[Compiler error C2199](compiler-error-c2199.md)|Błąd składniowy: znaleziono "*identyfikator* (" w zakresie globalnym (była deklaracja jest zamierzona?)|
