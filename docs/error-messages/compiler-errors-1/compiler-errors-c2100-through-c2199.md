...
|Błąd|Komunikat|
|-----------|-------------|
|[Błąd kompilatora C2100](compiler-error-c2100.md)|Niedozwolony element pośredni|
|[Błąd kompilatora C2101](compiler-error-c2101.md)|"&" dla stałej|
|[Błąd kompilatora C2102](compiler-error-c2102.md)|"&" wymaga wartości l|
|[Błąd kompilatora C2103](compiler-error-c2103.md)|"&" zarejestrować zmiennej|
...
|[Błąd kompilatora C2106](compiler-error-c2106.md)|"*operator*": lewy operand musi być l-value|
|[Błąd kompilatora C2107](compiler-error-c2107.md)|Nieprawidłowy indeks, pośrednik niedozwolony|
|[Błąd kompilatora C2108](compiler-error-c2108.md)|Indeks dolny nie jest typu całkowitego|
...
|[Błąd kompilatora C2116](compiler-error-c2116.md)|listy parametrów funkcji różnią się|
|[Błąd kompilatora C2117](compiler-error-c2117.md)|"*identyfikator*": przepełnienie granic tablicy|
|[Błąd kompilatora C2118](compiler-error-c2118.md)|Indeks dolny ujemna|
...
|[Błąd kompilatora C2135](compiler-error-c2135.md)|"*operator*": operacja na polu bitowym niedozwolony|
|C2136 błąd kompilatora|niedozwolone kontrakt interfejsu API tworzenia|
|[Błąd kompilatora C2137](compiler-error-c2137.md)|Stała znakowa pusty|
|[Błąd kompilatora C2138](compiler-error-c2138.md)|niedozwolone jest zdefiniowanie wyliczenia bez elementów członkowskich|
|[Błąd kompilatora C2139](compiler-error-c2139.md)|"*klasy*": Niezdefiniowana klasa nie jest dozwolona jako argument typu wewnętrznej cechy kompilatora "*cechy*"|
|[Błąd kompilatora C2140](compiler-error-c2140.md)|"*typu*": typ, który jest zależny od parametru typu ogólnego nie jest dozwolona jako argument typu wewnętrznej cechy kompilatora "*cechy*"|
|[Błąd kompilatora C2141](compiler-error-c2141.md)|przepełnienie rozmiar tablicy|
...
|[Błąd kompilatora C2144](compiler-error-c2144.md)|Błąd składniowy: "*typu*"powinien być poprzedzony przez"*token2*"|
...
|[Błąd kompilatora C2147](compiler-error-c2147.md)|Błąd składniowy: "*tokenu*" jest nowym słowem kluczowym|
|[Błąd kompilatora C2148](compiler-error-c2148.md)|Całkowity rozmiar tablicy nie może przekraczać 0 x*wartość* bajtów|
...
|[Błąd kompilatora C2154](compiler-error-c2154.md)|"*typu*": tylko typ wyliczeniowy jest dozwolony jako argument typu wewnętrznej cechy kompilatora "*cechy*"|
...
|[Błąd kompilatora C2158](compiler-error-c2158.md)|"*typu*': dyrektywa #pragma make_public jest obecnie obsługiwany tylko w przypadku natywnych nieszablonowych typów|
|[Błąd kompilatora C2159](compiler-error-c2159.md)|Określono więcej niż jednej klasy magazynu|
|[Błąd kompilatora C2160](compiler-error-c2160.md)|"##" nie może występować na początku definicji makra|
|[Błąd kompilatora C2161](compiler-error-c2161.md)|"##" nie może występować na końcu definicji makra|
...
|[Błąd kompilatora C2177](compiler-error-c2177.md)|stała jest za duży|
|[Błąd kompilatora C2178](compiler-error-c2178.md)|"*identyfikator*"nie mogą być zadeklarowane z"*specyfikator*" Specyfikator|
...
|[Błąd kompilatora C2181](compiler-error-c2181.md)|Niedozwolona instrukcja else bez zgodnej instrukcji if|
|[Błąd kompilatora C2182](compiler-error-c2182.md)|"*identyfikator*": niedozwolone użycie typu "void"|
|[Błąd kompilatora C2183](compiler-error-c2183.md)|Błąd składniowy: jednostka tłumaczenia jest pusta|
...
|[Błąd kompilatora C2192](compiler-error-c2192.md)|Parametr "*numer*" innej deklaracji|
...
|[Błąd kompilatora C2196](compiler-error-c2196.md)|przypadek wartość "*wartość*" już używana|
|[Błąd kompilatora C2197](compiler-error-c2197.md)|"*funkcja*": za dużo argumentów dla wywołania|
|[Błąd kompilatora C2198](compiler-error-c2198.md)|"*funkcja*": zbyt mało argumentów dla wywołania|
|[Błąd kompilatora C2199](compiler-error-c2199.md)|Błąd składniowy: znaleziono "*identyfikator* (" w zakresie globalnym (czy deklaracja jest zamierzona?)|  