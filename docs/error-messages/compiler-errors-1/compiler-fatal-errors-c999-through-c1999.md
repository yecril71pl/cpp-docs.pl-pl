...
|Błąd krytyczny C1012|niedopasowane nawiasy: brakuje "*znak*"|
|Błąd krytyczny C1013|ograniczenie kompilatora: zbyt wiele otwartych nawiasów|
|Błąd krytyczny C1014|zbyt wiele pliki dołączane: głębokość = *numer*|
...
|Błąd krytyczny C1047|Plik obiektu lub biblioteki "*pliku*' został utworzony za pomocą starszego kompilatora niż inne obiekty; obiekty stare ponownej kompilacji i biblioteki|
...
|Błąd krytyczny C1070|Niezgodność #if / #endif pair w pliku "*pliku*"|
...
|Błąd krytyczny C1109|Nie można odnaleźć '*symbol*"w pliku DLL"*pliku*"|
...
|Błąd krytyczny C1196|"*identyfikator*": identyfikator znaleziony w bibliotece typów "*typelib*" nie jest prawidłowym identyfikatorem języka C++|
...
|Błąd krytyczny C1205|Typy ogólne nie są obsługiwane przez wersję zainstalowanego środowiska uruchomieniowego|
|Błąd krytyczny C1206|Dane dla domeny appdomain nie są obsługiwane przez wersję zainstalowanego środowiska uruchomieniowego|
|Błąd krytyczny C1207|Zarządzane szablony nie są obsługiwane przez wersję zainstalowanego środowiska uruchomieniowego|
|Błąd krytyczny C1208|Przydzielanie klas odwołujących na stosie nie jest obsługiwana przez wersję zainstalowanego środowiska uruchomieniowego|
|Błąd krytyczny C1209|Przyjazne zestawy nie są obsługiwane przez wersję zainstalowanego środowiska uruchomieniowego|
|Błąd krytyczny C1210|/ CLR: pure i/CLR: Safe nie są obsługiwane przez wersję zainstalowanego środowiska uruchomieniowego|
|Błąd krytyczny C1211|Atrybut niestandardowy TypeForwardedTo nie jest obsługiwany przez wersję zainstalowanego środowiska uruchomieniowego|
...
|Błąd krytyczny C1312|Zbyt wiele warunkowych gałęzi w funkcji.  Uprość lub zrefaktoryzuj kod źródłowy.|
...
|Błąd krytyczny C1904|Zły dostawca interakcji: "*pliku*"|
