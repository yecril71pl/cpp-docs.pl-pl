---
title: Błąd kompilatora C2664 | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Aby uzyskać więcej informacji, zobacz [porady: konwertowanie obiektu System::String na wchar_t * lub char\*](../../dotnet/how-to-convert-system-string-to-wchar-t-star-or-char-star.md).
...
Zmienna enum nie jest konwertowana na jej typ podstawowy, tak aby wywołanie funkcji zostało spełnione. Aby uzyskać więcej informacji, zobacz [klasa wyliczeniowa](../../windows/enum-class-cpp-component-extensions.md). Poniższy przykład generuje C2664 i pokazuje, jak go naprawić.
