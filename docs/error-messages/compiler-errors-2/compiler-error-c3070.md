...
ms.locfileid: "74758206"
---
# <a name="compiler-error-c3070"></a>Błąd kompilatora C3070

Właściwość "Property": właściwość nie ma metody "Set"

Metoda akcesora ustawiania właściwości nie została zdefiniowana. Aby uzyskać więcej informacji, zobacz [Właściwość](../../extensions/property-cpp-component-extensions.md).
