---
title: C3373 błąd kompilatora | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33254501"
---
# <a name="compiler-error-c3373"></a>C3373 błąd kompilatora
Atrybut 'attribute' nie przyjmuje żadnych argumentów z wyjątkiem klasy coclass  
  
 Niektóre atrybuty może odnosić się do więcej niż jednego konstrukcji języka C++, ale argumenty atrybutu może być dozwolone tylko dla niektórych konstrukcje.  
