...
ms.locfileid: "58767135"
---
# <a name="compiler-error-c3393"></a>Błąd kompilatora C3393

Błąd składni w klauzuli ograniczenia: 'Identyfikator' nie jest typem

Identyfikator przekazany do ograniczenia, który musi być typem, nie jest typem.  Aby uzyskać więcej informacji, zobacz [ograniczenia dotyczące parametrów typu ogólnego (C + +/ CLI)](../../extensions/constraints-on-generic-type-parameters-cpp-cli.md).
