...
ms.locfileid: "62227114"
---
# <a name="compiler-error-c3744"></a>Błąd kompilatora C3744

__unhook musi mieć co najmniej 3 argumenty dla zdarzeń zarządzanych

[__Unhook](../../cpp/unhook.md) funkcji, należy wykonać trzy parametry, gdy jest używana w programie, który jest kompilowany dla zarządzanych rozszerzeń dla C++.
