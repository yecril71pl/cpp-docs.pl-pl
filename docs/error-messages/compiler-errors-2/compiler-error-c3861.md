...
### <a name="identifier-not-in-scope"></a>Identyfikator nie jest w zasięgu
...
### <a name="namespace-qualification-required"></a>Kwalifikacja Namespace wymagane
...
### <a name="adl-and-friend-functions"></a>Funkcje ADL i friend

Poniższy przykład generuje C3767, ponieważ kompilator nie można użyć argumentu zależnych wyszukiwanie `FriendFunc`:
