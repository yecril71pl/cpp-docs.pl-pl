...
|Błąd|Komunikat|
|-----------|-------------|
|[Błąd kompilatora C2700](compiler-error-c2700.md)|"*typu*": nie może zostać rzucony (Użyj/W4 Aby uzyskać więcej informacji)|
|[Błąd kompilatora C2701](compiler-error-c2701.md)|"*funkcja*": szablon funkcji/ogólny nie może być zaprzyjaźniona z lokalną klasą|
|[Błąd kompilatora C2702](compiler-error-c2702.md)| __except mogą nie są wyświetlane w bloku|
|[Błąd kompilatora C2703](compiler-error-c2703.md)|Niedozwolona instrukcja __leave|
|[Błąd kompilatora C2704](compiler-error-c2704.md)|"*funkcja*": __va_start dozwolone tylko w varargs wewnętrzne|
...
|[Błąd kompilatora C2712](compiler-error-c2712.md)|Nie można Użyj __try w funkcjach, które wymagają rozwinięcia obiektu|
...
|[Błąd kompilatora C2751](compiler-error-c2751.md)|"*parametr*": nie może być kwalifikowana nazwa parametru funkcji|
|[Błąd kompilatora C2752](compiler-error-c2752.md)|"*szablonu*": więcej niż jedna składowa specjalizacji pasuje do listy argumentów szablonu|
|[Błąd kompilatora C2753](compiler-error-c2753.md)|"*szablonu*": specjalizacji nie odpowiada liście argumentów dla podstawowego szablonu|
...
|[Błąd kompilatora C2755](compiler-error-c2755.md)|"*parametr*": parametr typu innego niż stała parametryzująca składowej specjalizacji musi być prostym identyfikatorem|
...
|[Błąd kompilatora C2779](compiler-error-c2779.md)|"*deklaracji*": metody właściwości mogą być skojarzony tylko z danych niestatycznych elementów członkowskich|
|[Błąd kompilatora C2780](compiler-error-c2780.md)|"*deklaracji*": oczekuje *numer* argumentów - *numer* podany|
|[Błąd kompilatora C2781](compiler-error-c2781.md)|"*deklaracji*": oczekuje co najmniej *numer* argument - *numer* podany|
|[Błąd kompilatora C2782](compiler-error-c2782.md)|"*deklaracji*": parametr szablonu/ogólne "*parametr*" jest niejednoznaczny|
|[Błąd kompilatora C2783](compiler-error-c2783.md)|"*deklaracji*": nie można wywnioskować argumentu szablonu/ogólne dla "*identyfikator*"|
|[Błąd kompilatora C2784](compiler-error-c2784.md)|"*deklaracji*": nie można wywnioskować argumentu szablonu/ogólne dla "*type1*"from"*type2*"|
