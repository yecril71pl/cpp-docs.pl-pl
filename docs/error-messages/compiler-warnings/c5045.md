...
To ostrzeżenie jest Nowość w programie Visual Studio 2017 w wersji 15,7 i jest domyślnie wyłączone. Użyj [/Wall](../../build/reference/compiler-option-warning-level.md) , aby włączyć wszystkie ostrzeżenia, które są domyślnie wyłączone, lub __/w__*n*__5038__ , aby włączyć C5045 jako ostrzeżenie poziomu *n* . W środowisku IDE domyślny poziom ostrzeżeń to **/W3** , a to ostrzeżenie można włączyć w oknie dialogowym **strony właściwości** projektu. Otwórz **Właściwości konfiguracji** > **wiersz polecenia** **CC++ /**  > i w polu **dodatkowe opcje** Dodaj */w35045*, a następnie wybierz **przycisk OK**. Aby uzyskać więcej informacji, zobacz [ostrzeżenia kompilatora, które są domyślnie wyłączone](../../preprocessor/compiler-warnings-that-are-off-by-default.md). Aby uzyskać informacje na temat sposobu wyłączania ostrzeżeń przez wersję kompilatora, zobacz [ostrzeżenia kompilatora według wersji kompilatora](compiler-warnings-by-compiler-version.md).
