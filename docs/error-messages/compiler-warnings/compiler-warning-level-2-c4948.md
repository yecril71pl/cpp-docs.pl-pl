---
title: Kompilatora (poziom 2) ostrzeżenie C4948 | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Kompilator znaleziono niezgodność typu danych jest jest pobrać i ustawić dla właściwości indeksowanej.  
  
C4948 jest tylko przy użyciu opcji kompilatora przestarzałe **: oldsyntax**.  
