...
ms.locfileid: "86491378"
---
# <a name="compiler-warnings-by-compiler-version"></a>Ostrzeżenia kompilatora według wersji kompilatora

Kompilator może pominąć ostrzeżenia, które zostały wprowadzone po określonej przez Ciebie wersji przy użyciu [`/Wv`](../../build/reference/compiler-option-warning-level.md) opcji kompilatora. Ta opcja jest przydatna do zarządzania procesem kompilacji po wprowadzeniu nowej wersji zestawu narzędzi i zamiarem tymczasowego pomijania nowych ostrzeżeń. Ta opcja powoduje pominięcie tylko ostrzeżeń, a nie nowych komunikatów o błędach. Nie pomijaj trwale wszystkich nowych ostrzeżeń! Zalecamy, aby zawsze kompilować na najwyższym poziomie ostrzeżeń, **`/W4`** i usunąć **`/Wv`** opcję z kompilacji tak szybko, jak to możliwe.

W tych wersjach kompilatora wprowadzono nowe ostrzeżenia:

| Produkt | Numer wersji kompilatora |
|--|--|
| Program Visual Studio 2002 | 13.00.9466 |
| Program Visual Studio 2003 | 13.10.3077 |
...
| Visual Studio 2017, wersja 15.3 | 19.11.25506.0 |
| Visual Studio 2017, wersja 15.5 | 19.12.25830.0 |
...
| Visual Studio 2019 w wersji 16.1 | 19.21.27702.0 |
|  Program Visual Studio 2019 w wersji 16.2  | 19.22.27905.0 |
| Visual Studio 2019 w wersji 16,3 | 19.23.28105.0 |
...
## <a name="warnings-introduced-in-visual-studio-2019-version-166-compiler-version-1926288050"></a>Ostrzeżenia wprowadzone w programie Visual Studio 2019 w wersji 16,6 (kompilator w wersji 19.26.28805.0)
...
## <a name="warnings-introduced-in-visual-studio-2019-version-165-compiler-version-1925286100"></a>Ostrzeżenia wprowadzone w programie Visual Studio 2019 w wersji 16,5 (kompilator w wersji 19.25.28610.0)
...
## <a name="warnings-introduced-in-visual-studio-2019-version-164-compiler-version-1924283140"></a>Ostrzeżenia wprowadzone w programie Visual Studio 2019 w wersji 16,4 (kompilator w wersji 19.24.28314.0)
...
## <a name="warnings-introduced-in-visual-studio-2019-version-163-compiler-version-1923281050"></a>Ostrzeżenia wprowadzone w programie Visual Studio 2019 w wersji 16,3 (kompilator w wersji 19.23.28105.0)
...
## <a name="warnings-introduced-in-visual-studio-2019-version-162-compiler-version-1922279050"></a>Ostrzeżenia wprowadzone w programie Visual Studio 2019 w wersji 16,2 (kompilator w wersji 19.22.27905.0)
...
## <a name="warnings-introduced-in-visual-studio-2019-version-161-compiler-version-1921277020"></a>Ostrzeżenia wprowadzone w programie Visual Studio 2019 w wersji 16,1 (kompilator w wersji 19.21.27702.0)
