...
|[Ostrzeżenie kompilatora (poziom 4) C4204](../../error-messages/compiler-warnings/compiler-warning-level-4-c4204.md)|użyto niestandardowego rozszerzenia: Inicjator agregacji nie jest stały|
...
|[Ostrzeżenie kompilatora (poziom 4) C4206](../../error-messages/compiler-warnings/compiler-warning-level-4-c4206.md)|użyto niestandardowego rozszerzenia: jednostka tłumaczeniowa jest pusta|
...
|[Ostrzeżenie kompilatora (poziom 4) C4213](../../error-messages/compiler-warnings/compiler-warning-level-4-c4213.md)|użyto niestandardowego rozszerzenia: rzutowanie na wartościowanie lewostronne|
...
|[Ostrzeżenie kompilatora (poziom 1) C4218](../../error-messages/compiler-warnings/compiler-warning-level-1-c4218.md)|użyto niestandardowego rozszerzenia: należy określić co najmniej klasę magazynu lub typ|
...
|[Ostrzeżenie kompilatora (poziom 4) C4242](../../error-messages/compiler-warnings/compiler-warning-level-4-c4242.md)|"*identyfikator*': konwersja z"*type1*"to"*type2*", możliwa utrata danych|
|[Ostrzeżenie kompilatora (poziom 3) C4243](../../error-messages/compiler-warnings/compiler-warning-level-3-c4243.md)|"*conversion_type*'konwersja'*type1*"to"*type2*" istnieje, ale jest niedostępna|
|[Ostrzeżenie kompilatora (poziom 2) C4244](../../error-messages/compiler-warnings/compiler-warning-level-2-c4244.md)|"*conversion_type*': konwersja z"*type1*"to"*type2*", możliwa utrata danych|
|[Ostrzeżenie kompilatora (poziomy 3 i 4) C4244](../../error-messages/compiler-warnings/compiler-warning-levels-3-and-4-c4244.md)|"*conversion_type*': konwersja z"*type1*"to"*type2*", możliwa utrata danych|
|[Ostrzeżenie kompilatora (poziom 4) C4245](../../error-messages/compiler-warnings/compiler-warning-level-4-c4245.md)|"*conversion_type*': konwersja z"*type1*"to"*type2*', niezgodność ze znakiem/bez znaku|
|[Ostrzeżenie kompilatora (poziom 2) C4250](../../error-messages/compiler-warnings/compiler-warning-level-2-c4250.md)|"*classname*": dziedziczy "*base_classname*::*elementu członkowskiego*" za pośrednictwem pozycji dominującej|
...
|[Ostrzeżenie kompilatora (poziom 4) C4254](../../error-messages/compiler-warnings/compiler-warning-level-4-c4254.md)|"*operator*': konwersja z"*type1*:*field_bits*"to"*type2*:*field_bits*", Możliwa utrata danych|
|[Ostrzeżenie kompilatora (poziom 4) C4255](../../error-messages/compiler-warnings/compiler-warning-level-4-c4255.md)|"*funkcja*": nie podano prototypu funkcji: konwertowanie '()"na"(void)"|
|[Ostrzeżenie kompilatora (poziom 4) C4256](../../error-messages/compiler-warnings/compiler-warning-level-4-c4256.md)|"*funkcja*": konstruktor dla klasy z bazami wirtualnymi ma "..."; wywołania mogą nie być zgodne ze starszymi wersjami programu Visual C++|
...
|[Ostrzeżenie kompilatora (poziom 4) C4263](../../error-messages/compiler-warnings/compiler-warning-level-4-c4263.md)|"*funkcja*": funkcja składowa nie zastępuje żadnej funkcji składowej wirtualnej klasy bazowej|
|[Ostrzeżenie kompilatora (poziom 1) C4264](../../error-messages/compiler-warnings/compiler-warning-level-1-c4264.md)|"*virtual_function*': niedostępne zastąpienie dla funkcji wirtualnej składowej z podstawowej"*classname*'; funkcja jest ukryta|
...
|[Ostrzeżenie kompilatora (poziom 4) C4266](../../error-messages/compiler-warnings/compiler-warning-level-4-c4266.md)|"*virtual_function*': niedostępne zastąpienie dla funkcji wirtualnej składowej z podstawowej"*classname*'; funkcja jest ukryta|
...
|[Ostrzeżenie kompilatora (poziom 3) C4282](../../error-messages/compiler-warnings/compiler-warning-level-3-c4282.md)|następnie za pośrednictwem typu "*type2*"|
...
|[Ostrzeżenie kompilatora (poziom 1) C4286](../../error-messages/compiler-warnings/compiler-warning-level-1-c4286.md)|"*derived_type*": zostanie przechwycony przez klasę bazową ("*base_type*") w wierszu "*line_number*"|
...
|[Ostrzeżenie kompilatora (poziom 4) C4296](../../error-messages/compiler-warnings/compiler-warning-level-4-c4296.md)|"*operator*": wyrażenie ma zawsze wartość "*boolean_value*"|
|[Ostrzeżenie kompilatora (poziom 1) C4297](../../error-messages/compiler-warnings/compiler-warning-level-1-c4297.md)|"*funkcja*": Funkcja przyjmuje się, że nie zgłasza wyjątku, ale nie|
...
|C4301 ostrzeżenia kompilatora|"*derived_class*::*funkcja*": przesłanianie wirtualnej funkcji różni się tylko od "*element $base_class*::*funkcja*" przez const/volatile Kwalifikator|
|[Ostrzeżenie kompilatora (poziom 2) C4302](../../error-messages/compiler-warnings/compiler-warning-level-2-c4302.md)|"*konwersji*': obcinanie z '*type1*"to"*type2*"|
|C4303 ostrzeżenia kompilatora|Stylu C rzutowanie z elementu "*type1*"to"*type2*" jest przestarzały, użyj statyczne\_cast \_ \_spróbuj\_rzutowania lub dynamiczny\_rzutowania|
|[Ostrzeżenie kompilatora (poziom 1) C4305](../../error-messages/compiler-warnings/compiler-warning-level-1-c4305.md)|"*konwersji*': obcinanie z '*type1*"to"*type2*"|
|[Ostrzeżenie kompilatora (poziom 3) C4306](../../error-messages/compiler-warnings/compiler-warning-level-3-c4306.md)|"*konwersji*': konwersja z"*type1*"to"*type2*' o większym rozmiarze|
|[Ostrzeżenie kompilatora (poziom 2) C4307](../../error-messages/compiler-warnings/compiler-warning-level-2-c4307.md)|"*operator*": przepełnienie stałej całkowitej|
...
|[Ostrzeżenie kompilatora (poziom 1) C4311](../../error-messages/compiler-warnings/compiler-warning-level-1-c4311.md)|"*zmiennej*': obcinanie wskaźnika z"*type1*"to"*type2*"|
|[Ostrzeżenie kompilatora (poziom 1) C4312](../../error-messages/compiler-warnings/compiler-warning-level-1-c4312.md)|"*operacji*': konwersja z"*type1*"to"*type2*' o większym rozmiarze|
...
|[Ostrzeżenie kompilatora (poziom 1) C4325](../../error-messages/compiler-warnings/compiler-warning-level-1-c4325.md)|atrybuty dla standardowej sekcji "*sekcji*" zignorowany|
|[Ostrzeżenie kompilatora (poziom 1) C4326](../../error-messages/compiler-warnings/compiler-warning-level-1-c4326.md)|zwracany typ "*funkcja*powinien być*type1*"zamiast z"*type2*"|
|C4327 ostrzeżenia kompilatora|"*przypisania*": operator pośredni wyrównania LHS ("*alignment1*") jest większy niż RHS ("*alignment2*")|
|C4328 ostrzeżenia kompilatora|"*funkcja*": operator pośredni wyrównania formalnego parametru *parameter_number* (*parameter_alignment*) jest większy niż rzeczywisty argument wyrównania (*argument_alignment*)|
...
|[Ostrzeżenie kompilatora (poziom 1) C4384](../../error-messages/compiler-warnings/compiler-warning-level-1-c4384.md)|#pragma "make_public" powinna być użyta tylko w zakresie globalnym|
|Ostrzeżenie kompilatora (poziom 3) C4387|"*alternatywnych*': została uznana za|
|Ostrzeżenie kompilatora (poziom 4) C4388|"*wyrażenie*": niezgodność ze znakiem/bez znaku|
|[Ostrzeżenie kompilatora (poziom 4) C4389](../../error-messages/compiler-warnings/compiler-warning-level-4-c4389.md)|"*operator*": niezgodność ze znakiem/bez znaku|
|[Ostrzeżenie kompilatora (poziom 3) C4390](../../error-messages/compiler-warnings/compiler-warning-level-3-c4390.md)|";": pusty kontrolowanego instrukcji znalezionej; to jest celem?|
