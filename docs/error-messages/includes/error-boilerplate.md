...
Może się okazać uzyskać dodatkową pomoc błędów i ostrzeżeń na forach publicznych firmy Microsoft. I wyszukaj błąd lub ostrzeżenie o numerze w programie Visual Studio C++ [społeczności deweloperów](https://developercommunity.visualstudio.com/spaces/8/index.html) lokacji. Możesz również wyszukać błędy i ostrzeżenia i zadawać pytania w [Stack Overflow](https://stackoverflow.com/) do rozwiązania.
