---
title: Błąd kompilatora zasobów RC2148 | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Identyfikator odmianą języka jest za duży  
  
 Wartość Identyfikatora odmianą języka jest poza zakresem.  
