...
Jeśli skompilować i uruchomić ponownie na tym etapie kod, będzie widoczna "Hello World" w konsoli. Następnie zmodyfikujesz `main` funkcji do wykonywania niektórych obliczeń.
