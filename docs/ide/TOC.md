...
# [CMake i pozostałe projekty platformy innej niż MSBuild w programie Visual C++](non-msbuild-projects.md)
## [Projekty CMake w programie Visual C++](cmake-tools-for-visual-cpp.md)
# [Projekty MSBuild w programie Visual C++](creating-and-managing-visual-cpp-projects.md)
...
#### [Określanie lokalizacji projektu i plików źródłowych, Kreator Utwórz nowy projekt z istniejących plików z kodem](specify-project-location-and-source-files.md)
#### [Określanie ustawień projektu, Kreator Utwórz nowy projekt z istniejących plików z kodem](specify-project-settings-create-new-project-from-existing-code-files-wizard.md)
#### [Określanie ustawień konfiguracji debugowania, Kreator Utwórz nowy projekt z istniejących plików z kodem](specify-debug-configuration-settings.md)
#### [Określanie ustawień konfiguracji wydania, Kreator Utwórz nowy projekt z istniejących plików z kodem](specify-release-configuration.md)
...
#### [Strona właściwości Niestandardowy krok budowania: ogólne](custom-build-step-property-page-general.md)
...
## [Dodawanie klasy (Visual C++)](adding-a-class-visual-cpp.md)
### [Okno dialogowe Dodawanie klasy](add-class-dialog-box.md)
## [Dodawanie klasy z kontrolki ActiveX (Visual C++)](adding-a-class-from-an-activex-control-visual-cpp.md)
### [Kreator dodawania klasy z kontrolki ActiveX](add-class-from-activex-control-wizard.md)
## [Dodawanie rodzajowej klasy C++](adding-a-generic-cpp-class.md)
### [Kreator rodzajowej klasy C++](generic-cpp-class-wizard.md)
## [Dodawanie funkcji składowej (Visual C++)](adding-a-member-function-visual-cpp.md)
### [Kreator dodawania funkcji składowej](add-member-function-wizard.md)
## [Dodawanie zmiennej składowej (Visual C++)](adding-a-member-variable-visual-cpp.md)
### [Kreator dodawania zmiennej składowej](add-member-variable-wizard.md)
### [Kontrolki okna dialogowego i typy zmiennych](dialog-box-controls-and-variable-types.md)
## [Dodawanie metody (Visual C++)](adding-a-method-visual-cpp.md)
### [Kreator dodawania metody](add-method-wizard.md)
### [Atrybuty IDL, Kreator dodawania metody](idl-attributes-add-method-wizard.md)
## [Dodawanie właściwości (Visual C++)](adding-a-property-visual-cpp.md)
### [Nazwy, Kreator dodawania właściwości](names-add-property-wizard.md)
### [Atrybuty IDL, Kreator dodawania właściwości](idl-attributes-add-property-wizard.md)
### [Właściwości podstawowe](stock-properties.md)
## [Dodawanie zdarzenia (Visual C++)](adding-an-event-visual-cpp.md)
### [Kreator dodawania zdarzenia](add-event-wizard.md)
## [Dodawanie obsługi zdarzeń (Visual C++)](adding-an-event-handler-visual-cpp.md)
### [Kreator obsługi zdarzeń](event-handler-wizard.md)
## [Tworzenie interfejsu COM (Visual C++)](creating-a-com-interface-visual-cpp.md)
### [Edytowanie interfejsu COM](editing-a-com-interface.md)
## [Implementowanie punktu połączenia (Visual C++)](implementing-a-connection-point-visual-cpp.md)
### [Kreator implementacji punktu połączenia](implement-connection-point-wizard.md)
## [Implementowanie interfejsu (Visual C++)](implementing-an-interface-visual-cpp.md)
### [Kreator implementacji interfejsu](implement-interface-wizard.md)
## [Nawigacja w strukturze klas (Visual C++)](navigating-the-class-structure-visual-cpp.md)
## [Zastępowanie funkcji wirtualnej (Visual C++)](overriding-a-virtual-function-visual-cpp.md)
...
## [Konstruowanie projektów zewnętrznych](building-external-projects.md)
