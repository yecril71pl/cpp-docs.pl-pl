...
Aby uzyskać więcej informacji na temat sposobu rozpowszechniania tych bibliotek DLL z aplikacją, zobacz [Redistributing Visual C++ Files](../ide/redistributing-visual-cpp-files.md). Aby uzyskać przykłady, zobacz [przykłady wdrożeń](../ide/deployment-examples.md).
