...
- **Aplikacja (.exe)**, wyświetla zestaw narzędzi konsolidatora (kompilator C/C++, MIDL, kompilator zasobów, konsolidator, BSCMake, Generator serwera Proxy usługi sieci Web XML, niestandardowej kompilacji, wydarzenia przedkompilacyjne, wydarzenie i postkompilacyjne).
...
- **Biblioteka statyczna (.lib)**, wyświetla zestaw narzędzi bibliotekarza (taki sam, jak zestaw narzędzi konsolidatora, z wyjątkiem podstawenia bibliotekarza na konsolidatora i pominięcia generatora serwera Proxy usługi sieci Web XML).
