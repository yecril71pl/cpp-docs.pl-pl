...
![Wyróżnione makra. ](../ide/media/hint-squiggle-and-actions.png "Podpowiedzi wężyk i szybkie akcje")
...
![Makra w pominięto opcję przeglądania w regionach. ](../ide/media/skipped-regions-squiggle-option.png "Pominięto opcję wężyk regionów.")
