---
title: Znaczniki zalecane dla komentarzy do dokumentacji (Visual C++)
ms.date: 11/04/2016
...
ms.locfileid: "57744796"
---
# <a name="recommended-tags-for-documentation-comments-visual-c"></a>Znaczniki zalecane dla komentarzy do dokumentacji (Visual C++)
...
||||
|-|-|-|
|[\<c>](../ide/c-visual-cpp.md)|[\<code>](../ide/code-visual-cpp.md)|[\<przykład >](../ide/example-visual-cpp.md)|
