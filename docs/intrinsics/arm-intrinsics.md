...
|_arm_smulwb|SMULWB|_arm_smulwb int (int _Rn, int _Rm)|  
...
|_arm_smuadx|SMUADX|_arm_muadxs int (int _Rn, int _Rm)|  
|_arm_smusd|SMUSD|_arm_smusd int (int _Rn, int _Rm)|  
|_arm_smusdx|SMUSDX|_arm_smusdx int (int _Rn, int _Rm)|  
