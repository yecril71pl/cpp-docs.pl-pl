---
title: x64 (amd64) lista funkcji wewnętrznych
ms.date: 04/18/2019
helpviewer_keywords:
...
## <a name="x64-intrinsics"></a>x64 funkcje wewnętrzne

W poniższej tabeli wymieniono funkcje wewnętrzne dostępne na x64 procesorów. Kolumna technologii zawiera zestaw instrukcji obsługi technicznej. Użyj [__cpuid](cpuid-cpuidex.md) wewnętrznych, aby określić zestaw instrukcji obsługi w czasie wykonywania. W przypadku dwóch wpisów w jednym wierszu, stanowią one różne punkty wejścia dla tej samej wewnętrznej. [1] wskazuje, że wewnętrznych jest dostępna tylko na procesory AMD. [2] wskazuje, że wewnętrznych jest dostępna tylko na procesorach Intel. [3] wskazuje, że prototyp jest makra. Nagłówek, wymagane do prototypu funkcji znajduje się w nagłówku kolumny. Nagłówek intrin.h obejmuje zarówno immintrin.h, jak i ammintrin.h dla uproszczenia.

|Nazwa funkcji wewnętrznej|Technologia|nagłówek|Prototyp funkcji|
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin.h|unsigned char _addcarry_u16 (unsigned char, typ unsigned short, typ unsigned short, typ unsigned short \*)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|unsigned char _addcarry_u32 (unsigned char, niepodpisane int, niepodpisane int, niepodpisane int \*)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|unsigned char _addcarry_u64 (unsigned char, niepodpisane \__int64, niepodpisane \__int64, niepodpisane \__int64 \*)|
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8 (unsigned char, char bez znaku, unsigned char unsigned char \*)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|unsigned char _addcarryx_u32 (unsigned char, niepodpisane int, niepodpisane int, niepodpisane int \*)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|unsigned char _addcarryx_u64 (unsigned char, niepodpisane \__int64, niepodpisane \__int64, niepodpisane \__int64 \*)|
|[__addgsbyte](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|__addgsbyte void (bez znaku długie, unsigned char)|
|[__addgsdword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|__addgsdword void (unsigned long, nieoznaczona liczba całkowita)|
|[__addgsqword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (unsigned long, niepodpisane \__int64)|
|[__addgsword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|__addgsword void (krótki unsigned long, bez znaku)|
...
|_andn_u64|BMI [1]|ammintrin.h|unsigned __int64 _andn_u64 (bez znaku \__int64, niepodpisane \__int64)|
...
|[_bextr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bextr_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _bextr_u64 (bez znaku \__int64, niepodpisane int, niepodpisane int)|
|_bextri_u32|ABM [1]|ammintrin.h|unsigned int _bextri_u32 (unsigned int, niepodpisane int)|
|_bextri_u64|ABM [1]|ammintrin.h|unsigned __int64 _bextri_u64 (bez znaku \__int64, niepodpisane int)|
|[_BitScanForward](bitscanforward-bitscanforward64.md)||intrin.h|unsigned char _BitScanForward (unsigned long\*, unsigned long)|
|[_BitScanForward64](bitscanforward-bitscanforward64.md)||intrin.h|unsigned char _BitScanForward64 (unsigned long\*bez znaku \__int64)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin.h|unsigned char _BitScanReverse (unsigned long\*, unsigned long)|
|[_BitScanReverse64](bitscanreverse-bitscanreverse64.md)||intrin.h|unsigned char _BitScanReverse64 (unsigned long\*bez znaku \__int64)|
|[_bittest](bittest-bittest64.md)||intrin.h|unsigned char _bittest (długo const \*długie)|
|[_bittest64](bittest-bittest64.md)||intrin.h|_bittest64 char bez znaku (\__int64 const \*, \__int64)|
|[_bittestandcomplement](bittestandcomplement-bittestandcomplement64.md)||intrin.h|unsigned char _bittestandcomplement (long \*długie)|
|[_bittestandcomplement64](bittestandcomplement-bittestandcomplement64.md)||intrin.h|_bittestandcomplement64 char bez znaku (\__int64 \*, \__int64)|
|[_bittestandreset](bittestandreset-bittestandreset64.md)||intrin.h|unsigned char _bittestandreset (long \*długie)|
|[_bittestandreset64](bittestandreset-bittestandreset64.md)||intrin.h|_bittestandreset64 char bez znaku (\__int64 \*, \__int64)|
|[_bittestandset](bittestandset-bittestandset64.md)||intrin.h|unsigned char _bittestandset (long \*długie)|
|[_bittestandset64](bittestandset-bittestandset64.md)||intrin.h|_bittestandset64 char bez znaku (\__int64 \*, \__int64)|
|_blcfill_u32|ABM [1]|ammintrin.h|_blcfill_u32(unsigned int) unsigned int|
|_blcfill_u64|ABM [1]|ammintrin.h|unsigned __int64 _blcfill_u64 (bez znaku \__int64)|
...
|[_blsi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _blsi_u64 (bez znaku \__int64)|
|_blsic_u32|ABM [1]|ammintrin.h|_blsic_u32(unsigned int) unsigned int|
|_blsic_u64|ABM [1]|ammintrin.h|unsigned __int64 _blsic_u64 (bez znaku \__int64)|
...
|[_bzhi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64)|BMI [2]|immintrin.h|unsigned __int64 _bzhi_u64 (bez znaku \__int64, niepodpisane int)|
...
|[__emulu](emul-emulu.md)||intrin.h|__int64 bez znaku [pascal/cdecl]\__emulu (unsigned int, niepodpisane int)|
...
|[__inbyte](inbyte.md)||intrin.h|__inbyte(unsigned short) char bez znaku|
|[__inbytestring](inbytestring.md)||intrin.h|void __inbytestring (typ unsigned short, char bez znaku \*, unsigned long)|
...
|[__indwordstring](indwordstring.md)||intrin.h|void __indwordstring (typ unsigned short, unsigned long \*, unsigned long)|
|[__int2c](int2c.md)||intrin.h|void __int2c(void)|
|[_InterlockedAnd](interlockedand-intrinsic-functions.md)||intrin.h|długi _InterlockedAnd (długo volatile \*długie)|
|[_InterlockedAnd_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedAnd_HLEAcquire (długo volatile \*długie)|
|[_InterlockedAnd_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedAnd_HLERelease (długo volatile \*długie)|
|[_InterlockedAnd_np](interlockedand-intrinsic-functions.md)||intrin.h|długi _InterlockedAnd_np (long \*długie)|
|[_InterlockedAnd16](interlockedand-intrinsic-functions.md)||intrin.h|krótki _InterlockedAnd16 (krótki volatile \*, krótki)|
|[_InterlockedAnd16_np](interlockedand-intrinsic-functions.md)||intrin.h|krótki _InterlockedAnd16_np (krótki \*, krótki)|
...
|[_interlockedbittestandreset](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandreset (long \*długie)|
|[_interlockedbittestandreset_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLEAcquire (long \*długie)|
|[_interlockedbittestandreset_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLERelease (long \*długie)|
|[_interlockedbittestandreset64](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|_interlockedbittestandreset64 char bez znaku (\__int64 \*, \__int64)|
|[_interlockedbittestandreset64_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|_interlockedbittestandreset64_HLEAcquire char bez znaku (\__int64 \*, \__int64)|
|[_interlockedbittestandreset64_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|_interlockedbittestandreset64_HLERelease char bez znaku (\__int64 \*, \__int64)|
|[_interlockedbittestandset](interlockedbittestandset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandset (long \*długie)|
|[_interlockedbittestandset_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLEAcquire (long \*długie)|
|[_interlockedbittestandset_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLERelease (long \*długie)|
|[_interlockedbittestandset64](interlockedbittestandset-intrinsic-functions.md)||intrin.h|_interlockedbittestandset64 char bez znaku (\__int64 \*, \__int64)|
|[_interlockedbittestandset64_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|_interlockedbittestandset64_HLEAcquire char bez znaku (\__int64 \*, \__int64)|
|[_interlockedbittestandset64_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|_interlockedbittestandset64_HLERelease char bez znaku (\__int64 \*, \__int64)|
|[_InterlockedCompareExchange](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|długi _InterlockedCompareExchange (długo volatile \*, long, długi)|
|[_InterlockedCompareExchange_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedCompareExchange_HLEAcquire (długo volatile \*, long, długi)|
|[_InterlockedCompareExchange_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedCompareExchange_HLERelease (długo volatile \*, long, długi)|
|[_InterlockedCompareExchange_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|długi _InterlockedCompareExchange_np (long \*, long, długi)|
...
|[_InterlockedCompareExchange16](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|krótki _InterlockedCompareExchange16 (krótki volatile \*, krótka, krótka)|
|[_InterlockedCompareExchange16_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|krótki _InterlockedCompareExchange16_np (krótki volatile \*, krótka, krótka)|
...
|[_InterlockedDecrement](interlockeddecrement-intrinsic-functions.md)||intrin.h|długi _InterlockedDecrement (długo volatile \*)|
|[_InterlockedDecrement16](interlockeddecrement-intrinsic-functions.md)||intrin.h|krótki _InterlockedDecrement16 (skrócona volatile \*)|
...
|[_InterlockedExchange](interlockedexchange-intrinsic-functions.md)||intrin.h|długi _InterlockedExchange (długo volatile \*długie)|
|[_InterlockedExchange_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedExchange_HLEAcquire (długo volatile \*długie)|
|[_InterlockedExchange_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedExchange_HLERelease (długo volatile \*długie)|
|[_InterlockedExchange16](interlockedexchange-intrinsic-functions.md)||intrin.h|krótki _InterlockedExchange16 (krótki volatile \*, krótki)|
...
|[_InterlockedExchangeAdd](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|_interlockedexchangeadd — długi (długo volatile \*długie)|
|[_InterlockedExchangeAdd_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|_interlockedexchangeadd_hleacquire — długi (długo volatile \*długie)|
|[_InterlockedExchangeAdd_HLERelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|_interlockedexchangeadd_hlerelease — długi (długo volatile \*długie)|
|[_InterlockedExchangeAdd16](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|_interlockedexchangeadd16 — krótki (krótki volatile \*, krótki)|
...
|[_InterlockedIncrement](interlockedincrement-intrinsic-functions.md)||intrin.h|długi _InterlockedIncrement (długo volatile \*)|
|[_InterlockedIncrement16](interlockedincrement-intrinsic-functions.md)||intrin.h|krótki _InterlockedIncrement16 (skrócona volatile \*)|
...
|[_InterlockedOr](interlockedor-intrinsic-functions.md)||intrin.h|długi _InterlockedOr (długo volatile \*długie)|
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedOr_HLEAcquire (długo volatile \*długie)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedOr_HLERelease (długo volatile \*długie)|
|[_InterlockedOr_np](interlockedor-intrinsic-functions.md)||intrin.h|długi _InterlockedOr_np (long \*długie)|
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin.h|krótki _InterlockedOr16 (krótki volatile \*, krótki)|
|[_InterlockedOr16_np](interlockedor-intrinsic-functions.md)||intrin.h|krótki _InterlockedOr16_np (krótki \*, krótki)|
...
|[_InterlockedXor](interlockedxor-intrinsic-functions.md)||intrin.h|długi _InterlockedXor (długo volatile \*długie)|
|[_InterlockedXor_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedXor_HLEAcquire (długo volatile \*długie)|
|[_InterlockedXor_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|długi _InterlockedXor_HLERelease (długo volatile \*długie)|
|[_InterlockedXor_np](interlockedxor-intrinsic-functions.md)||intrin.h|długi _InterlockedXor_np (long \*długie)|
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin.h|krótki _InterlockedXor16 (krótki volatile \*, krótki)|
|[_InterlockedXor16_np](interlockedxor-intrinsic-functions.md)||intrin.h|krótki _InterlockedXor16_np (krótki \*, krótki)|
...
|[__inword](inword.md)||intrin.h|__inword(unsigned short) krótka bez znaku|
|[__inwordstring](inwordstring.md)||intrin.h|void __inwordstring (typ unsigned short, typ unsigned short \*, unsigned long)|
|_lgdt||intrin.h|void _lgdt(void\*)|
|[__lidt](lidt.md)||intrin.h|void __lidt (void\*)|
|[__ll_lshift](ll-lshift.md)||intrin.h|__int64 bez znaku [pascal/cdecl] \__ll_lshift (bez znaku \__int64, int)|
...
|__lwpins32|LWP [1]|ammintrin.h|unsigned char __lwpins32 (unsigned int, niepodpisane int, niepodpisane int)|
|__lwpins64|LWP [1]|ammintrin.h|unsigned char __lwpins64 (bez znaku \__int64, niepodpisane int, niepodpisane int)|
|__lwpval32|LWP [1]|ammintrin.h|void __lwpval32 (unsigned int, niepodpisane int, niepodpisane int)|
|__lwpval64|LWP [1]|ammintrin.h|void __lwpval64 (bez znaku \__int64, niepodpisane int, niepodpisane int)|
|[__lzcnt](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|__lzcnt(unsigned int) unsigned int|
...
|[_lzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _lzcnt_u64 (bez znaku \__int64)|
|[__lzcnt16](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|__lzcnt16(unsigned short) krótka bez znaku|
|[__lzcnt64](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|unsigned __int64 \__lzcnt64 (bez znaku \__int64)|
...
|[_mm_crc32_u16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u16)|SSE42|intrin.h|unsigned int _mm_crc32_u16 (unsigned int typ unsigned short)|
...
|[_mm_crc32_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u64)|SSE42|intrin.h|unsigned __int64 _mm_crc32_u64 (bez znaku \__int64, niepodpisane \__int64)|
...
|[_mm_loaddup_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loaddup_pd)|SSE3|intrin.h|__m128d _mm_loaddup_pd (podwójny const\*)|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void _mm_monitor (void const\*, niepodpisane int, niepodpisane int)|
...
|[_mm_mwait](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mwait)|SSE3|intrin.h|_mm_mwait void (unsigned int, niepodpisane int)|
...
|[_mm_set_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set_epi16)|SSE2|intrin.h|__m128i _mm_set_epi16 (krótko, short, krótko, krótko, short, krótko, krótko, krótki)|
...
|[_mm_setr_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_epi16)|SSE2|intrin.h|__m128i _mm_setr_epi16 (krótko, short, krótko, krótko, short, krótko, krótko, krótki)|
...
|[_mm256_broadcast_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_sd)|AVX [2]|immintrin.h|__m256d _mm256_broadcast_sd (podwójny const \*)|
...
|[_mm256_load_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_pd)|AVX [2]|immintrin.h|__m256d _mm256_load_pd (podwójny const \*)|
...
|[_mm256_loadu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_pd)|AVX [2]|immintrin.h|__m256d _mm256_loadu_pd (podwójny const \*)|
...
|[_mm256_set_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_epi64x)|AVX [2]|immintrin.h|_mm256_set_epi64x __m256i (long long long long, long long, long long)|
...
|[_mm256_set_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_set_pd)|AVX [2]|immintrin.h|__m256d _mm256_set_pd (double, double, double, podwójny)|
...
|[_mm256_setr_epi64x](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_epi64x)|AVX [2]|immintrin.h|_mm256_setr_epi64x __m256i (long long long long, long long, long long)|
...
|[_mm256_setr_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_setr_pd)|AVX [2]|immintrin.h|__m256d _mm256_setr_pd (double, double, double, podwójny)|
...
|[__movsw](movsw.md)||intrin.h|VOID __movsw (typ unsigned short \*, niepodpisane krótka const \*, size_t)|
|[_mul128](mul128.md)||intrin.h|__int64 _mul128(\__int64, \__int64, \__int64 \*)|
|[__mulh](mulh.md)||intrin.h|__int64 \__mulh (\__int64, \__int64)|
|_mulx_u32|BMI [2]|immintrin.h|unsigned int _mulx_u32 (unsigned int, niepodpisane int, niepodpisane int\*)|
|_mulx_u64|BMI [2]|immintrin.h|unsigned __int64 _mulx_u64 (bez znaku \__int64, niepodpisane \__int64, niepodpisane \__int64\*)|
...
|[__outbyte](outbyte.md)||intrin.h|__outbyte void (unsigned char krótka, nieoznaczona)|
|[__outbytestring](outbytestring.md)||intrin.h|void __outbytestring (typ unsigned short, char bez znaku \*, unsigned long)|
|[__outdword](outdword.md)||intrin.h|__outdword void (unsigned short, nieoznaczona długa)|
|[__outdwordstring](outdwordstring.md)||intrin.h|void __outdwordstring (typ unsigned short, unsigned long \*, unsigned long)|
|[__outword](outword.md)||intrin.h|__outword void (krótki krótko nieoznaczona, nieoznaczona liczba)|
|[__outwordstring](outwordstring.md)||intrin.h|void __outwordstring (typ unsigned short, typ unsigned short \*, unsigned long)|
|[_pdep_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u32)|BMI [2]|immintrin.h|unsigned int _pdep_u32 (unsigned int, niepodpisane int)|
|[_pdep_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64)|BMI [2]|immintrin.h|unsigned __int64 _pdep_u64 (bez znaku \__int64, niepodpisane \__int64)|
|[_pext_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u32)|BMI [2]|immintrin.h|unsigned int _pext_u32 (unsigned int, niepodpisane int)|
|[_pext_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64)|BMI [2]|immintrin.h|unsigned __int64 _pext_u64 (bez znaku \__int64, niepodpisane \__int64)|
|[__popcnt](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|__popcnt(unsigned int) unsigned int|
|[__popcnt16](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|__popcnt16(unsigned short) krótka bez znaku|
|[__popcnt64](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|unsigned __int64 \__popcnt64 (bez znaku \__int64)|
|[_rdrand16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand16_step)|RDRAND [2]|immintrin.h|int _rdrand16_step (typ unsigned short \*)|
...
|[_rdseed16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed16_step)|RDSEED [2]|immintrin.h|int _rdseed16_step (typ unsigned short \*)|
...
|[__readgsbyte](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|__readgsbyte(unsigned long) char bez znaku|
...
|[__readgsword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|__readgsword(unsigned long) krótka bez znaku|
...
|_rorx_u64|BMI [2]|immintrin.h|unsigned __int64 _rorx_u64 (bez znaku \__int64, const unsigned int)|
|[_rotl16](rotl8-rotl16.md)||intrin.h|niepodpisane krótka _rotl16 (typ unsigned short, unsigned char)|
|[_rotl8](rotl8-rotl16.md)||intrin.h|niepodpisane char _rotl8 (char bez znaku, unsigned char)|
|[_rotr16](rotr8-rotr16.md)||intrin.h|niepodpisane krótka _rotr16 (typ unsigned short, unsigned char)|
|[_rotr8](rotr8-rotr16.md)||intrin.h|niepodpisane char _rotr8 (char bez znaku, unsigned char)|
|_rsm||intrin.h|void _rsm(void)|
|_sarx_i32|BMI [2]|immintrin.h|int _sarx_i32 (int, niepodpisane int)|
|_sarx_i64|BMI [2]|immintrin.h|__int64 _sarx_i64 (\__int64, niepodpisane int)|
|[__segmentlimit](segmentlimit.md)||intrin.h|unsigned long __segmentlimit(unsigned long)|
|_sgdt||intrin.h|void _sgdt (void\*)|
|[__shiftleft128](shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128 (bez znaku \__int64, niepodpisane \__int64, unsigned char)|
|[__shiftright128](shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128 (bez znaku \__int64, niepodpisane \__int64, unsigned char)|
|_shlx_u32|BMI [2]|immintrin.h|unsigned int _shlx_u32 (unsigned int, niepodpisane int)|
|_shlx_u64|BMI [2]|immintrin.h|unsigned __int64 _shlx_u64 (bez znaku \__int64, niepodpisane int)|
|_shrx_u32|BMI [2]|immintrin.h|unsigned int _shrx_u32 (unsigned int, niepodpisane int)|
|_shrx_u64|BMI [2]|immintrin.h|unsigned __int64 _shrx_u64 (bez znaku \__int64, niepodpisane int)|
|[__sidt](sidt.md)||intrin.h|void __sidt (void\*)|
|__slwpcb|LWP [1]|ammintrin.h|void \*__slwpcb(void)|
|_stac|SMAP|intrin.h|void _stac(void)|
|_store_be_u16<br /><br /> [_storebe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141)|MOVBE|immintrin.h|void _store_be_u16 (void \*, unsigned short);<br /><br /> void _storebe_i16 (void \*, krótki); [3]|
|_store_be_u32<br /><br /> [_storebe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i32&expand=5142)|MOVBE|immintrin.h|void _store_be_u32 (void \*, niepodpisane int);<br /><br /> void _storebe_i32 (void \*, int); [3]|
...
|_Store_HLERelease|HLE [2]|immintrin.h|void _Store_HLERelease (długo volatile \*długie)|
...
|[__stosb](stosb.md)||intrin.h|void __stosb (unsigned char \*, char bez znaku, size_t)|
|[__stosd](stosd.md)||intrin.h|void __stosd (unsigned long \*, unsigned long, size_t)|
|[__stosq](stosq.md)||intrin.h|void __stosq (bez znaku \__int64 \*bez znaku \__int64, size_t)|
|[__stosw](stosw.md)||intrin.h|void __stosw (typ unsigned short \*, typ unsigned short, size_t)|
|_subborrow_u16||intrin.h|unsigned char _subborrow_u16 (unsigned char, typ unsigned short, typ unsigned short, typ unsigned short \*)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin.h|unsigned char _subborrow_u32 (unsigned char, niepodpisane int, niepodpisane int, niepodpisane int \*)|
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin.h|unsigned char _subborrow_u64 (unsigned char, niepodpisane \__int64, niepodpisane \__int64, niepodpisane \__int64 \*)|
|_subborrow_u8||intrin.h|unsigned char _subborrow_u8 (unsigned char, char bez znaku, unsigned char unsigned char \*)|
...
|_tzmsk_u64|ABM [1]|ammintrin.h|unsigned __int64 _tzmsk_u64 (bez znaku \__int64)|
|[__ud2](ud2.md)||intrin.h|void __ud2(void)|
|[_udiv128](udiv128.md)||intrin.h|unsigned __int64 _udiv128 (bez znaku \__int64, niepodpisane \__int64, niepodpisane \__int64, niepodpisane \__int64 \*)|
|[_udiv64](udiv64.md)||intrin.h|unsigned int \_udiv64 (bez znaku \__int64, niepodpisane int, niepodpisane int *)|
|[__ull_rshift](ull-rshift.md)||intrin.h|__int64 bez znaku [pascal/cdecl] \__ull_rshift (bez znaku \__int64, int)|
|[_umul128](umul128.md)||intrin.h|unsigned __int64 _umul128 (bez znaku \__int64, niepodpisane \__int64, niepodpisane \__int64 \*)|
|[__umulh](umulh.md)||intrin.h|unsigned __int64 \__umulh (bez znaku \__int64, niepodpisane \__int64)|
|[__vmx_off](vmx-off.md)||intrin.h|void __vmx_off(void)|
|[__vmx_on](vmx-on.md)||intrin.h|unsigned char __vmx_on (bez znaku \__int64\*)|
|[__vmx_vmclear](vmx-vmclear.md)||intrin.h|unsigned char __vmx_vmclear (bez znaku \__int64\*)|
|[__vmx_vmlaunch](vmx-vmlaunch.md)||intrin.h|__vmx_vmlaunch(void) char bez znaku|
|[__vmx_vmptrld](vmx-vmptrld.md)||intrin.h|unsigned char __vmx_vmptrld (bez znaku \__int64\*)|
...
|[__vmx_vmresume](vmx-vmresume.md)||intrin.h|__vmx_vmresume(void) char bez znaku|
|[__vmx_vmwrite](vmx-vmwrite.md)||intrin.h|__vmx_vmwrite char bez znaku (size_t, size_t)|
|[__wbinvd](wbinvd.md)||intrin.h|void __wbinvd(void)|
|[_WriteBarrier](writebarrier.md)||intrin.h|void _WriteBarrier(void)|
|[__writecr0](writecr0.md)||intrin.h|void __writecr0 (bez znaku \__int64)|
|[__writecr3](writecr3.md)||intrin.h|void __writecr3 (bez znaku \__int64)|
|[__writecr4](writecr4.md)||intrin.h|void __writecr4 (bez znaku \__int64)|
|[__writecr8](writecr8.md)||intrin.h|void __writecr8 (bez znaku \__int64)|
|[__writedr](writedr.md)||intrin.h|void __writedr (bez znaku, niepodpisane \__int64)|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags (bez znaku \__int64)|
...
|[__writegsdword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|__writegsdword void (long long nieoznaczona, nieoznaczona liczba)|
|[__writegsqword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (unsigned long, niepodpisane \__int64)|
|[__writegsword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|__writegsword void (krótki unsigned long, bez znaku)|
|[__writemsr](writemsr.md)||intrin.h|void __writemsr (unsigned long, niepodpisane \__int64)|
...
|[_xsetbv](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsetbv)|XSAVE [2]|immintrin.h|void _xsetbv (unsigned int, niepodpisane \__int64)|
...
[Funkcje wewnętrzne kompilatora](compiler-intrinsics.md)<br/>
[Funkcje wewnętrzne ARM](arm-intrinsics.md)<br/>
[x86 funkcje wewnętrzne](x86-intrinsics-list.md)