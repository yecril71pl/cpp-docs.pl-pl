...
Ten dokument zawiera listę funkcji wewnętrznych, które kompilator Microsoft C/C++ obsługuje, gdy jest przeznaczony dla procesorów x86.
...
|Nazwa funkcji wewnętrznej|Technologia|Header|Prototyp funkcji|
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin. h|niepodpisany znak _addcarry_u16 (znak bez znaku, niepodpisane, krótkie, niepodpisane, krótkie \* )|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin. h|niepodpisany znak _addcarry_u32 (znak bez znaku, int, unsigned int, int bez znaku \* )|
|_addcarry_u8||intrin. h|niepodpisany znak _addcarry_u8 (znak bez znaku, znak bez znaku, znak bez znaku, znak bez znaku \* )|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin. h|niepodpisany znak _addcarryx_u32 (znak bez znaku, int, unsigned int, int bez znaku \* )|
...
|[_BitScanForward](bitscanforward-bitscanforward64.md)||intrin. h|niepodpisany znak _BitScanForward (Long bez znaku \* , Long)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin. h|niepodpisany znak _BitScanReverse (Long bez znaku \* , Long)|
...
|[__emulu](emul-emulu.md)||intrin. h|niepodpisane __int64 [Pascal/CDECL] \_ _emulu (int bez znaku int)|
...
|[__inbytestring](inbytestring.md)||intrin. h|void __inbytestring (unsigned Short, unsigned char \* , Long unsigned)|
...
|[__indwordstring](indwordstring.md)||intrin. h|void __indwordstring (niepodpisane: Short, Long unsigned \* Long)|
|[__int2c](int2c.md)||intrin. h|void __int2c (void)|
|[_InterlockedAddLargeStatistic](interlockedaddlargestatistic.md)||intrin. h|długi _InterlockedAddLargeStatistic ( \_ _int64 nietrwały \* , Long)|
|[_InterlockedAnd](interlockedand-intrinsic-functions.md)||intrin. h|długi _InterlockedAnd (Long volatile \* , Long)|
|[_InterlockedAnd_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedAnd_HLEAcquire (Long volatile \* , Long)|
|[_InterlockedAnd_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedAnd_HLERelease (Long volatile \* , Long)|
|[_InterlockedAnd16](interlockedand-intrinsic-functions.md)||intrin. h|Krótki _InterlockedAnd16 (krótki nietrwały \* , krótki)|
...
|[_InterlockedCompareExchange](interlockedcompareexchange-intrinsic-functions.md)||intrin. h|długi _InterlockedCompareExchange (Long volatile \* , Long, Long)|
|[_InterlockedCompareExchange_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedCompareExchange_HLEAcquire (Long volatile \* , Long, Long)|
|[_InterlockedCompareExchange_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedCompareExchange_HLERelease (Long volatile \* , Long, Long)|
...
|[_InterlockedCompareExchange64](interlockedcompareexchange-intrinsic-functions.md)||intrin. h|_InterlockedCompareExchange64 __int64 ( \_ _int64 volatile \* , \_ _int64, \_ _int64)|
|[_InterlockedCompareExchange64_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|_InterlockedCompareExchange64_HLEAcquire __int64 ( \_ _int64 volatile \* , \_ _int64, \_ _int64)|
|[_InterlockedCompareExchange64_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|_InterlockedCompareExchange64_HLERelease __int64 ( \_ _int64 volatile \* , \_ _int64, \_ _int64)|
|[_InterlockedCompareExchange8](interlockedcompareexchange-intrinsic-functions.md)||intrin. h|char _InterlockedCompareExchange8 (Char, char \* , Char)|
...
|[_InterlockedDecrement16](interlockeddecrement-intrinsic-functions.md)||intrin. h|krótkie _InterlockedDecrement16 (Short volatile \* )|
|[_InterlockedExchange](interlockedexchange-intrinsic-functions.md)||intrin. h|długi _InterlockedExchange (Long volatile \* , Long)|
|[_InterlockedExchange_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedExchange_HLEAcquire (Long volatile \* , Long)|
|[_InterlockedExchange_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedExchange_HLERelease (Long volatile \* , Long)|
|[_InterlockedExchange16](interlockedexchange-intrinsic-functions.md)||intrin. h|Krótki _InterlockedExchange16 (krótki nietrwały \* , krótki)|
|[_InterlockedExchange8](interlockedexchange-intrinsic-functions.md)||intrin. h|char _InterlockedExchange8 (Char volatile \* , Char)|
|[_InterlockedExchangeAdd](interlockedexchangeadd-intrinsic-functions.md)||intrin. h|długi _InterlockedExchangeAdd (Long volatile \* , Long)|
|[_InterlockedExchangeAdd_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedExchangeAdd_HLEAcquire (Long volatile \* , Long)|
|[_InterlockedExchangeAdd_HLERelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedExchangeAdd_HLERelease (Long volatile \* , Long)|
...
|[_InterlockedIncrement16](interlockedincrement-intrinsic-functions.md)||intrin. h|krótkie _InterlockedIncrement16 (Short volatile \* )|
|[_InterlockedOr](interlockedor-intrinsic-functions.md)||intrin. h|długi _InterlockedOr (Long volatile \* , Long)|
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedOr_HLEAcquire (Long volatile \* , Long)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedOr_HLERelease (Long volatile \* , Long)|
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin. h|Krótki _InterlockedOr16 (krótki nietrwały \* , krótki)|
|[_InterlockedOr8](interlockedor-intrinsic-functions.md)||intrin. h|char _InterlockedOr8 (Char volatile \* , Char)|
|[_InterlockedXor](interlockedxor-intrinsic-functions.md)||intrin. h|długi _InterlockedXor (Long volatile \* , Long)|
|[_InterlockedXor_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedXor_HLEAcquire (Long volatile \* , Long)|
|[_InterlockedXor_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin. h|długi _InterlockedXor_HLERelease (Long volatile \* , Long)|
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin. h|Krótki _InterlockedXor16 (krótki nietrwały \* , krótki)|
...
|[__ll_lshift](ll-lshift.md)||intrin. h|niepodpisane __int64 [Pascal/CDECL] \_ _ll_lshift (niepodpisane \_ _int64, int)|
...
|[_m_pinsrw](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pinsrw)|SSE|intrin. h|_m_pinsrw __m64 ( \_ _m64, int, int)|
...
|[_m_pshufw](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pshufw)|SSE|intrin. h|_m_pshufw __m64 ( \_ _m64, int)|
...
|[_m_pslldi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_pslldi)|MMX|intrin. h|_m_pslldi __m64 ( \_ _m64, int)|
...
|[_m_psllqi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psllqi)|MMX|intrin. h|_m_psllqi __m64 ( \_ _m64, int)|
...
|[_m_psllwi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psllwi)|MMX|intrin. h|_m_psllwi __m64 ( \_ _m64, int)|
...
|[_m_psradi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psradi)|MMX|intrin. h|_m_psradi __m64 ( \_ _m64, int)|
...
|[_m_psrawi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psrawi)|MMX|intrin. h|_m_psrawi __m64 ( \_ _m64, int)|
...
|[_m_psrldi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psrldi)|MMX|intrin. h|_m_psrldi __m64 ( \_ _m64, int)|
...
|[_m_psrlqi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psrlqi)|MMX|intrin. h|_m_psrlqi __m64 ( \_ _m64, int)|
...
|[_m_psrlwi](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_m_psrlwi)|MMX|intrin. h|_m_psrlwi __m64 ( \_ _m64, int)|
...
|_m_to_float|3DNOW|intrin. h|_m_to_float zmiennoprzecinkowe ( \_ _m64)|
...
|[_mm_alignr_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_alignr_epi8)|SSSE3|intrin. h|_mm_alignr_epi8 __m128i ( \_ _m128i, \_ _m128i, int)|
|[_mm_alignr_pi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_alignr_pi8)|SSSE3|intrin. h|_mm_alignr_pi8 __m64 ( \_ _m64, \_ _m64, int)|
...
|[_mm_blendv_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blendv_epi8)|SSE41|intrin. h|_mm_blendv_epi8 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|[_mm_blendv_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blendv_pd)|SSE41|intrin. h|_mm_blendv_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_blendv_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blendv_ps)|SSE41|intrin. h|_mm_blendv_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
...
|_mm_cmov_si128|XOP [1]|ammintrin. h|_mm_cmov_si128 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
...
|_mm_com_epi16|XOP [1]|ammintrin. h|_mm_com_epi16 __m128i ( \_ _m128i, \_ _m128i, int)|
|_mm_com_epi32|XOP [1]|ammintrin. h|_mm_com_epi32 __m128i ( \_ _m128i, \_ _m128i, int)|
|_mm_com_epi64|XOP [1]|ammintrin. h|_mm_com_epi32 __m128i ( \_ _m128i, \_ _m128i, int)|
|_mm_com_epi8|XOP [1]|ammintrin. h|_mm_com_epi8 __m128i ( \_ _m128i, \_ _m128i, int)|
|_mm_com_epu16|XOP [1]|ammintrin. h|_mm_com_epu16 __m128i ( \_ _m128i, \_ _m128i, int)|
|_mm_com_epu32|XOP [1]|ammintrin. h|_mm_com_epu32 __m128i ( \_ _m128i, \_ _m128i, int)|
|_mm_com_epu64|XOP [1]|ammintrin. h|_mm_com_epu32 __m128i ( \_ _m128i, \_ _m128i, int)|
|_mm_com_epu8|XOP [1]|ammintrin. h|_mm_com_epu8 __m128i ( \_ _m128i, \_ _m128i, int)|
...
|[_mm_cvt_si2ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvt_si2ss)|SSE|intrin. h|_mm_cvt_si2ss __m128 ( \_ _m128, int)|
...
|[_mm_cvtsd_f64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsd_f64)|SSSE3|intrin. h|podwójne _mm_cvtsd_f64 ( \_ _m128d)|
...
|[_mm_cvtsi32_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsi32_sd)|SSE2|intrin. h|_mm_cvtsi32_sd __m128d ( \_ _m128d, int)|
...
|[_mm_cvtss_f32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtss_f32)|SSSE3|intrin. h|_mm_cvtss_f32 zmiennoprzecinkowe ( \_ _m128)|
...
|[_mm_extracti_si64](mm-extract-si64-mm-extracti-si64.md)|SSE4a|intrin. h|_mm_extracti_si64 __m128i ( \_ _m128i, int, int)|
|[_mm_fmadd_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmadd_pd)|FMA [2]|immintrin. h|_mm_fmadd_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fmadd_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmadd_ps)|FMA [2]|immintrin. h|_mm_fmadd_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fmadd_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmadd_sd)|FMA [2]|immintrin. h|_mm_fmadd_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fmadd_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmadd_ss)|FMA [2]|immintrin. h|_mm_fmadd_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fmaddsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmaddsub_pd)|FMA [2]|immintrin. h|_mm_fmaddsub_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fmaddsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmaddsub_ps)|FMA [2]|immintrin. h|_mm_fmaddsub_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fmsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmsub_pd)|FMA [2]|immintrin. h|_mm_fmsub_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fmsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmsub_ps)|FMA [2]|immintrin. h|_mm_fmsub_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fmsub_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmsub_sd)|FMA [2]|immintrin. h|_mm_fmsub_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fmsub_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmsub_ss)|FMA [2]|immintrin. h|_mm_fmsub_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fmsubadd_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmsubadd_pd)|FMA [2]|immintrin. h|_mm_fmsubadd_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fmsubadd_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fmsubadd_ps)|FMA [2]|immintrin. h|_mm_fmsubadd_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fnmadd_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmadd_pd)|FMA [2]|immintrin. h|_mm_fnmadd_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fnmadd_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmadd_ps)|FMA [2]|immintrin. h|_mm_fnmadd_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fnmadd_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmadd_sd)|FMA [2]|immintrin. h|_mm_fnmadd_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fnmadd_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmadd_ss)|FMA [2]|immintrin. h|_mm_fnmadd_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fnmsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmsub_pd)|FMA [2]|immintrin. h|_mm_fnmsub_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fnmsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmsub_ps)|FMA [2]|immintrin. h|_mm_fnmsub_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|[_mm_fnmsub_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmsub_sd)|FMA [2]|immintrin. h|_mm_fnmsub_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|[_mm_fnmsub_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_fnmsub_ss)|FMA [2]|immintrin. h|_mm_fnmsub_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
...
|[_mm_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_pd)|AVX2 [2]|immintrin. h|__m128d _mm_i32gather_pd (podwójna stała \* , \_ _m128i, const int)|
...
|[_mm_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_pd)|AVX2 [2]|immintrin. h|__m128d _mm_i64gather_pd (podwójna stała \* , \_ _m128i, const int)|
...
|[_mm_insert_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi16)|SSE2|intrin. h|_mm_insert_epi16 __m128i ( \_ _m128i, int, int)|
...
|[_mm_loaddup_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loaddup_pd)|SSE3|intrin. h|__m128d _mm_loaddup_pd (podwójna stała \* )|
...
|_mm_macc_epi16|XOP [1]|ammintrin. h|_mm_macc_epi16 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_macc_epi32|XOP [1]|ammintrin. h|_mm_macc_epi32 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_macc_pd|FMA4 [1]|ammintrin. h|_mm_macc_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_macc_ps|FMA4 [1]|ammintrin. h|_mm_macc_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|_mm_macc_sd|FMA4 [1]|ammintrin. h|_mm_macc_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_macc_ss|FMA4 [1]|ammintrin. h|_mm_macc_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|_mm_maccd_epi16|XOP [1]|ammintrin. h|_mm_maccd_epi16 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_macchi_epi32|XOP [1]|ammintrin. h|_mm_macchi_epi32 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_macclo_epi32|XOP [1]|ammintrin. h|_mm_macclo_epi32 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_maccs_epi16|XOP [1]|ammintrin. h|_mm_maccs_epi16 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_maccs_epi32|XOP [1]|ammintrin. h|_mm_maccs_epi32 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_maccsd_epi16|XOP [1]|ammintrin. h|_mm_maccsd_epi16 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_maccshi_epi32|XOP [1]|ammintrin. h|_mm_maccshi_epi32 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_maccslo_epi32|XOP [1]|ammintrin. h|_mm_maccslo_epi32 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
...
|_mm_maddd_epi16|XOP [1]|ammintrin. h|_mm_maddd_epi16 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_maddsd_epi16|XOP [1]|ammintrin. h|_mm_maddsd_epi16 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|_mm_maddsub_pd|FMA4 [1]|ammintrin. h|_mm_maddsub_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_maddsub_ps|FMA4 [1]|ammintrin. h|_mm_maddsub_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
...
|[_mm_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_pd)|AVX2 [2]|immintrin. h|__m128d _mm_mask_i32gather_pd ( \_ _m128d, Podwójna stała \* , \_ _m128i, \_ _m128d, const int)|
|[_mm_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_ps)|AVX2 [2]|immintrin. h|__m128 _mm_mask_i32gather_ps ( \_ _m128, wartość zmiennoprzecinkowa \* , \_ _m128i, \_ _m128, const int)|
...
|[_mm_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_pd)|AVX2 [2]|immintrin. h|__m128d _mm_mask_i64gather_pd ( \_ _m128d, Podwójna stała \* , \_ _m128i, \_ _m128d, const int)|
|[_mm_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_ps)|AVX2 [2]|immintrin. h|__m128 _mm_mask_i64gather_ps ( \_ _m128, wartość zmiennoprzecinkowa \* , \_ _m128i, \_ _m128, const int)|
...
|[_mm_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_pd)|AVX [2]|immintrin. h|__m128d _mm_maskload_pd (podwójna stała \* , \_ _m128i)|
|[_mm_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_ps)|AVX [2]|immintrin. h|__m128 _mm_maskload_ps (zmiennoprzecinkowa stała \* , \_ _m128i)|
...
|_mm_msub_pd|FMA4 [1]|ammintrin. h|_mm_msub_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_msub_ps|FMA4 [1]|ammintrin. h|_mm_msub_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|_mm_msub_sd|FMA4 [1]|ammintrin. h|_mm_msub_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_msub_ss|FMA4 [1]|ammintrin. h|_mm_msub_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|_mm_msubadd_pd|FMA4 [1]|ammintrin. h|_mm_msubadd_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_msubadd_ps|FMA4 [1]|ammintrin. h|_mm_msubadd_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
...
|_mm_nmacc_pd|FMA4 [1]|ammintrin. h|_mm_nmacc_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_nmacc_ps|FMA4 [1]|ammintrin. h|_mm_nmacc_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|_mm_nmacc_sd|FMA4 [1]|ammintrin. h|_mm_nmacc_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_nmacc_ss|FMA4 [1]|ammintrin. h|_mm_nmacc_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|_mm_nmsub_pd|FMA4 [1]|ammintrin. h|_mm_nmsub_pd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_nmsub_ps|FMA4 [1]|ammintrin. h|_mm_nmsub_ps __m128 ( \_ _m128, \_ _m128, \_ _m128)|
|_mm_nmsub_sd|FMA4 [1]|ammintrin. h|_mm_nmsub_sd __m128d ( \_ _m128d, \_ _m128d, \_ _m128d)|
|_mm_nmsub_ss|FMA4 [1]|ammintrin. h|_mm_nmsub_ss __m128 ( \_ _m128, \_ _m128, \_ _m128)|
...
|_mm_perm_epi8|XOP [1]|ammintrin. h|_mm_perm_epi8 __m128i ( \_ _m128i, \_ _m128i, \_ _m128i)|
|[_mm_permute_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_permute_pd)|AVX [2]|immintrin. h|_mm_permute_pd __m128d ( \_ _m128d, int)|
|[_mm_permute_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_permute_ps)|AVX [2]|immintrin. h|_mm_permute_ps __m128 ( \_ _m128, int)|
...
|_mm_roti_epi16|XOP [1]|ammintrin. h|_mm_rot_epi16 __m128i ( \_ _m128i, int)|
|_mm_roti_epi32|XOP [1]|ammintrin. h|_mm_rot_epi32 __m128i ( \_ _m128i, int)|
|_mm_roti_epi64|XOP [1]|ammintrin. h|_mm_rot_epi64 __m128i ( \_ _m128i, int)|
|_mm_roti_epi8|XOP [1]|ammintrin. h|_mm_rot_epi8 __m128i ( \_ _m128i, int)|
...
|[_mm_shuffle_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_shuffle_epi32)|SSE2|intrin. h|_mm_shuffle_epi32 __m128i ( \_ _m128i, int)|
...
|[_mm_shuffle_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_shuffle_pd)|SSE2|intrin. h|_mm_shuffle_pd __m128d ( \_ _m128d, \_ _m128d, int)|
...
|[_mm_shuffle_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_shuffle_ps)|SSE|intrin. h|__m128 _mm_shuffle_ps ( \_ _m128, \_ _m128, bez znaku int)|
|[_mm_shufflehi_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_shufflehi_epi16)|SSE2|intrin. h|_mm_shufflehi_epi16 __m128i ( \_ _m128i, int)|
|[_mm_shufflelo_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_shufflelo_epi16)|SSE2|intrin. h|_mm_shufflelo_epi16 __m128i ( \_ _m128i, int)|
...
|[_mm_slli_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_epi16)|SSE2|intrin. h|_mm_slli_epi16 __m128i ( \_ _m128i, int)|
|[_mm_slli_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_epi32)|SSE2|intrin. h|_mm_slli_epi32 __m128i ( \_ _m128i, int)|
|[_mm_slli_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_epi64)|SSE2|intrin. h|_mm_slli_epi64 __m128i ( \_ _m128i, int)|
|[_mm_slli_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_pi16)|MMX|mmintrin. h|_mm_slli_pi16 __m64 ( \_ _m64, int) [3]|
|[_mm_slli_pi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_pi32)|MMX|mmintrin. h|_mm_slli_pi32 __m64 ( \_ _m64, int) [3]|
|[_mm_slli_si64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_si64)|MMX|mmintrin. h|_mm_slli_si64 __m64 ( \_ _m64, int) [3]|
|[_mm_slli_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_slli_si128)|SSE2|intrin. h|_mm_slli_si128 __m128i ( \_ _m128i, int)|
...
|[_mm_srai_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srai_epi16)|SSE2|intrin. h|_mm_srai_epi16 __m128i ( \_ _m128i, int)|
|[_mm_srai_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srai_epi32)|SSE2|intrin. h|_mm_srai_epi32 __m128i ( \_ _m128i, int)|
|[_mm_srai_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srai_pi16)|MMX|mmintrin. h|_mm_srai_pi16 __m64 ( \_ _m64, int) [3]|
|[_mm_srai_pi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srai_pi32)|MMX|mmintrin. h|_mm_srai_pi32 __m64 ( \_ _m64, int) [3]|
...
|[_mm_srli_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_epi16)|SSE2|intrin. h|_mm_srli_epi16 __m128i ( \_ _m128i, int)|
|[_mm_srli_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_epi32)|SSE2|intrin. h|_mm_srli_epi32 __m128i ( \_ _m128i, int)|
|[_mm_srli_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_epi64)|SSE2|intrin. h|_mm_srli_epi64 __m128i ( \_ _m128i, int)|
|[_mm_srli_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_pi16)|MMX|mmintrin. h|_mm_srli_pi16 __m64 ( \_ _m64, int) [3]|
|[_mm_srli_pi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_pi32)|MMX|mmintrin. h|_mm_srli_pi32 __m64 ( \_ _m64, int) [3]|
|[_mm_srli_si64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_si64)|MMX|mmintrin. h|_mm_srli_si64 __m64 ( \_ _m64, int) [3]|
|[_mm_srli_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_srli_si128)|SSE2|intrin. h|_mm_srli_si128 __m128i ( \_ _m128i, int)|
...
|[_mm256_blendv_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_blendv_epi8)|AVX2 [2]|immintrin. h|_mm256_blendv_epi8 __m256i ( \_ _m256i, \_ _m256i, \_ _m256i)|
|[_mm256_blendv_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_blendv_pd)|AVX [2]|immintrin. h|_mm256_blendv_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|[_mm256_blendv_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_blendv_ps)|AVX [2]|immintrin. h|_mm256_blendv_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
...
|[_mm256_broadcast_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_sd)|AVX [2]|immintrin. h|__m256d _mm256_broadcast_sd (podwójna stała \* )|
|[_mm256_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_ss)|AVX [2]|immintrin. h|__m256 _mm256_broadcast_ss (zmiennoprzecinkowa stała \* )|
...
|_mm256_cmov_si256|XOP [1]|ammintrin. h|_mm256_cmov_si256 __m256i ( \_ _m256i, \_ _m256i, \_ _m256i)|
...
|[_mm256_extracti128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_extracti128_si256)|AVX2 [2]|immintrin. h|_mm256_extracti128_si256 __m128i ( \_ _m256i, int)|
|[_mm256_fmadd_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmadd_pd)|FMA [2]|immintrin. h|_mm256_fmadd_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|[_mm256_fmadd_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmadd_ps)|FMA [2]|immintrin. h|_mm256_fmadd_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
|[_mm256_fmaddsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmaddsub_pd)|FMA [2]|immintrin. h|_mm256_fmaddsub_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|[_mm256_fmaddsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmaddsub_ps)|FMA [2]|immintrin. h|_mm256_fmaddsub_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
|[_mm256_fmsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmsub_pd)|FMA [2]|immintrin. h|_mm256_fmsub_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|[_mm256_fmsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmsub_ps)|FMA [2]|immintrin. h|_mm256_fmsub_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
|[_mm256_fmsubadd_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmsubadd_pd)|FMA [2]|immintrin. h|_mm256_fmsubadd_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|[_mm256_fmsubadd_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fmsubadd_ps)|FMA [2]|immintrin. h|_mm256_fmsubadd_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
|[_mm256_fnmadd_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fnmadd_pd)|FMA [2]|immintrin. h|_mm256_fnmadd_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|[_mm256_fnmadd_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fnmadd_ps)|FMA [2]|immintrin. h|_mm256_fnmadd_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
|[_mm256_fnmsub_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fnmsub_pd)|FMA [2]|immintrin. h|_mm256_fnmsub_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|[_mm256_fnmsub_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_fnmsub_ps)|FMA [2]|immintrin. h|_mm256_fnmsub_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
...
|[_mm256_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd)|AVX2 [2]|immintrin. h|__m256d _mm256_i32gather_pd (podwójna stała \* , \_ _m128i, const int)|
...
|[_mm256_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd)|AVX2 [2]|immintrin. h|__m256d _mm256_i64gather_pd (podwójna stała \* , \_ _m256i, const int)|
...
|[_mm256_insertf128_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_insertf128_pd)|AVX [2]|immintrin. h|_mm256_insertf128_pd __m256d ( \_ _m256d, \_ _m128d, int)|
|[_mm256_insertf128_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_insertf128_ps)|AVX [2]|immintrin. h|_mm256_insertf128_ps __m256 ( \_ _m256, \_ _m128, int)|
|[_mm256_insertf128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_insertf128_si256)|AVX [2]|immintrin. h|_mm256_insertf128_si256 __m256i ( \_ _m256i, \_ _m128i, int)|
|[_mm256_inserti128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_inserti128_si256)|AVX2 [2]|immintrin. h|_mm256_inserti128_si256 __m256i ( \_ _m256i, \_ _m128i, int)|
...
|[_mm256_load_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_pd)|AVX [2]|immintrin. h|__m256d _mm256_load_pd (podwójna stała \* )|
|[_mm256_load_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_ps)|AVX [2]|immintrin. h|__m256 _mm256_load_ps (zmiennoprzecinkowa stała \* )|
...
|[_mm256_loadu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_pd)|AVX [2]|immintrin. h|__m256d _mm256_loadu_pd (podwójna stała \* )|
|[_mm256_loadu_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_ps)|AVX [2]|immintrin. h|__m256 _mm256_loadu_ps (zmiennoprzecinkowa stała \* )|
...
|_mm256_macc_pd|FMA4 [1]|ammintrin. h|_mm_macc_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|_mm256_macc_ps|FMA4 [1]|ammintrin. h|_mm_macc_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
...
|_mm256_maddsub_pd|FMA4 [1]|ammintrin. h|_mm_maddsub_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|_mm256_maddsub_ps|FMA4 [1]|ammintrin. h|_mm_maddsub_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
...
|[_mm256_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_pd)|AVX2 [2]|immintrin. h|__m256d _mm256_mask_i32gather_pd ( \_ _m256d, Podwójna stała \* , \_ _m128i, \_ _m256d, const int)|
|[_mm256_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_ps)|AVX2 [2]|immintrin. h|__m256 _mm256_mask_i32gather_ps ( \_ _m256, wartość zmiennoprzecinkowa \* , \_ _m256i, \_ _m256, const int)|
...
|[_mm256_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_pd)|AVX2 [2]|immintrin. h|__m256d _mm256_mask_i64gather_pd ( \_ _m256d, Podwójna stała \* , \_ _m256i, \_ _m256d, const int)|
|[_mm256_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_ps)|AVX2 [2]|immintrin. h|__m128 _mm256_mask_i64gather_ps ( \_ _m128, wartość zmiennoprzecinkowa \* , \_ _m256i, \_ _m128, const int)|
...
|[_mm256_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_pd)|AVX [2]|immintrin. h|__m256d _mm256_maskload_pd (podwójna stała \* , \_ _m256i)|
|[_mm256_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_ps)|AVX [2]|immintrin. h|__m256 _mm256_maskload_ps (zmiennoprzecinkowa stała \* , \_ _m256i)|
...
|_mm256_msub_pd|FMA4 [1]|ammintrin. h|_mm_msub_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|_mm256_msub_ps|FMA4 [1]|ammintrin. h|_mm_msub_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
|_mm256_msubadd_pd|FMA4 [1]|ammintrin. h|_mm_msubadd_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|_mm256_msubadd_ps|FMA4 [1]|ammintrin. h|_mm_msubadd_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
...
|_mm256_nmacc_pd|FMA4 [1]|ammintrin. h|_mm_nmacc_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|_mm256_nmacc_ps|FMA4 [1]|ammintrin. h|_mm_nmacc_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
|_mm256_nmsub_pd|FMA4 [1]|ammintrin. h|_mm_nmsub_pd __m256d ( \_ _m256d, \_ _m256d, \_ _m256d)|
|_mm256_nmsub_ps|FMA4 [1]|ammintrin. h|_mm_nmsub_ps __m256 ( \_ _m256, \_ _m256, \_ _m256)|
...
|[_mm256_permute_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute_pd)|AVX [2]|immintrin. h|_mm256_permute_pd __m256d ( \_ _m256d, int)|
|[_mm256_permute_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute_ps)|AVX [2]|immintrin. h|_mm256_permute_ps __m256 ( \_ _m256, int)|
...
|[_mm256_permute2f128_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute2f128_pd)|AVX [2]|immintrin. h|_mm256_permute2f128_pd __m256d ( \_ _m256d, \_ _m256d, int)|
|[_mm256_permute2f128_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute2f128_ps)|AVX [2]|immintrin. h|_mm256_permute2f128_ps __m256 ( \_ _m256, \_ _m256, int)|
|[_mm256_permute2f128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute2f128_si256)|AVX [2]|immintrin. h|_mm256_permute2f128_si256 __m256i ( \_ _m256i, \_ _m256i, int)|
...
|[_mm256_round_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_round_pd)|AVX [2]|immintrin. h|_mm256_round_pd __m256d ( \_ _m256d, int)|
|[_mm256_round_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_round_ps)|AVX [2]|immintrin. h|_mm256_round_ps __m256 ( \_ _m256, int)|
...
|[_mm256_slli_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_slli_epi16)|AVX2 [2]|immintrin. h|_mm256_slli_epi16 __m256i ( \_ _m256i, int)|
|[_mm256_slli_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_slli_epi32)|AVX2 [2]|immintrin. h|_mm256_slli_epi32 __m256i ( \_ _m256i, int)|
|[_mm256_slli_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_slli_epi64)|AVX2 [2]|immintrin. h|_mm256_slli_epi64 __m256i ( \_ _m256i, int)|
|[_mm256_slli_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_slli_si256)|AVX2 [2]|immintrin. h|_mm256_slli_si256 __m256i ( \_ _m256i, int)|
...
|[_mm256_srai_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_srai_epi16)|AVX2 [2]|immintrin. h|_mm256_srai_epi16 __m256i ( \_ _m256i, int)|
|[_mm256_srai_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_srai_epi32)|AVX2 [2]|immintrin. h|_mm256_srai_epi32 __m256i ( \_ _m256i, int)|
...
|[_mm256_srli_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_srli_epi16)|AVX2 [2]|immintrin. h|_mm256_srli_epi16 __m256i ( \_ _m256i, int)|
|[_mm256_srli_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_srli_epi32)|AVX2 [2]|immintrin. h|_mm256_srli_epi32 __m256i ( \_ _m256i, int)|
|[_mm256_srli_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_srli_epi64)|AVX2 [2]|immintrin. h|_mm256_srli_epi64 __m256i ( \_ _m256i, int)|
|[_mm256_srli_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_srli_si256)|AVX2 [2]|immintrin. h|_mm256_srli_si256 __m256i ( \_ _m256i, int)|
...
|[__movsb](movsb.md)||intrin. h|void __movsb (znak bez znaku \* , stała znakowa \* , size_t)|
|[__movsd](movsd.md)||intrin. h|void __movsd (Long unsigned \* , Long const \* , size_t)|
|[__movsw](movsw.md)||intrin. h|void __movsw (niepodpisane Short \* , Short const \* , size_t)|
...
|[__outbytestring](outbytestring.md)||intrin. h|void __outbytestring (unsigned Short, unsigned char \* , Long unsigned)|
|[__outdword](outdword.md)||intrin. h|void __outdword (unsigned Short, unsigned long)|
|[__outdwordstring](outdwordstring.md)||intrin. h|void __outdwordstring (niepodpisane: Short, Long unsigned \* Long)|
...
|[_rdrand16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand16_step)|RDRAND [2]|immintrin. h|int _rdrand16_step (krótkie bez znaku \* )|
|[_rdrand32_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand32_step)|RDRAND [2]|immintrin. h|int _rdrand32_step (liczba całkowita bez znaku \* )|
|[_rdseed16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed16_step)|RDSEED [2]|immintrin. h|int _rdseed16_step (krótkie bez znaku \* )|
|[_rdseed32_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed32_step)|RDSEED [2]|immintrin. h|int _rdseed32_step (liczba całkowita bez znaku \* )|
|[__rdtsc](rdtsc.md)||intrin. h|niepodpisane \_ _rdtsc __int64 (void)|
|[__rdtscp](rdtscp.md)|RDTSCP|intrin. h|niepodpisane __int64 \_ _rdtscp (int bez znaku \* )|
...
|[__readmsr](readmsr.md)||intrin. h|niepodpisane \_ _readmsr __int64 (liczba bez znaku)|
|[__readpmc](readpmc.md)||intrin. h|niepodpisane \_ _readpmc __int64 (liczba bez znaku)|
...
|_store_be_u32<br /><br /> [_storebe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i32&expand=5142)|MOVBE|immintrin. h|void _store_be_u32 (void \* , unsigned int);<br /><br /> void _storebe_i32 (void \* , int); r.3|
...
|[__stosb](stosb.md)||intrin. h|void __stosb (znak bez znaku \* , znak bez znaku, size_t)|
|[__stosd](stosd.md)||intrin. h|void __stosd (Long unsigned long \* , size_t)|
|[__stosw](stosw.md)||intrin. h|void __stosw (niepodpisane krótkie \* , niepodpisane, size_t)|
|_subborrow_u16||intrin. h|niepodpisany znak _subborrow_u16 (znak bez znaku, niepodpisane, krótkie, niepodpisane, krótkie \* )|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin. h|niepodpisany znak _subborrow_u32 (znak bez znaku, int, unsigned int, int bez znaku \* )|
|_subborrow_u8||intrin. h|niepodpisany znak _subborrow_u8 (znak bez znaku, znak bez znaku, znak bez znaku, znak bez znaku \* )|
...
|[_udiv64](udiv64.md)||intrin. h|unsigned int \_ udiv64 (niepodpisane \_ _int64, int unsigned int \* )|
|[__ull_rshift](ull-rshift.md)||intrin. h|niepodpisane __int64 [Pascal/CDECL] \_ _ull_rshift (niepodpisane \_ _int64, int)|
...
|[__writemsr](writemsr.md)||intrin. h|void __writemsr (Long unsigned, unsigned \_ _int64)|
...
|[_xsave](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave)|XSAVE [2]|immintrin. h|void _xsave (void \* , niepodpisane \_ _int64)|
|[_xsaveopt](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt)|XSAVEOPT [2]|immintrin. h|void _xsaveopt (void \* , niepodpisane \_ _int64)|
|[_xsetbv](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsetbv)|XSAVE [2]|immintrin. h|void _xsetbv (niepodpisane int, niepodpisane \_ _int64)|
