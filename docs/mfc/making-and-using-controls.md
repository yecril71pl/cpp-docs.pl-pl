---
title: Tworzenie i używanie formantów | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
-   Pojedynczych formantów: zobacz [formanty](../mfc/controls-mfc.md) łącza do wszystkich typowych formantów  
