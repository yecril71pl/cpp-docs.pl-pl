...
5.  W **nazwa właściwości** wpisz nazwę właściwości.  
  
6.  Aby uzyskać **typ implementacji**, kliknij przycisk **metod Get/Set**.  
  
7.  W **typ właściwości** wybierz odpowiedniego typu właściwości.  
  
8.  Jeśli chcesz, aby właściwość tylko do odczytu, wyczyść nazwą zestawu funkcji. Jeśli chcesz, aby właściwość tylko do zapisu, wyczyść nazwę funkcji Get.  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Kontrolki ActiveX MFC: właściwości](../mfc/mfc-activex-controls-properties.md)   
