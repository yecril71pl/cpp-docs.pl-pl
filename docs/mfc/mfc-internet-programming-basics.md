...
-   [Klasy MFC związane z Internetu](../mfc/internet-related-mfc-classes.md)  
...
##  <a name="_core_web_sites_for_more_information"></a>Witryny sieci Web, aby uzyskać więcej informacji  
 Aby uzyskać dodatkowe informacje na temat technologii Microsoft Internet, zobacz [Microsoft Developer Network (MSDN)](http://go.microsoft.com/fwlink/linkid=56322) witryny sieci Web. (Łącza mogą ulec zmianie bez powiadomienia).  
 ...
 [Sieci World Wide Web konsorcjum W3C](http://go.microsoft.com/fwlink/linkid=37125) publikuje specyfikacje dla kodu HTML, HTTP CGI i inne technologie sieci World Wide Web.  
