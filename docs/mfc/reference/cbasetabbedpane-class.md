...
`CBaseTabbedPane`Obiekt otacza wskaźnik do obiektu [klasy CMFCBaseTabCtrl](../../mfc/reference/cmfcbasetabctrl-class.md) . [Klasa CMFCBaseTabCtrl](../../mfc/reference/cmfcbasetabctrl-class.md) zostaje następnie oknem podrzędnym okienka z kartami.
...
## <a name="cbasetabbedpanecanfloat"></a><a name="canfloat"></a> CBaseTabbedPane:: onfloat
...
`CArray`Obiekt, który określa domyślną kolejność kart w okienku.
...
*dzieł*<br/>
określoną `CObList` , Który jest wypełniony okienkami zawartymi w okienku z kartami.
...
## <a name="cbasetabbedpanesetautohidemode"></a><a name="setautohidemode"></a> CBaseTabbedPane:: autoukrywaniemode
