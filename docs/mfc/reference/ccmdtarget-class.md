...
### <a name="parameters"></a>Parametry  
 ...
 `pHandlerInfo`  
 Jeśli nie **NULL**, `OnCmdMsg` wypełnia **pTarget** i **pmf** członkami `pHandlerInfo` struktury zamiast wysyłania polecenia. Zazwyczaj ten parametr powinien być **NULL**.  
