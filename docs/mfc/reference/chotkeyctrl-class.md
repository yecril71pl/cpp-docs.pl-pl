...
*Rect*<br/>
Określa rozmiar i położenie formantu klawisza dostępu firmy. Może być albo [CRect](../../atl-mfc-shared/reference/crect-class.md) obiektu lub [struktura RECT](/windows/desktop/api/windef/ns-windef-tagrect).
