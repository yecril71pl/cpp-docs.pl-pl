...
*wartość elementu dwFlags*  
Dowolną kombinację `INTERNET_FLAG_*` flagi. Zobacz tabelę w **uwagi** sekcji [CHttpConnection::OpenRequest](../../mfc/reference/chttpconnection-class.md#openrequest) opis `dwFlags` wartości.
