...
Mapy programu Word do wskaźnika nie może być serializowany.

Gdy `CMapWordToPtr` obiekt zostanie usunięty lub po jego elementy są usuwane, słowa i wskaźniki są usuwane. Jednostek odwołuje się wskaźniki nie są usuwane.

Aby uzyskać więcej informacji na temat `CMapWordToPtr`, zapoznaj się z artykułem [kolekcje](../../mfc/collections.md).
