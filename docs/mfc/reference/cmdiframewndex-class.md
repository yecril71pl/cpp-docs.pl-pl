...
W poniższym przykładzie pokazano sposób, w jaki `DockPaneLeftOf` metoda jest używana w [VisualStudioDemo próbki: Aplikacja programu Visual Studio MFC](../../overview/visual-cpp-samples.md).
