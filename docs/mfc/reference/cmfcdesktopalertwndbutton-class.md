...
Poniższy przykład pokazuje sposób użycia `SetImage` method in Class metoda `CMFCDesktopAlertWndButton` klasy. Ten fragment kodu jest częścią [próbka Demo alertu pulpitu](../../overview/visual-cpp-samples.md).
