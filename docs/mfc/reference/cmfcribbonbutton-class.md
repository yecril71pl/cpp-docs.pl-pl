---
title: Klasa CMFCRibbonButton | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|Nazwa|Opis|  
|----------|-----------------|  
|[CMFCRibbonButton::CMFCRibbonButton](#cmfcribbonbutton)|Tworzy obiekt przycisk wstążki.|  
...
|[CMFCRibbonButton::GetToolTipText](#gettooltiptext)|Zwraca tekst etykietki narzędzia elementu wstążki. (Przesłania [CMFCRibbonBaseElement::GetToolTipText](../../mfc/reference/cmfcribbonbaseelement-class.md#gettooltiptext).)|  
|[CMFCRibbonButton::HasCompactMode](#hascompactmode)|Określa, czy element wstążki ma tryb kompaktowy. (Przesłania [CMFCRibbonBaseElement::HasCompactMode](../../mfc/reference/cmfcribbonbaseelement-class.md#hascompactmode).)|  
|[CMFCRibbonButton::HasIntermediateMode](#hasintermediatemode)|Określa, czy element wstążki ma tryb pośrednich. (Przesłania [CMFCRibbonBaseElement::HasIntermediateMode](../../mfc/reference/cmfcribbonbaseelement-class.md#hasintermediatemode).)|  
|[CMFCRibbonButton::HasLargeMode](#haslargemode)|Określa, czy element wstążki ma trybie duży. (Przesłania [CMFCRibbonBaseElement::HasLargeMode](../../mfc/reference/cmfcribbonbaseelement-class.md#haslargemode).)|  
|[CMFCRibbonButton::HasMenu](#hasmenu)|(Przesłania [CMFCRibbonBaseElement::HasMenu](../../mfc/reference/cmfcribbonbaseelement-class.md#hasmenu).)|  
...
|[CMFCRibbonButton::IsRightAlignMenu](#isrightalignmenu)|Określa, czy menu jest wyrównany do prawej.|  
...
##  <a name="cmfcribbonbutton"></a>  CMFCRibbonButton::CMFCRibbonButton  
 Tworzy obiekt przycisk wstążki.  
...
##  <a name="getimageindex"></a>  CMFCRibbonButton::GetImageIndex  
 Zwraca indeks obrazu, który jest skojarzony z przyciskiem.  
...
##  <a name="isrightalignmenu"></a>  CMFCRibbonButton::IsRightAlignMenu  
 Określa, czy menu jest wyrównany do prawej.  
...
##  <a name="onclick"></a>  CMFCRibbonButton::OnClick  
 Wywoływane przez platformę, gdy użytkownik kliknie przycisk.  
...
##  <a name="setimageindex"></a>  CMFCRibbonButton::SetImageIndex  
 Przypisuje indeks obrazu przycisku.  
