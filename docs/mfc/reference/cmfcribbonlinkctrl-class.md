...
Poniższy przykład pokazuje, jak używać konstruktora `CMFCRibbonLinkCtrl` klasy. Ten fragment kodu jest częścią [przykładowe gadżetów wstążki](../../overview/visual-cpp-samples.md).
