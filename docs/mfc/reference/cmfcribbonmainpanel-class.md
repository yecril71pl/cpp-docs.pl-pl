...
[in] [out] *pElem* wskaźnik do elementu wstążki do dodania do panelu głównego.
...
[in] [out] *pElem* wskaźnik do elementu wstążki do dodania do dolnej części panelu głównego.
