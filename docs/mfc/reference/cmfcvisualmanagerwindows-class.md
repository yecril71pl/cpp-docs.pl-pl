...
Poniższy przykład pokazuje sposób użycia `CMFCVisualManagerWindows`. Ten fragment kodu jest częścią [próbka Demo alertu pulpitu](../../overview/visual-cpp-samples.md).
