...
- COleCurrency (`cySrc`) tworzy `COleCurrency` obiektu z [waluty](http://msdn.microsoft.com/5e81273c-7289-45c7-93c0-32c1553f708e) wartość.  
...
##  <a name="m_cur"></a>  COleCurrency::m_cur  
 Podstawowe [waluty](http://msdn.microsoft.com/5e81273c-7289-45c7-93c0-32c1553f708e) struktury, w tym `COleCurrency` obiektu.  
...
>  Zmiana wartości w `CURRENCY` struktury używane przez wskaźnik zwracany przez tę funkcję zmieni wartość tego `COleCurrency` obiektu. Nie zmienia się jego stan to `COleCurrency` obiektu.  
 ...
 Aby uzyskać więcej informacji, zobacz [waluty](http://msdn.microsoft.com/5e81273c-7289-45c7-93c0-32c1553f708e) wejścia w zestawie Windows SDK.  
