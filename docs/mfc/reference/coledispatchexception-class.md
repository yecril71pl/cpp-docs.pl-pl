...
## <a name="remarks"></a>Uwagi  
 Jak pochodną klasy wyjątków `CException` podstawowa klasa `COleDispatchException` może być używany z THROW, throw_last — TRY, CATCH, and_catch — i end_catch — makra.  
