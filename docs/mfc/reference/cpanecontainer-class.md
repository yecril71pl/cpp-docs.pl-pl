...
Poniższy przykład pokazuje, jak skonstruować wystąpienia `CPaneContainer` klasy. Ten fragment kodu jest częścią [przykładowe ustawić rozmiar okienka](../../overview/visual-cpp-samples.md).
