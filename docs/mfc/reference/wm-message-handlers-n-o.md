---
title: 'Programy obsługi komunikatów WM_: N - O | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|ON_WM_NCCALCSIZE()|afx_msg void [OnNcCalcSize](../../mfc/reference/cwnd-class.md#onnccalcsize)(wartość logiczna, nccalcsize_params — DALEKIEGO *);|  
...
|ON_WM_NCHITTEST()|afx_msg elementu LRESULT [OnNcHitTest](../../mfc/reference/cwnd-class.md#onnchittest)(CPoint);|  
