---
title: 'Komunikaty WM_: P - R | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "46380278"
---
# <a name="wm-messages-p---r"></a>Komunikaty WM_: P - R
...
|ON_WM_PAINTCLIPBOARD()|afx_msg void [OnPaintClipboard](../../mfc/reference/cwnd-class.md#onpaintclipboard)(CWnd *, UCHWYT);|
