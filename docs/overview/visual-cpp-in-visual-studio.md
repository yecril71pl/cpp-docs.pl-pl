...
Więcej informacji na temat ulepszenia zgodności języka C++ w programie Visual Studio.
...
[Visual C++, przenoszenie i uaktualnianie przewodnik](../porting/visual-cpp-porting-and-upgrading-guide.md)<br/>
...
[Narzędzia języka Visual C++ i funkcji w wersjach programu Visual Studio](visual-cpp-tools-and-features-in-visual-studio-editions.md)<br/>
...
[Najlepsze praktyki w zakresie zabezpieczeń](../security/security-best-practices-for-cpp.md)<br/>
Dowiedz się, jak chronić aplikacje przed złośliwym kodem i bezprawnym użyciem.

[Programowanie chmury i sieci Web](../cloud/cloud-and-web-programming-in-visual-cpp.md)<br/>
...
[Materiały referencyjne dotyczące języka C](../c-language/c-language-reference.md)
...
[Odwołanie do biblioteki C-Run-Time](../c-runtime-library/c-run-time-library-reference.md)<br/>
...
[Biblioteka Active Template Library (ATL)](../atl/atl-com-desktop-components.md)<br/>
Wsparcie dla składników COM i aplikacji.

[{1&gt;Biblioteki klasy Microsoft Foundation Class (MFC)&lt;1}](../mfc/mfc-desktop-applications.md)<br/>
...
Dla wielu platform **vcpkg** narzędzie wiersza polecenia znacząco upraszcza odnajdywanie i instalacja ponad 900 C++ bibliotek typu open source. See [vcpkg: Menedżer pakietów języka C++ dla Windows](../build/vcpkg.md).

## <a name="feedback-and-community"></a>Opinie i społeczność

[Jak zgłosić Problem za pomocą zestawu narzędzi Visual C++](how-to-report-a-problem-with-the-visual-cpp-toolset.md)<br/>
