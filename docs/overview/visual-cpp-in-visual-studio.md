...
Visual Studio 2015 i 2017 2019 r mogą być zainstalowane side-by-side. Visual Studio 2019 (v142 zestaw narzędzi kompilatora) służy do edytowania i kompilowania programów przy użyciu zestawu narzędzi programu Visual Studio 2015 (wersja 140) i Visual Studio 2017 (w wersji 141).
