---
title: CONCURRENCY::Direct3D funkcje przestrzeni nazw (AMP) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 08/31/2018
ms.topic: reference
f1_keywords:
...
### <a name="parameters"></a>Parametry
`Av` Widok akceleratora D3D, dla którego jest zwracany podstawowego interfejsu urządzenia D3D.
