...
## <a name="construction"></a>Konstrukcja  
 [1] Konstruktor  
 Uzyskuje blokadę dostępu D3D na danym [accelerator_view](accelerator-view-class.md) obiektu. Konstruowanie bloków, dopóki jest blokada.  
  
 [2] Konstruktor  
 Przyjęcie blokadę dostępu D3D z danego [accelerator_view](accelerator-view-class.md) obiektu.  
  
 [3] Konstruktor przenoszący  
 Pobiera istniejącą blokadę dostępu D3D z innego `scoped_d3d_access_lock` obiektu. Konstrukcje nie są blokowane.  
