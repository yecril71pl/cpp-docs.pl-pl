...
ms.locfileid: "77127728"
---
# <a name="uint_3-class"></a>uint_3 — Klasa
...
|Name (Nazwa)|Opis|
|----------|-----------------|
|[Konstruktor uint_3](#ctor)|Przeciążone. Konstruktor domyślny, inicjuje wszystkie elementy z wartością 0.|
