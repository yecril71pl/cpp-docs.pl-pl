---
title: Współbieżność środowiska wykonawczego — najlepsze praktyki | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Opisuje sposób korzystania z agentów asynchronicznych w aplikacjach użytkownika.  
  
 [Struktury danych synchronizacji](../../parallel/concrt/synchronization-data-structures.md)  
 W tym artykule opisano różne elementy podstawowe synchronizacji, które zapewnia współbieżność środowiska wykonawczego.  
  
 [Harmonogram zadań](../../parallel/concrt/task-scheduler-concurrency-runtime.md)  
 Opisuje sposób użyć harmonogramu zadań, aby dostosować wydajność aplikacji.
