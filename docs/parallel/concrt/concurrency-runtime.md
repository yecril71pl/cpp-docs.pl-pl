...
|[Przykłady aplikacji środowisko wykonawcze systemu Windows](https://docs.microsoft.com/samples/browse/?languages=cpp&expanded=windows&products=windows-uwp)|Zawiera przykłady kodu do pobrania i aplikacje demonstracyjne dla środowisko wykonawcze systemu Windows.|
