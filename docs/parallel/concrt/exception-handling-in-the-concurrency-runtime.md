...
Aby uzyskać kompletny przykład używającej obsługi wyjątków w grupy zadań, zobacz [porady: Użyj obsługi wyjątków aby przerwać pętlę równoległą](../../parallel/concrt/how-to-use-exception-handling-to-break-from-a-parallel-loop.md).
