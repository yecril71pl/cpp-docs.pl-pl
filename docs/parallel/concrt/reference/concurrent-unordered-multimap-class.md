...
#### <a name="parameters"></a>Parametry  
 ...
 `_Allocator_type`  
 Typ reprezentujący obiekt alokatora przechowywane, który hermetyzuje szczegółowe informacje dotyczące alokacji i cofania alokacji pamięci dla jednoczesnych wektora. Ten argument jest opcjonalny, a wartość domyślna to `std::allocator<std::pair<K`, `_Element_type>>`.  
...
|Nazwa|Opis|  
|----------|-----------------|  
|[concurrent_unordered_multimap](#ctor)|Przeciążone. Tworzy równoczesnych multimap nieuporządkowaną.|  
...
|[Wstaw](#insert)|Przeciążone. Dodaje elementy `concurrent_unordered_multimap` obiektu.|  
|[key_eq](#key_eq)|Zwraca obiekt funkcja porównania równości przechowywane.|  
|[swap](#swap)|Zamienia zawartość dwóch `concurrent_unordered_multimap` obiektów. Ta metoda nie jest bezpieczne współbieżności.|  
|[unsafe_erase](#unsafe_erase)|Przeciążone. Usuwa elementy z `concurrent_unordered_multimap` w określonych pozycji. Ta metoda nie jest bezpieczne współbieżności.|  
  
### <a name="public-operators"></a>Operatory publiczne  
  
|Nazwa|Opis|  
|----------|-----------------|  
|[operator=](#operator_eq)|Przeciążone. Przypisuje zawartość innego `concurrent_unordered_multimap` obiektu do tego. Ta metoda nie jest bezpieczne współbieżności.|  
  
## <a name="remarks"></a>Uwagi  
 Aby uzyskać szczegółowe informacje na temat `concurrent_unordered_multimap` , zobacz [równoległe kontenery oraz obiekty](../../../parallel/concrt/parallel-containers-and-objects.md).  
...
##  <a name="ctor"></a> concurrent_unordered_multimap — 
 ...
 Tworzy równoczesnych multimap nieuporządkowaną.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Number_of_buckets`  
 Początkowa liczba zasobników dla tego nieuporządkowaną multimap.  
  
 `_Hasher`  
 Funkcja wyznaczania wartości skrótu dla tego nieuporządkowaną multimap.  
  
 `key_equality`  
 Funkcja porównania równości dla tego nieuporządkowaną multimap.  
  
 `_Allocator`  
 Program przydzielania tego nieuporządkowaną multimap.  
 ...
 `_Umap`  
 Źródło `concurrent_unordered_multimap` obiekt, aby skopiować elementy z.  
  
### <a name="remarks"></a>Uwagi  
 Wszystkie konstruktory zapisania obiektu alokatora `_Allocator` i zainicjuj nieuporządkowaną multimap.  
  
 Pierwszy Konstruktor Określa pusty multimap początkowej i jawnie określa liczbę przedziałów, funkcji skrótu, funkcja równości i przydzielania typu do użycia.  
  
 Drugi Konstruktor określa alokatora nieuporządkowaną multimap.  
  
 Trzeci konstruktora określa wartości dostarczone przez zakres iteratora [ `_Begin`, `_End`).  
  
 Konstruktory czwartym i piątym Określ kopię równoczesnych multimap nieuporządkowaną `_Umap`.  
  
 Konstruktor ostatniego Określa przeniesienie równoczesnych multimap nieuporządkowaną `_Umap`.  
...
##  <a name="insert"></a> Wstaw 
 ...
 Dodaje elementy `concurrent_unordered_multimap` obiektu.  
...
##  <a name="operator_eq"></a> operator = 
 ...
 Przypisuje zawartość innego `concurrent_unordered_multimap` obiektu do tego. Ta metoda nie jest bezpieczne współbieżności.  
...
### <a name="remarks"></a>Uwagi  
 Po wykonaniu elementy w równoczesnych multimap nieuporządkowaną, `operator=` albo kopiuje lub przenosi zawartość `_Umap` do równoczesnych multimap nieuporządkowaną.  
...
##  <a name="swap"></a> Swap 
 ...
 Zamienia zawartość dwóch `concurrent_unordered_multimap` obiektów. Ta metoda nie jest bezpieczne współbieżności.  
...
### <a name="parameters"></a>Parametry  
 `_Umap`  
 `concurrent_unordered_multimap` Obiektu wymiany.  
...
##  <a name="unsafe_erase"></a> unsafe_erase 
 ...
 Usuwa elementy z `concurrent_unordered_multimap` w określonych pozycji. Ta metoda nie jest bezpieczne współbieżności.  
...
### <a name="return-value"></a>Wartość zwracana  
 Pierwszy funkcji Członkowskich dwóch zwracać iterację wyznacza pierwszy element pozostałych poza wszelkie elementy usunięte, lub `concurrent_unordered_multimap::end`(), jeśli nie zawiera żadnego takiego elementu. Trzeci funkcji członkowskiej zwraca liczbę elementów, które powoduje usunięcie.  
...
### <a name="remarks"></a>Uwagi  
 ...
 Trzeci funkcji członkowskiej usuwa elementy w zakresie rozdzielone `concurrent_unordered_multimap::equal_range`(KVal).  
