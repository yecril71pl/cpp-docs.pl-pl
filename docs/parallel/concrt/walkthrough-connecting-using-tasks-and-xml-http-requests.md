...
> [!TIP]
>  Można także za pomocą zestawu SDK REST języka C++ wykonywać żądania HTTP z aplikacji języka C++ do sklepu [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] oraz z klasycznych aplikacji języka C++. Aby uzyskać więcej informacji, zobacz [C++ REST SDK (nazwa kodowa "Casablanca")](https://github.com/Microsoft/cpprestsdk).  
  
 Aby uzyskać więcej informacji o zadaniach, zobacz [równoległość zadań](../../parallel/concrt/task-parallelism-concurrency-runtime.md). Aby uzyskać więcej informacji o sposobie używania zadań w [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] aplikacji, zobacz [asynchronicznego programowania w języku C++](http://msdn.microsoft.com/en-us/512700b7-7863-44cc-93a2-366938052f31) i [tworzenie operacji asynchronicznych w języku C++ dla aplikacji ze Sklepu Windows](../../parallel/concrt/creating-asynchronous-operations-in-cpp-for-windows-store-apps.md).  
  
 W tym dokumencie najpierw pokazano, jak utworzyć klasę `HttpRequest` i jej klasy pomocnicze. Następnie pokazano sposób użycia tej klasy z aplikacji do sklepu [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] wykorzystującej języki C++ i XAML.  
...
> [!TIP]
>  `IXMLHTTPRequest2` i `IXMLHTTPRequest2Callback` to interfejsy, które polecamy do stosowania w aplikacjach do sklepu [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)]. Niniejszy przykład można również przystosować do aplikacji klasycznej.  
...
## <a name="using-the-httprequest-class-in-a-includewin8appnamelongbuildincludeswin8appnamelongmdmd-app"></a>Za pomocą klasy HttpRequest w [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] aplikacji  
 W tej sekcji przedstawiono wykorzystanie klasy `HttpRequest` w aplikacji do sklepu [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)]. Aplikacja zawiera pole wprowadzania danych definiujące zasób adresu URL, polecenia przycisków wykonujące operacje GET i POST oraz polecenie przycisku, które anuluje bieżącą operację.  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Programowanie asynchroniczne w języku C++](http://msdn.microsoft.com/en-us/512700b7-7863-44cc-93a2-366938052f31)   
