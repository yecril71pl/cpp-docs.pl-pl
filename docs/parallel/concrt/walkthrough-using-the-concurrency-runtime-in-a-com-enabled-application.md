---
title: 'Wskazówki: Korzystanie ze współbieżności środowiska wykonawczego w aplikacji z możliwością korzystania z COM | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
