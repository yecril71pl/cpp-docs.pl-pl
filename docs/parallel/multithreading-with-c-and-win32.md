...
Microsoft Visual C++ obsługuje tworzenie wielowątkowe aplikacje. Należy rozważyć użycie więcej niż jeden wątek, jeśli aplikacja wymaga do wykonywania pracochłonnych operacji, które mogłyby spowodować interfejsu użytkownika przestanie odpowiadać.  
