...
Typ, który przechowuje następujących fragmentów informacji na temat blokady: czy blokada jest dostępne, a tożsamość wątku, który jest właścicielem blokady i liczba zagnieżdżenia.  
...
-   [omp_test_nest_lock](../../../parallel/openmp/reference/omp-test-nest-lock.md)  
 ...
 Aby uzyskać więcej informacji, zobacz [3.2 funkcje blokady](../../../parallel/openmp/3-2-lock-functions.md).  
  
## <a name="example"></a>Przykład  
 Zobacz [omp_init_nest_lock](../../../parallel/openmp/reference/omp-init-nest-lock.md) przykład za pomocą **omp_nest_lock_t**.  
