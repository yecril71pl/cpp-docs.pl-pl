...
2. Otwórz okno właściwości projektu, a w języku C++ ogólne, ustaw zestaw narzędzi platformy v141, zestaw narzędzi dla programu Visual Studio 2017 r.
