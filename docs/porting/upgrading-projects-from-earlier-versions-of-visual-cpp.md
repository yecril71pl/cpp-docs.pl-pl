...
description: Jak uaktualnić program Microsoft C++ projektów ze starszych wersji programu Visual Studio.
ms.date: 05/03/2019
helpviewer_keywords:
- 32-bit code porting
...
[Co nowego w języku Visual C++ w programie Visual Studio](../overview/what-s-new-for-visual-cpp-in-visual-studio.md)<br/>
