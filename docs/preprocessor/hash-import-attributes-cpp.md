...
|Atrybut|Opis|
|---------------|-----------------|
|[auto_rename](../preprocessor/auto-rename.md)|Zmienia nazwę C++ słowa zastrzeżone przez dołączenie dwóch znaków podkreślenia (_) do nazwy zmiennej, aby rozwiązać potencjalne konflikty nazw.|
