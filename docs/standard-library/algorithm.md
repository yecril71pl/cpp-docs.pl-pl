...
|[nth_element](../standard-library/algorithm-functions.md#nth_element)|Partycje zakresu elementów poprawnie lokalizowanie *n*element th sekwencji w zakresie tak, aby wszystkie elementy przed nim są mniejsze niż lub równe go i wszystkie elementy, które po nim w sekwencji są większe niż lub równe do niego.|
