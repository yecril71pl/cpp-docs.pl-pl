...
> [!NOTE]
> \<Algorytm > używa również biblioteki `#include <initializer_list>` instrukcji.
...
|[Ograniczenie](../standard-library/algorithm-functions.md#clamp)||
...
|[Próbki](../standard-library/algorithm-functions.md#sample)||
