...
### <a name="parameters"></a>Parametry  
 ...
 `hint`  
 A `const_pointer` który może ułatwić obiektu alokatora spełniające żądanie dla magazynu dzięki umieszczeniu adresu przydzielonego obiektu przed żądania. Pustego wskaźnika jest traktowany jako bez wskazówki.  
...
### <a name="parameters"></a>Parametry  
 ...
 `args`  
 Lista argumentów została przekazana do konstruktora obiektu.  
