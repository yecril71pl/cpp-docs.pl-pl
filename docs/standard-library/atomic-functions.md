...
### <a name="parameters"></a>Parametry  
 `Atom`  
 Wskaźnik do `atomic` obiekt zawierający wartości typu `Ty`.  
...
### <a name="parameters"></a>Parametry  
 ...
 `Order2`  
 Drugi `memory_order` argumentu. Wartość `Order2` nie może być `memory_order_release` lub `memory_order_acq_rel`, nie może być mocniejszy niż wartość `Order1`.  
...
### <a name="parameters"></a>Parametry  
 ...
 `Order2`  
 Drugi `memory_order` argumentu. Wartość `Order2` nie może być `memory_order_release` lub `memory_order_acq_rel`, ani nie może być mocniejszy niż wartość `Order1`.  
...
### <a name="parameters"></a>Parametry  
 `Atom`  
 Wskaźnik do `atomic` obiekt, który przechowuje wskaźnika do typu `T`.  
...
### <a name="parameters"></a>Parametry  
 `Atom`  
 Wskaźnik do `atomic` obiekt zawierający wartości typu `T`.  
...
### <a name="parameters"></a>Parametry  
 `Order`  
 Pamięci, kolejność ograniczenie, które określa typ ogranicznika.  
...
### <a name="parameters"></a>Parametry  
 `Atom`  
 Wskaźnik do obiektu atomic, który zawiera wartości typu `Ty`.  
