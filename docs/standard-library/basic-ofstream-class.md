...
### <a name="parameters"></a>Parametry  
 ...
 `right`  
 Odwołania wartościowane prawostronnie do `basic_ofstream` obiekt używany do inicjowania to `basic_ofstream` obiektu.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Odwołania do r-wartości do `basic_ofstream` obiektu.  
...
## <a name="see-also"></a>Zobacz też  
 [basic_ostream — klasa](../standard-library/basic-ostream-class.md)   
