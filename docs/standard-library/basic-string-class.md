...
*liczba* \
Liczba elementów, które zostaną usunięte, jeśli w zakresie ciągu rozpoczyna się od *_Pos*.
...
*liczba* \
Liczba przypadków, gdy *_Ch* jest kopiowana do ciągu operandu.
