 ...
 *N*  
 Określa liczbę bitów w obiekcie bitset — całkowitą różną od zera typu **size_t** musi być znane w czasie kompilacji.  
...
|[flip](#flip)|Odwraca wartość wszystkie bity w `bitset` lub odwraca jednej ręki na określonej pozycji.|  
|[Brak](#none)|Testy, jeżeli nie bitowe nie ustawiono na wartość 1 w `bitset` obiektu.|  
|[reset](#reset)|Resetuje wszystkie bity w `bitset` 0 lub resetuje nieco na określonej pozycji na 0.|  
...
### <a name="parameters"></a>Parametry  
 `val`  
 Niepodpisane liczba całkowita, którego reprezentacja base dwa służy do inicjowania usługi bits w bitset — tworzona.  
  
 `str`  
 Ciąg zera i używane do zainicjowania wartości bitowe bitset —.  
  
 `_CStr`  
 Ciąg stylu języka C zera i używane do zainicjowania wartości bitowe bitset —.  
  
 `_Pos`  
 Pozycja znaku w ciągu, licząc od lewej do prawej, a począwszy od zera, używaną do inicjalizacji pierwszy bit w bitset —.  
  
 `count`  
 Liczba znaków w ciągu, który służy do zapewnienia usługi BITS w bitset — wartości początkowe.  
  
 `_Zero`  
 Znak, który jest używany do reprezentowania zero. Wartość domyślna to "0".  
  
 `_One`  
 Znak, który jest używany do reprezentowania na. Wartość domyślna to "1".  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Bitset — należy porównać do bitset — docelowy pod kątem nierówności.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Bitset — ma łączyć alternatywy bitowej z bitset — docelowy.  
...
### <a name="parameters"></a>Parametry  
 `_Pos`  
 Liczba pozycji z lewej strony, który bitów w bitset — mają zostać przesunięte.  
...
### <a name="parameters"></a>Parametry  
 `_Pos`  
 Liczba pozycji w lewo, bitów w bitset — mają zostać przesunięte.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Bitset — należy porównać do bitset — docelowy pod kątem równości.  
...
### <a name="parameters"></a>Parametry  
 `_Pos`  
 Liczba pozycji w prawo, bitów w bitset — mają zostać przesunięte.  
...
### <a name="parameters"></a>Parametry  
 `val`  
 Wartość typu obiektu `bool` przypisuje się nieco w bitset —.  
  
 `_Bitref`  
 Odwołanie do formularza *x [i]* -bitowy na pozycji *i* w bitset — *x*.  
...
### <a name="parameters"></a>Parametry  
 `_Pos`  
 Pozycja bitu w bitset — zostaną zresetowane do 0.  
...
### <a name="parameters"></a>Parametry  
 ...
 `val`  
 Wartość do przypisania do bitu w określonej pozycji.  
...
### <a name="parameters"></a>Parametry  
 `_Pos`  
 Pozycja bitu w bitset — pod kątem jego wartość.  
