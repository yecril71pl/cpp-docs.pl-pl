...
|[Przerzuć](#flip)|Odwraca wszystkie bity w wartości `bitset` lub odwraca pojedynczy bit na określonej pozycji.|
...
|[operator ~](#op_dtor)|Odwraca wszystkie bity w elemencie docelowym `bitset` i zwraca wynik.|
