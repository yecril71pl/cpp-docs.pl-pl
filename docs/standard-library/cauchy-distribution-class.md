...
Klasa szablonu opisuje dystrybucji tworzącego wartości określony użytkownik liczb zmiennoprzecinkowych typu lub typu `double` Jeśli nie zostanie podana, rozdzielonych dystrybucji Cauchy. Poniższe łącza tabeli do artykułów na temat poszczególnych członków.
