---
title: "&lt;climits —&gt; | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.workload:
- cplusplus
ms.openlocfilehash: 7c79d6416d3cda2b06fa771dec0134a99111843c
...
Zawiera nagłówek biblioteki standardowe C \<Limits.h — > i dodaje skojarzone nazwy `std` przestrzeni nazw.  
