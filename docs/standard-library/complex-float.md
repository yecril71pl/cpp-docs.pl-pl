...
#### <a name="parameters"></a>Parametry  
 `_RealVal`  
 Wartość typu **float** rzeczywistych część liczby złożonej tworzona.  
  
 `_ImagVal`  
 Wartość typu **float** urojony część liczby złożonej tworzona.  
  
 `complexNum`  
 Liczby złożonej typu **podwójne** lub typu `long double` których części rzeczywistą i urojony są używane do zainicjowania liczbą typu **float** tworzona.  
