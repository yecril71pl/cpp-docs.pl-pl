...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczby złożonej, którego modulo zostanie określony.  
  
### <a name="return-value"></a>Wartość zwracana  
 Moduł liczbą.  
  
### <a name="remarks"></a>Uwagi  
 *Modulo* z liczbą jest miarą długość wektora reprezentujący liczby złożonej. Moduł liczbą + bi jest sqrt (<sup>2</sup> + b<sup>2</sup>) pisemnej &#124; + bi &#124;. *Normy* z liczbą + jest analizy biznesowej (<sup>2</sup> + b<sup>2</sup>), więc resztę z liczbą jest pierwiastek kwadratowy liczby jego normy.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, którego argument zostanie określony.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczby złożonej, którego zespolonej zostały zwrócone.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, którego cosinus jest określane.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, której cosinus hiperboliczny jest określane.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Złożone number, którego wykładniczej jest określane.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, których część rzeczywista ma zostać wyodrębniony.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych zależy którego logarytm naturalny.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych zależy którego logarytm 10.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczby złożonej, których normy zostanie określony.  
  
### <a name="return-value"></a>Wartość zwracana  
 Normy liczbą.  
  
### <a name="remarks"></a>Uwagi  
 Normy liczbą *+ analizy biznesowej* jest *(*<sup>2</sup> *+ b*<sup>2</sup>*).* Normy liczbą jest kwadrat jego modulo. Resztę z liczbą jest miarą długość wektora reprezentujący liczby złożonej. Moduł liczbą *+ analizy biznesowej* jest `sqrt` *(*<sup>2</sup> *+ b*<sup>2</sup> *),* zapisywane *&#124; + bi &#124;.*  
...
### <a name="parameters"></a>Parametry  
 *_Modulus*  
 Moduł liczby złożonej trwa danych wejściowych.  
  
 *_Argument*  
 Argument liczby złożonej trwa danych wejściowych.  
...
### <a name="parameters"></a>Parametry  
 `_Base`  
 Liczba złożonych lub liczba, która jest typu parametru dla liczby złożonej, będący podstawą do podniesione do potęgi o funkcji członkowskiej.  
  
 *_Power*  
 Liczba całkowita lub liczby złożonej lub liczba, która jest typu parametru dla liczby złożonej, będącą energii zostać podniesiona do funkcji członkowskiej bazie.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, którego sinus jest określane.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, której sinusem hiperbolicznym jest określane.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, której pierwiastek kwadratowy ma zostać znaleziona.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, którego tangens jest określane.  
...
### <a name="parameters"></a>Parametry  
 `complexNum`  
 Liczba złożonych, której tangens hiperboliczny jest określane.  
...
## <a name="see-also"></a>Zobacz też  
 [\<złożone >](../standard-library/complex.md)
