---
title: Kontener Class::clear | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="container-classclear"></a>Kontener Class::clear
> [!NOTE]
>  Ten temat dotyczy w dokumentacji Visual C++ prawidłowo przykład kontenerów używanych w standardowej bibliotece C++. Aby uzyskać więcej informacji, zobacz [standardowe kontenery biblioteki C++](../standard-library/stl-containers.md).  
 ...
 Wywołania [wymazać](../standard-library/container-class-erase.md)([rozpocząć](../standard-library/container-class-begin.md), [zakończenia](../standard-library/container-class-end.md)).  
