---
title: Kontener Class::size_type
ms.date: 11/04/2016
helpviewer_keywords:
- size_type typedef
...
Opisuje obiekt, który może reprezentować długość wszelkie kontrolowanej sekwencji.
...
Jest on opisany tutaj jako synonim dla nieokreślonego typu `T0` (zazwyczaj `Alloc::size_type`).
