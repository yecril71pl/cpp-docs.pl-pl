---
title: Kontener Class::size | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Zwraca długość kontrolowanej sekwencji w czasie stałej niezależnie od długości kontrolowanej sekwencji.
