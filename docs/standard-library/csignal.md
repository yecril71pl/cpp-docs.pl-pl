---
title: '&lt;csignal —&gt; | Dokumenty Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841598"
---
# <a name="ltcsignalgt"></a>&lt;csignal&gt;

Zawiera nagłówek biblioteki standardowe C \<signal.h > i dodaje skojarzone nazwy `std` przestrzeni nazw.
