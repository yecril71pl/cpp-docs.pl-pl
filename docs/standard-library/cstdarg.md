---
title: '&lt;cstdarg —&gt; | Dokumenty Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33843954"
---
# <a name="ltcstdarggt"></a>&lt;cstdarg&gt;

Zawiera nagłówek biblioteki standardowe C \<stdarg.h > i dodaje skojarzone nazwy `std` przestrzeni nazw.
