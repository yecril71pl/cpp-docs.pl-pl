...
```  
 ...
 Obie funkcje Członkowskie zwracać mysymstat prawdopodobnie najpierw zmienić jako status_known(mysymstat) w następujący sposób: Jeśli, a następnie nic nie rób. Otherwise, mysymstat = symlink_status(mypval).  
