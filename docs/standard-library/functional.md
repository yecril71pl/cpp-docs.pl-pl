...
|[multiplies](../standard-library/multiplies-struct.md)|Klasa zawiera wstępnie zdefiniowany obiekt Function, który wykonuje operacje arytmetyczne mnożenia dla elementów o określonym typie wartości.|
