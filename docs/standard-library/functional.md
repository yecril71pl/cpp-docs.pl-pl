...
|[greater](../standard-library/greater-struct.md)|Predykat binarny, który umożliwia sprawdzenie, czy wartość o określonym typie jest większa niż wartość inna tego typu.|  
