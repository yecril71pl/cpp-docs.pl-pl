...
||||  
|-|-|-|  
|[asynchroniczne](#async)|[future_category —](#future_category)|[make_error_code —](#make_error_code)|  
...
### <a name="parameters"></a>Parametry  
 `policy`  
 A [uruchamianie](../standard-library/future-enums.md#launch) wartość.  
...
### <a name="parameters"></a>Parametry  
 `Errno`  
 A [future_errc —](../standard-library/future-enums.md#future_errc) wartość, która identyfikuje zgłoszonego błędu.  
