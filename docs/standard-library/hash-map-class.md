...
#### <a name="parameters"></a>Parametry  
 ...
 `Type`  
 Typ danych elementu mają być przechowywane w hash_map.  
 ...
 `Allocator`  
 Typ reprezentujący obiekt alokatora przechowywane, który hermetyzuje szczegółowe informacje dotyczące alokacji hash_map i cofania alokacji pamięci. Ten argument jest opcjonalny, a wartość domyślna to alokatora < pair < stała `Key`, `Type`>>.  
...
|[iteratora](#iterator)|Typ, który udostępnia iteratora dwukierunkowego, które mogą odczytywać lub modyfikować dowolny element w `hash_map`.|  
...
|[wskaźnik](#pointer)|Typ, który dostarcza wskaźnik do elementu `hash_map`.|  
...
|||  
|-|-|  
|[w](#at)|Odnajduje element `hash_map` o określonej wartości klucza.|  
|[Rozpocznij](#begin)|Zwraca iteratora adresowania pierwszym elementem w `hash_map`.|  
...
### <a name="remarks"></a>Uwagi  
 ...
 `const_iterator` Zdefiniowany przez punkty hash_map dla elementów, które są obiektami [value_type](#value_type), która jest typu `pair`  *\<*  **const klucza, wpisz**  *>* , którego pierwszego elementu członkowskiego ma kluczowe znaczenie dla elementu i sekundę, których element członkowski jest mapowanych elementu danych przez element.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Wartość klucza elementu do dopasowania z hash_map.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Argument wartość klucza ma zostać porównane z klucza sortowania z elementem z hash_map przeszukiwany.  
...
### <a name="parameters"></a>Parametry  
 `_Where`  
 Położenie elementu do usunięcia z hash_map.  
  
 `first`  
 Pozycja pierwszego elementu usunięte z hash_map.  
  
 `last`  
 Pozycja poza ostatni element usunięty z hash_map.  
  
 `key`  
 Wartość klucza elementu do usunięcia z hash_map.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Wartość klucza do dopasowania za pomocą klucza sortowania z elementem z hash_map przeszukiwany.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Hash_map — argument, zapewniając elementy, aby być zamieniona na hash_map docelowej.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Wartość klucza argument ma być porównywana z wartością klucza sortowania z elementem z hash_map przeszukiwany.  
