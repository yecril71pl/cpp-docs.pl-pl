...
#### <a name="parameters"></a>Parametry  
 T  
 Typ wartości. musi być typem całkowitym: bool, char, char16_t, char32_t, wchar_t, podpisane lub niepodpisanych typów całkowitych.  
  
 Cyklicznych  
 Stała parametryzująca pakietu, który reprezentuje sekwencję wartości typu całkowitego T.  
