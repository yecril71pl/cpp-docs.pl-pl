...
ms.locfileid: "87233122"
---
# <a name="is_fundamental-class"></a>is_fundamental — Klasa
...
Wystąpienie predykatu typu ma wartość true, jeśli typ *ty* jest typem podstawowym, czyli **`void`** typem całkowitym, typem zmiennoprzecinkowym lub `cv-qualified` postaci jednego z nich, w przeciwnym razie ma wartość false.
