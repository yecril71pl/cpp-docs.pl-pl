...
Wystąpienie typu predykatu posiada wartość true Jeśli typ `T` jest `void` lub formularza kwalifikowana cv `void`, w przeciwnym razie ma wartość false.
