...
|||  
|-|-|  
|[takie same](#equal)|Sprawdza pod kątem równości dwóch iteratorów bufora strumienia wejściowego.|  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Iterator, dla którego ma być sprawdzany pod kątem równości.  
...
### <a name="parameters"></a>Parametry  
 `strbuf`  
 Bufor strumienia wejściowego, do którego `istreambuf_iterator` jest dołączony.  
  
 `_Istr`  
 Strumień wejściowy, do którego `istreambuf_iterator` jest dołączony.  
