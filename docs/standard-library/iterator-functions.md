...
### <a name="parameters"></a>Parametry  
 `_Cont`  
 Kontener, do którego ma zostać wykonana wstecz wstawiania.  
...
### <a name="parameters"></a>Parametry  
 `first`  
 Pierwszy iteratora ustala się których odległość od drugiego.  
  
 `last`  
 Drugi iteratora, których odległość od pierwszego zostanie określony.  
...
### <a name="parameters"></a>Parametry  
 `_Cont`  
 Obiekt kontenera, w których przodu ma element wstawiony.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Where`  
 Lokalizowanie punkt wstawiania iteratora.  
...
### <a name="parameters"></a>Parametry  
 `_It`  
 Iterator przechowywane w nowych iteratora przenoszenia.  
...
### <a name="parameters"></a>Parametry  
 ...
 `_Off`  
 Liczba godzin w celu wykonania iteracji.  
