...
## <a name="remarks"></a>Uwagi  
 ...
 Możesz utworzyć **mask_array —\<typu >** obiektu Pisząc wyrażenie w postaci [ł &#91; ba &#93;](../standard-library/valarray-class.md#op_at). Funkcje Członkowskie mask_array — klasa następnie zachowania odpowiedniego sygnatury funkcji zdefiniowane dla **valarray —\<typu >**, ale dotyczy tylko sekwencji wybrane elementy.  
