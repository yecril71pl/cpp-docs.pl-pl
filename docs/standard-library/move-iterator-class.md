...
##  <a name="op_at">move_iterator::operator]</a>  
...
##  <a name="move_iterator__operator-">move_iterator::operator-</a>  
...
##  <a name="move_iterator__operator-_gt">move_iterator::operator-</a>&gt;  
