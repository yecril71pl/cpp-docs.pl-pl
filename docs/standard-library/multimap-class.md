...
#### <a name="parameters"></a>Parametry  
 ...
 `Traits`  
 Typ, który dostarcza obiekt funkcji, która może porównać dwie wartości elementów jako klucze sortowania, aby określić ich względną kolejność w mapie wielokrotnej. Predykat binarne `less<Key>` jest wartością domyślną.  
...
|[iteratora](#iterator)|Typ, który zawiera różnicę między dwoma Iteratory, które odwołują się do elementów w tym samym `multimap`.|  
...
|[wskaźnik](#pointer)|Typ, który dostarcza wskaźnik do `const` element `multimap`.|  
...
|||  
|-|-|  
|[Rozpocznij](#begin)|Zwraca iteratora adresowania pierwszym elementem w `multimap`.|  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Klucz elementu do dopasowania z multimap.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Klucz argumentu, który ma zostać porównane z klucza sortowania z elementem z multimap przeszukiwany.  
...
### <a name="parameters"></a>Parametry  
 `key`  
 Wartość klucza do dopasowania za pomocą klucza sortowania z elementem z multimap przeszukiwany.  
