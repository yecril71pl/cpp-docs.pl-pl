---
title: "negative_binomial_distribution — klasa | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
{param_type — struktura  
   ...
   param_type (result_type k = 1, dwukrotnie p = 0,5); result_type k() const; Podwójna p() const;
