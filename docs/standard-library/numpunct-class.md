...
Szablon klasy, który opisuje obiekt, który może służyć jako zestaw reguł lokalnych do opisywania sekwencji typu `CharType` używanego do reprezentowania informacji o formatowaniu i interpunkcji wyrażeń liczbowych i logicznych.
