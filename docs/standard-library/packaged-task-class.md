...
*Po prawej stronie* A `packaged_task` obiektu.
...
*ALLOC* alokatora pamięci. Aby uzyskać więcej informacji, zobacz [ \<buforów >](../standard-library/allocators-header.md).

*FN* obiektu funkcyjnego.
