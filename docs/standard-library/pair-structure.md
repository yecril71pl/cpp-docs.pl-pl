...
#### <a name="parameters"></a>Parametry  
 `Val1`  
 Wartość, inicjowanie pierwszego elementu obiektu `pair`.  
  
 `Val2`  
 Wartość inicjowanie drugiego elementu `pair`.  
  
 `Right`  
 Para, których wartości, które mają być używane do zainicjowania elementy kolejną parę.  
