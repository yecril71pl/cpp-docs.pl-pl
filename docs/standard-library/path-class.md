...
2.  katalog główny, jeśli jest obecny  
  
3.  pozostałe elementy katalogu ścieżki nadrzędnej, jeśli jest obecny, kończąc nazwę pliku, jeśli jest obecny    
...
2.  X == pval.end() ma wartość true, gdy X punktów tylko poza koniec sekwencja składników.  
  
3. * X zwraca ciąg zgodny bieżącego składnika  
  
4.  ++ X wyznacza następny składnik w sekwencji, jeśli jest obecny.  
  
5.  --X wyznacza poprzedniego składnika w sekwencji, jeśli jest obecny.  
  
6.  Zmienianie mójużytkownik unieważnia Iteratory wszystkich elementów w mójużytkownik wyznaczenie.  
...
2.  wstring() ciągu\<wchar_t cech, alokacji >)  
  
3.  u16string() ciągu\<char16_t, cech, alokacji >)  
  
4.  u32string() ciągu\<char32_t, cech, alokacji >)  
