...
### <a name="quick-tips"></a>Szybkie porady  
 Poniżej przedstawiono kilka wskazówek, które należy wziąć pod uwagę w przypadku korzystania z `<random>`:  
...
### <a name="utility-functions"></a>Funkcje pomocnicze  
 Ta sekcja zawiera funkcje ogólne narzędzie zawarte w `<random>` nagłówka.  
