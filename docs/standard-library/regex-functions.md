...
### <a name="parameters"></a>Parametry  
 `BidIt`  
 Typ iteratora submatches. Dla typowe przypadki spośród string::const_iterator, wstring::const_iterator, char const * lub const wchar_t\*.  
  
 `Alloc`  
 Klasa alokatora wyniki dopasowania.  
  
 `Elem`  
 Typ elementów, do których ma pasować. Dla przypadków typowe to ciąg, wstring, char * lub wchar_t\*.  
  
 `RXtraits`  
 Klasa cech dla elementów.  
  
 `Alloc2`  
 Allocator — klasa wyrażenia regularnego.  
  
 `IOtraits`  
 Klasa cech ciągu.  
  
 `IOalloc`  
 Allocator — klasa ciągu.  
  
 `flags`  
 Flagi do dopasowania.  
 ...
 `match`  
 Wyniki zgodne. Odnosi się do typu elementu: [smatch](../standard-library/regex-typedefs.md#smatch) dla parametrów, [wsmatch](../standard-library/regex-typedefs.md#wsmatch) dla wstring, [cmatch](../standard-library/regex-typedefs.md#cmatch) dla char * lub [wcmatch](../standard-library/regex-typedefs.md#wcmatch) dla wchar_t\*.  
  
 `ptr`  
 Wskaźnik do początku sekwencji do dopasowania. Jeśli ptr char *, należy zastosować cmatch i wyrażenia regularnego. W przypadku ptr wchar_t\* Użyj wcmatch i wregex.  
  
 `re`  
 Wyrażenie regularne do dopasowania. Typ `regex` ciągu i char * lub `wregex` wstring i wchar_t\*.  
