---
title: remove_extent — klasa | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Wystąpienie `remove_extent<T>` przechowuje zmodyfikowany typ, który jest `T1` podczas *T* ma postać `T1[N]`, w przeciwnym razie *T*.
