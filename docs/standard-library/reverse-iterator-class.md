...
|[operator->](#op-arrow)|Zwraca wskaźnik do elementu kierowanego przez `reverse_iterator`.|
...
*Off*<br/>
Przesunięcie, które mają zostać dodane do odwrotnego iteratora.
