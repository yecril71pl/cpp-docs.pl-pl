...
|[iteratora](../standard-library/container-class-iterator.md)|Opis obiektu, który może służyć jako iterację w kontrolowanej sekwencji.|  
...
|||  
|-|-|  
|[Rozpocznij](../standard-library/container-class-begin.md)|Zwraca iteratora tego punktów w pierwszym elementem sekwencji (lub bezpośrednio po zakończeniu pustej sekwencji).|  
