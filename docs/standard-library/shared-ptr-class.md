...
### <a name="remarks"></a>Uwagi  
 Zwraca wartość typu, który można przekonwertować na typ `bool`. Wynik konwersji na `bool` jest `true` podczas `get() != 0`, w przeciwnym razie `false`.  
...
### <a name="parameters"></a>Parametry  
 ...
 `ap`  
 Wskaźnik automatycznie do skopiowania.  
...
### <a name="parameters"></a>Parametry  
 `Other`  
 Typ kontrolowane przez wskaźnik argumentu.  
...
### <a name="parameters"></a>Parametry  
 ...
 `sp`  
 Wskaźnik inteligentny do skopiowania.  
...
### <a name="parameters"></a>Parametry  
 `sp`  
 Udostępniony wskaźnik do wymiany.  
