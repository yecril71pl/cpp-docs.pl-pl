...
|Konstruktor|Opis|
|-|-|
|[slice](#slice)|Definiuje podzbiór `valarray` składający się z liczbą elementów, które są równe odległości i, która jest uruchamiana na określony element.|
