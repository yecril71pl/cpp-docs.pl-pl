...
### <a name="parameters"></a>Parametry  
 ...
 `str`  
 Ciąg, do którego są odczytywanie znaków ze strumienia wejściowego.  
...
### <a name="parameters"></a>Parametry  
 `left`  
 Jednego ciągu, których elementy mają być zamieniona na tych z innego ciągu.  
  
 `right`  
 Inny ciąg, których elementy mają być zamieniona na pierwszy ciąg.  
