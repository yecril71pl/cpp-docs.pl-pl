...
||||  
|-|-|-|  
|[Pobierz](#get)|[make_tuple —](#make_tuple)|[Powiązanie](#tie)|  
...
### <a name="parameters"></a>Parametry  
 ...
 `Types`  
 Sekwencja typy zadeklarowane w spójnej kolekcji w kolejności deklaracji.  
...
### <a name="parameters"></a>Parametry  
 `TN`  
 Typ podstawowy elementu n-ty spójnej kolekcji.  
