...
|[~ unique_lock — destruktor](#dtorunique_lock_destructor)|Zwalnia wszystkie zasoby, które są skojarzone z `unique_lock` obiektu.|  
...
|[odblokowywanie](#unlock)|Zwalnia własność skojarzonego `mutex`.|  
