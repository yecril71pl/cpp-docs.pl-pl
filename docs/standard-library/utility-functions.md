...
||||  
|-|-|-|  
|[Program Exchange](#exchange)|[Prześlij dalej](#forward)|[Get — funkcja &lt;narzędzia&gt;](#get)|  
...
### <a name="parameters"></a>Parametry  
 `Index`  
 Na podstawie 0 indeks elementu wyznaczonych.  
...
### <a name="parameters"></a>Parametry  
 `Val1`  
 Wartość, która inicjuje pierwszego elementu obiektu `pair`.  
  
 `Val2`  
 Wartość, która inicjuje drugiego elementu `pair`.  
