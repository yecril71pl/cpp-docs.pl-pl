...
Ta funkcja niestandardowa jest odpowiednikiem przypisywanie pusta tablicy valarray. Przykład:
...
*po prawej stronie*\
A `valarray` zawierająca elementy, które mają być zamienione.
