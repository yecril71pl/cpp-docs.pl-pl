 ...
 *_Func(Type)*  
 Funkcja obiekt, który ma zostać zastosowany do każdego elementu valarray — argument.  
  
 *_Func(Const type&)*  
 Obiekt funkcja const ma zostać zastosowany do każdego elementu valarray — argument.  
...
### <a name="parameters"></a>Parametry  
 `count`  
 Liczba miejsc, w których elementy mają zostać przesunięty do przodu.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Valarray — lub wartość identyczna ze valarray — argument, który mnożenia element-wise, valarray — argument typu elementu.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Valarray — lub wartość identyczna ze valarray — argument, który ma zostać dodany, element-wise, aby valarray — operand typu elementu.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Valarray — lub wartość identyczna ze valarray — argument, który można odejmować, element-wise, z valarray — argument typu elementu.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Valarray — lub wartość identyczna ze valarray — argument, który ma być podzielone, element-wise, valarray — operand typu elementu.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Valarray — można skopiować do valarray — argument.  
  
 `val`  
 Wartość do przypisania do elementów valarray — argument.  
  
 `_Slicearray`  
 Slice_array — można skopiować do valarray — argument.  
  
 `_Gslicearray`  
 Gslice_array — można skopiować do valarray — argument.  
  
 `_Maskarray`  
 Mask_array — można skopiować do valarray — argument.  
  
 `_Indarray`  
 Indirect_array — można skopiować do valarray — argument.  
...
### <a name="parameters"></a>Parametry  
 `_Off`  
 Indeks elementu, który ma być przypisana wartość.  
  
 `_Slicearray`  
 Slice_array — z valarray —, określająca podzbiór, która zostanie wybrana lub powrót do nowego valarray —.  
  
 `_Gslicearray`  
 Gslice_array — z valarray —, określająca podzbiór, która zostanie wybrana lub powrót do nowego valarray —.  
  
 *_Boolarray*  
 Bool_array valarray —, określająca podzbiór, która zostanie wybrana lub powrót do nowego valarray —.  
  
 `_Indarray`  
 Indirect_array — z valarray —, określająca podzbiór, która zostanie wybrana lub powrót do nowego valarray —.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Valarray — lub wartość typu elementu identyczna ze valarray — argument, który ma być łączone, element-wise przez jedynego logicznej **XOR** z valarray — argument.  
...
### <a name="parameters"></a>Parametry  
 `right`  
 Valarray — lub wartość typu elementu identyczna ze valarray — argument, który ma być łączone, element-wise przez operatora testu koniunkcji `OR` z valarray — argument.  
...
### <a name="parameters"></a>Parametry  
 `_Newsize`  
 Liczba elementów w zmienionym rozmiarze valarray —.  
  
 `val`  
 Wartość do elementów po zmianie rozmiaru valarray —.  
