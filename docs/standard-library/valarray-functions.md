...
### <a name="parameters"></a>Parametry  
 `left`  
 Wejściowy valarray —, których elementy mają obsługiwany przez funkcję elementu członkowskiego.  
...
### <a name="parameters"></a>Parametry  
 `left`  
 Dane liczbowe stałej typu lub danych wejściowych valarray — której elementy Podaj wartości współrzędną y argument tangens.  
  
 `right`  
 Dane liczbowe stałej typu lub danych wejściowych valarray — której elementy Podaj wartości współrzędną x argument tangens.  
...
### <a name="parameters"></a>Parametry  
 `left`  
 Wejściowy valarray —, której elementy dostaw base, aby uzyskać każdy element ma być exponentiated.  
  
 `right`  
 Wejściowy valarray —, której elementy podać zasilania dla każdego elementu jako exponentiated.  
