...
|&nbsp;&nbsp;[N2634 Wyrażenie SFINAE](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2008/n2634.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7|
...
|&nbsp;&nbsp;[Wnioskowanie argumentu szablonu P0091R3 dla szablonów klas](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0091r3.html)<br />&nbsp;&nbsp;[Problemy Wnioskowanie argumentu szablonu klasy P0512R0](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0512r0.pdf)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7 <sup> [17](#note_17)</sup>|
|&nbsp;&nbsp;[Deklarowanie P0127R2 parametry szablonu bez typu, dzięki funkcji autoskalowania](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0127r2.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7 <sup> [17](#note_17)</sup>|
|&nbsp;&nbsp;[Gwarantowana P0135R1 pominięcia kopii](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0135r1.html)|PREMIERA PROGRAMU VS 2017 15.6<sup>[H](#note_H)</sup>|
|&nbsp;&nbsp;[Zmiana sformułowania elementu P0136R1, konstruktory dziedziczące](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0136r1.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7 <sup> [17](#note_17)</sup>|
|&nbsp;&nbsp;[P0137R1 std::launder](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0137r1.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7 <sup> [17](#note_17)</sup>|
|&nbsp;&nbsp;[Rafinacja P0145R3 kolejność obliczania wyrażeń](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0145r3.pdf)<br />&nbsp;&nbsp;[P0400R0 kolejność obliczania argumenty funkcji](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0400r0.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7 <sup> [17](#note_17)</sup>|
|&nbsp;&nbsp;[Rozwinięcia P0195R2 Pack w deklaracjach using](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0195r2.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7 <sup> [17](#note_17)</sup>|
...
|&nbsp;&nbsp;[CWG 1581: Gdy funkcje Członkowskie constexpr zdefiniowano?](https://wg21.cmeerw.net/cwg/issue1581)|Nie|
...
|&nbsp;&nbsp; [Unikanie niepotrzebnych zanikania P0777R1](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0777r1.pdf)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7 <sup> [14](#note_14)</sup>|
...
|&nbsp;&nbsp;[Integrowanie P0433R2 wnioskowanie szablonu dla szablonów klas, do biblioteki standardowej](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0433r2.html)<br />&nbsp;&nbsp;[Poprawa P0739R0 klasy argument wnioskowanie integracji szablonu do biblioteki standardowej](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0739r0.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7|
|&nbsp;&nbsp;[P0426R1 constexpr dla char_traits](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0426r1.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7|
|&nbsp;&nbsp;[Hypot P0030R1 — (x, y, z)](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0030r1.pdf)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7|
...
|&nbsp;&nbsp;[N4562 Dokumentu Library Fundamentals: \<memory_resource >](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/n4562.html#memory.resource.synop)<br />&nbsp;&nbsp;[Usuwanie P0337R0 polymorphic_allocator przypisania](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0337r0.html)|PREMIERA PROGRAMU VS 2017 15.6|
|&nbsp;&nbsp;[Algorytmy równoległe P0024R2](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0024r2.html)<br />&nbsp;&nbsp;[Zasady wykonywania równoległego zmiana nazwy P0336R1](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0336r1.pdf)<br />&nbsp;&nbsp;[Algorytmy równoległe P0394R4 powinien terminate() dla wyjątków](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0394r4.html)<br />&nbsp;&nbsp;[P0452R1, ujednolicając naukę \<liczbowych > algorytmy równoległe](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0452r1.html)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7|
|&nbsp;&nbsp;[P0226R1 specjalne funkcje matematyczne](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0226r1.pdf)|PREMIERA PROGRAMU VS 2017 WERSJI 15.7|
...
|&nbsp;&nbsp;[Usuwanie N4190 auto_ptr, random_shuffle() i starych \<funkcjonalności > rzeczy](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4190.htm)|Program VS 2015 <sup> [rem](#note_rem)</sup>|
...
|&nbsp;&nbsp;[Funkcje N4279 insert_or_assign()/try_emplace() dla map/unordered_map](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n4279.html)|VS 2015 <sup>[14](#note_14)</sup>|
...
|&nbsp;&nbsp;[Funkcja exchange() N3668](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3668.html)|VS 2015|
...
- Nie poprawę wydajności jawnego równoległości na urządzeniu docelowym; Wszystkie algorytmy, które jedynie kopiowania lub permute — elementy z gałęzi są zazwyczaj ograniczone przepustowość pamięci:
  - kopiowania, copy_backward, copy_n, wypełnienie, fill_n, przenoszenie, move_backward, Usuń, remove_if —, Zastąp, replace_if —, wstecznego, reverse_copy, obracanie, rotate_copy —, swap_ranges —
