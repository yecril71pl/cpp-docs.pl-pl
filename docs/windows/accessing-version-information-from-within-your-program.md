...
### <a name="to-access-version-information-from-within-your-program"></a>Dostęp do informacji o wersji z Twojego programu  
  
1.  Aby uzyskać dostęp do informacji o wersji z Twojego programu, należy użyć [GetFileVersionInfo](http://msdn.microsoft.com/library/windows/desktop/ms647003.aspx) funkcji i [VerQueryValue](http://msdn.microsoft.com/library/windows/desktop/ms647464.aspx) funkcji.  
