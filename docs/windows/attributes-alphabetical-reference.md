...
|[attribute](../windows/attribute.md)|Umożliwia tworzenie atrybutów niestandardowych.|
...
|[db_accessor](../windows/db-accessor.md)|Tworzy powiązanie kolumn w zestawie wierszy i wiąże ich odpowiednich mapowania dostępu.|
|[db_column](../windows/db-column.md)|Wiąże określonej kolumny zestawu wierszy.|
|[db_command](../windows/db-command.md)|Wykonuje polecenie OLE DB.|
|[db_param](../windows/db-param.md)|Kojarzy zmiennej określonego elementu członkowskiego z parametrów wejściowych lub wyjściowych.|
...
|[helpstring](../windows/helpstring.md)|Określa identyfikator tematu pomocy w pliku hlp lub chm.|
...
|[requires_category](../windows/requires-category.md)|Określa wymagany składnik kategorie dla klasy.|
...
|[synchronize](../windows/synchronize.md)|Synchronizuje dostęp do metody.|
...
[Dokumentacja atrybutów (C++)](../windows/cpp-attributes-reference.md)<br/>
