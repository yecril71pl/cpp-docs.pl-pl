---
title: atrybut (atrybut C++ COM) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 10/03/2018
ms.technology:
- cpp-windows
...
> [!NOTE]
> **Atrybut** atrybutu jest już przestarzały.  Użyj wspólnego atrybutu środowisko uruchomieniowe języka `System.Attribute` można bezpośrednio utworzyć attirbutes zdefiniowanych przez użytkownika. Aby uzyskać więcej informacji, zobacz [atrybuty zdefiniowane przez użytkownika](../user-defined-attributes-cpp-component-extensions.md).

Należy zdefiniować [atrybutu niestandardowego](custom-attributes-cpp.md) , umieszczając **atrybut** atrybutu zarządzanych definicji klasy lub struktury. Nazwa klasy jest atrybutu niestandardowego. Na przykład:
...
Aby uzyskać listę typy parametrów atrybutu możliwe, zobacz [atrybuty niestandardowe](custom-attributes-cpp.md).

Zobacz [atrybuty zdefiniowane przez użytkownika](../user-defined-attributes-cpp-component-extensions.md) do dyskusji na temat docelowe atrybuty.
