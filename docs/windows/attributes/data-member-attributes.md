---
title: Atrybuty elementów członkowskich danych (C++ COM)
ms.date: 10/02/2018
helpviewer_keywords:
...
|Atrybut|Opis|
|---------------|-----------------|
|[db_accessor](db-accessor.md)|Grupy `db_column` atrybuty, które uczestniczą w `IAccessor`— na podstawie powiązania.|
