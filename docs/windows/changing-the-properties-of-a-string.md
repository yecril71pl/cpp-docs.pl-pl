...
### <a name="to-change-a-string-or-its-identifier"></a>Aby zmienić ciąg lub identyfikatora  
...
2.  Wybierz ciąg chcesz edytować, a następnie kliknij dwukrotnie **identyfikator**, **wartość**, lub **podpis** kolumny. Teraz możesz:  
  
    -   Wybierz **identyfikator** z **identyfikator listy rozwijanej** listy lub wpisz identyfikator bezpośrednio w miejscu.  
  
    -   Wpisz inny numer w **wartość** kolumny.  
  
    -   Wpisz zmiany w **podpis** kolumny.  
  
        > [!NOTE]
        >  Można również edytować właściwości ciągu w [okna właściwości](/visualstudio/ide/reference/properties-window).  
