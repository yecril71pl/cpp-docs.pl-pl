...
2.  Wpisz nowy identyfikator w **identyfikator** właściwości w [okna właściwości](/visualstudio/ide/reference/properties-window), lub użyj listy rozwijanej, aby wybrać nowy **identyfikator**.  
