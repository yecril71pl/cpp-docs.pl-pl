---
title: Component Extensions dla platformy .NET i platformy uniwersalnej systemu Windows | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 10/12/2018
ms.technology:
- cpp-windows
...
|**delegate**|Tak|Deklaruje delegata.|[Delegowanie (C + +/ CLI i C + +/ CX)](../windows/delegate-cpp-component-extensions.md)|
