...
|Tytuł|Opis|  
|-----------|-----------------|  
|[Przewodnik: tworzenie standardowego programu C++ (C++)](../windows/walkthrough-creating-a-standard-cpp-program-cpp.md)|Opisuje sposób tworzenia aplikacji konsoli, które użytkownicy mogą uruchamiać z wiersza polecenia.|  
|[Tworzenie aplikacji konsoli](../windows/creating-a-console-application.md)|Zawiera informacje o aplikacji konsoli.|