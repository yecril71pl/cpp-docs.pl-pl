...
1. W [widok zasobów](/windows/how-to-create-a-resource-script-file#create-resources), kliknij prawym przyciskiem myszy użytkownika *.rc* plik i wybierz **Dodaj zasób**.
