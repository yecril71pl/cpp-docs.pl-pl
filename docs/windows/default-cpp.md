...
**Domyślne** atrybut C++ ma taką samą funkcjonalność jak [domyślne](/windows/desktop/Midl/default) atrybutów w MIDL. **Domyślne** również zostanie użyty atrybut [przypadek](../windows/case-cpp.md) atrybutu.
