---
title: Usuwanie przycisku paska narzędzi (C++)
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "50603232"
---
# <a name="deleting-a-toolbar-button-c"></a>Usuwanie przycisku paska narzędzi (C++)

### <a name="to-delete-a-toolbar-button"></a>Aby usunąć przycisku paska narzędzi

1. Wybierz przycisk paska narzędzi i przeciągnij go poza pasek narzędzi.
