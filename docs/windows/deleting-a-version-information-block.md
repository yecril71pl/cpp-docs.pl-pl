---
title: Usuwanie bloku informacji o wersji | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="deleting-a-version-information-block"></a>Usuwanie bloku informacji o wersji
### <a name="to-delete-a-version-information-block"></a>Aby usunąć blok informacji o wersji  
  
1.  Otwórz zasobach informacji o wersji, klikając odpowiednią ikonę w [widok zasobów](../windows/resource-view-window.md).  
...
2.  Kliknij prawym przyciskiem myszy nagłówek bloku chcesz usunąć, a następnie wybierz pozycję **Usuń wersję bloku informacyjnego** z menu skrótów.  
  
     To polecenie usuwa wybrany nagłówek i pozostawia niezmienione pozostałe informacje o wersji. Należy pamiętać, że akcja jest nieodwracalna.  
