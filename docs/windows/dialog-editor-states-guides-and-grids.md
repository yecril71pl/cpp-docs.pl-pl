---
title: Stany Edytor okien dialogowych (prowadnice i siatki) (C++) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
- [Dopasowanie kontrolek do prowadnicy](../windows/aligning-controls-on-a-guide.md)

- [Wyłączanie prowadnic](../windows/disabling-guides.md)
