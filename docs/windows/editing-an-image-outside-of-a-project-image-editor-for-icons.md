...
### <a name="to-open-a-bitmap-for-stand-alone-editing"></a>Aby otworzyć mapy bitowej do edycji autonomicznych  
  
1.  Z **pliku** menu, kliknij przycisk **Otwórz**.  
  
2.  W **pliki typu** kliknij **wszystkie pliki**.  
  
3.  Zlokalizuj i Otwórz obraz, który chcesz edytować.  
