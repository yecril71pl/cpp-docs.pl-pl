...
|[obiekt](../windows/object-cpp.md)|Określa niestandardowy interfejs.|  
...
|[ograniczone](../windows/restricted.md)|Określa, które elementy członkowskie biblioteki nie może być wywoływana arbitralnie.|  
