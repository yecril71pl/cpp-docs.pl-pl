...
`true` można przydzielić pamięci dla obiektu, który obsługuje słabe odwołania; `false` można przydzielić pamięci dla obiektu, który nie obsługuje słabe odwołania.
