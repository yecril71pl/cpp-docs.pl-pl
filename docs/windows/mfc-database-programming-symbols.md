---
title: Symbole programowania bazy danych MFC | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33877608"
---
# <a name="mfc-database-programming-symbols"></a>Symbole programowania bazy danych MFC
Symbole w tej tabeli są wyświetlane tylko w projekcie MFC po dodaniu obsługi bazy danych. Obsługują one połączenie MFC serwerów SQL i programowanie bazy danych.  
...
|AFX_IDP_SQL_FIELD_NOT_FOUND|NIEZGODNOŚĆ AFX_IDP_SQL_FILED_SCHEMA_|  
...
|AKTUALIZACJE AFX_IDP_SQL_NO_POSITIONED_|AFX_IDP_SQL_NO_ROWS_AFFECTED|  
