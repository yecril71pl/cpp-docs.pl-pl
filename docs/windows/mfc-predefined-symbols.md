...
|AFX_IDP_DAO_DFX_BIND|INICJOWANIE AFX_IDP_DAO_ENGINE_|
...
|AFX_IDS_CHECKLISTBOX_MIXED|USUŃ ZAZNACZENIE POLA WYBORU AFX_IDS_CHECKLISTBOX_|
...
|AFX_IDS_METAFILE_FORMAT|AFX_IDS_MINI CZCIONKI|
|AFX_IDS_NOT_DOCOBJECT|WYJĄTEK AFX_IDS_NOT_SUPPORTED_|
