...
|Nazwa|Opis|  
|----------|-----------------|  
|[Module::objectcount_ — członek danych](../windows/module-objectcount-data-member.md)|Przechowuje informacje o ile klasy zostały utworzone z [upewnij](../windows/make-function.md) funkcji.|  
|[Module::releasenotifier_ — członek danych](../windows/module-releasenotifier-data-member.md)|Zawiera wskaźnik do obiektu ReleaseNotifier.|  
