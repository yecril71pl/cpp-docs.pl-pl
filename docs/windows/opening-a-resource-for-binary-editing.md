---
title: Otwieranie zasobów do edycji plików binarnych (C++) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "50068011"
---
# <a name="opening-a-resource-for-binary-editing-c"></a>Otwieranie zasobów do edycji plików binarnych (C++)
