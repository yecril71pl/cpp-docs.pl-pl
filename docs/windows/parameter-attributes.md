---
title: Atrybuty parametrów | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33879399"
---
# <a name="parameter-attributes"></a>Atrybuty parametru
Następujące atrybuty dotyczą parametry metody w klasie lub interfejs.  
...
|[iid_is](../windows/iid-is.md)|Określa indeks pierwszego elementu tablicy ma zostać przesłany.|  
