---
title: Atrybuty parametru | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|[iid_is](../windows/iid-is.md)|Określa indeks pierwszego elementu tablicy mają być przekazywane.|
