---
title: Zasoby służące do C++ tworzenia gier za pomocą programu DirectX
ms.date: 06/08/2018
helpviewer_keywords:
- games [C++]
...
ms.locfileid: "80167826"
---
# <a name="resources-for-creating-a-c-game-using-directx"></a>Zasoby służące do C++ tworzenia gier za pomocą programu DirectX

Aby tworzyć najlepsze gry, używaj Visual C++ w połączeniu z DirectX.

## <a name="resources"></a>Zasoby

Wizualizacja C++ jest zawarta we wszystkich wersjach programu Visual Studio, ale nie jest instalowana domyślnie. Informacje o sposobie instalowania programu Visual Studio i narzędzi C++ programistycznych znajdują się [w C++ temacie Install Support in Visual Studio](../build/vscpp-step-0-installation.md).
...
[Aplikacje systemu Windows Win32](../windows/windows-desktop-applications-cpp.md) zawierają artykuły opisujące sposób tworzenia podstawowej aplikacji klasycznej systemu Windows.
