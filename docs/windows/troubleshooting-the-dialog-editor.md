---
title: Rozwiązywanie problemów z edytora okien dialogowych | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33889907"
---
# <a name="troubleshooting-the-dialog-editor"></a>Rozwiązywanie problemów z Edytorem okien dialogowych
Poniżej przedstawiono kilka problemów, które należy zwrócić uwagę, gdy praca w edytorze okien dialogowych.  
...
-   [Używanie kontrolki RichEdit 1.0 z MFC](../windows/using-the-richedit-1-0-control-with-mfc.md)  
