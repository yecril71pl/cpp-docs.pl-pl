...
2.  Przed użyciem procedury matematyczne w bibliotece statycznej, należy to odwołać. Aby to zrobić, otwórz menu skrótów dla projektu MyExecRefsLib w **Eksploratora rozwiązań**, a następnie wybierz **Dodaj** > **odwołania**.  
